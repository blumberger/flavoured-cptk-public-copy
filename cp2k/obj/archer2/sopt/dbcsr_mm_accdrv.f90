# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/dbcsr/mm/dbcsr_mm_accdrv.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/dbcsr/mm/dbcsr_mm_accdrv.F"
!-----------------------------------------------------------------------------!
...
# 70 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/dbcsr/mm/dbcsr_mm_accdrv.F" 2
...
! *****************************************************************************
  SUBROUTINE dbcsr_mm_accdrv_process(this, left, right, params, stack_size, &
    ...
    IF(.NOT. acc_devmem_allocated(a_area%acc_devmem)) &
       CALL cp__b("dbcsr/mm/dbcsr_mm_accdrv.F",615,"dbcsr_mm_accdrv_process: a_area%acc_devmem not allocated")
    IF(.NOT. acc_devmem_allocated(b_area%acc_devmem)) &
       CALL cp__b("dbcsr/mm/dbcsr_mm_accdrv.F",617,"dbcsr_mm_accdrv_process: b_area%acc_devmem not allocated")
    IF(.NOT. acc_devmem_allocated(c_area%acc_devmem)) &
       CALL cp__b("dbcsr/mm/dbcsr_mm_accdrv.F",619,"dbcsr_mm_accdrv_process: c_area%acc_devmem not allocated")
