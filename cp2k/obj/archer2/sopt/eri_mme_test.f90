# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/eri_mme_test.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/eri_mme_test.F"
!-----------------------------------------------------------------------------!
...
# 41 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/eri_mme_test.F" 2
...
! *****************************************************************************
  SUBROUTINE create_eri_mme_test_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("eri_mme_test.F",70)
...
! *****************************************************************************
  SUBROUTINE eri_mme_perf_acc_test(para_env, iw, eri_mme_test_section)
    ...
    IF(nzet .LE. 0)&
       CALL cp__b("eri_mme_test.F",190,"Number of exponents NZET must be greater than 0.")
    ...
    IF(iw>0) THEN
      ...
      IF(test_accuracy) THEN
        ...
        IF(.NOT.acc_check)&
           CALL cp__b("eri_mme_test.F",316,"Actual error greater than upper bound estimate.")
