# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/core_ppl.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/core_ppl.F"
!-----------------------------------------------------------------------------!
...
# 49 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/core_ppl.F" 2
...
! *****************************************************************************
  SUBROUTINE build_core_ppl(matrix_h, matrix_p, force, virial, calculate_forces, use_virial, nder,&
    ...
    INTEGER :: atom_a, atom_b, atom_c, handle, i, iatom, icol, ikind, img, &
      ...
      maxco, maxder, maxl, maxlgto, maxlppl, maxnset, maxsgf, mepos, natom, &
      ncoa, ncob, nexp_lpot, nexp_ppl, nkind, nseta, nsetb, nthread, sgfa, &
      sgfb
    ...
    LOGICAL                                  :: dokp, found, lpotextended
...
!$OMP          f0, katom, ppl_work, atom_c, cellind, img, &                                                        
!$OMP          ldai)                 
    ...
    DO WHILE (neighbor_list_iterate(nl_iterator, mepos=mepos)==0)
       ...
       DO kkind=1,nkind
          ...
          IF (lpotextended) THEN
            ...
            IF(.NOT.(nexp_lpot<nexp_max))CALL cp__a("core_ppl.F",340)
