# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/pw/ps_wavelet_scaling_function.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/pw/ps_wavelet_scaling_function.F"
!-----------------------------------------------------------------------------!
...
# 14 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/pw/ps_wavelet_scaling_function.F" 2
...
!Number of points: must be 2**nex
  ...
  IF (i_all /= 0) THEN
     ...
     CALL cp__b("pw/ps_wavelet_scaling_function.F",56,"")
  END IF
...
!must be 2**nex
  ...
  IF (i_all /= 0) THEN
     ...
     CALL cp__b("pw/ps_wavelet_scaling_function.F",112,"")
  END IF
