# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/pw/ps_wavelet_base.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/pw/ps_wavelet_base.F"
!-----------------------------------------------------------------------------!
...
# 18 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/pw/ps_wavelet_base.F" 2
...
! *****************************************************************************
  SUBROUTINE P_PoissonSolver(n1,n2,n3,nd1,nd2,nd3,md1,md2,md3,nproc,iproc,zf&
    ...
    INTEGER                                  :: i, i1, i3, ic1, ic2, ic3, &
                                                inzee, j, j2, J2stb, J2stf, &
                                                j3, Jp2stb, Jp2stf, lot, lzt, &
                                                ma, mb, ncache, nfft
    ...
    IF (nd1.LT.n1/2+1) CALL cp__b("pw/ps_wavelet_base.F",73,"Parallel convolution:ERROR:nd1")
    IF (nd2.LT.n2/2+1) CALL cp__b("pw/ps_wavelet_base.F",74,"Parallel convolution:ERROR:nd2")
    IF (nd3.LT.n3/2+1) CALL cp__b("pw/ps_wavelet_base.F",75,"Parallel convolution:ERROR:nd3")
    IF (md1.LT.n1) CALL cp__b("pw/ps_wavelet_base.F",76,"Parallel convolution:ERROR:md1")
    IF (md2.LT.n2) CALL cp__b("pw/ps_wavelet_base.F",77,"Parallel convolution:ERROR:md2")
    IF (md3.LT.n3) CALL cp__b("pw/ps_wavelet_base.F",78,"Parallel convolution:ERROR:md3")
    IF (MOD(nd3,nproc).NE.0) CALL cp__b("pw/ps_wavelet_base.F",79,"Parallel convolution:ERROR:nd3")
    IF (MOD(md2,nproc).NE.0) CALL cp__b("pw/ps_wavelet_base.F",80,"Parallel convolution:ERROR:md2")
    ...
    IF (lot.LT.1) THEN
       ...
       CALL cp__b("pw/ps_wavelet_base.F",135,"")
    ENDIF
    DO j2=1,md2/nproc
       ...
       IF (iproc*(nd3/nproc)+j3.LE.n3/2+1) THEN
          ...
          IF (lot.LT.1) THEN
             WRITE(*,*) &
                  ...
                  'least one 1-d FFT of this size even though this will' // &
                  'reduce the performance for shorter transform lengths'
             CALL cp__b("pw/ps_wavelet_base.F",189,"")
          ENDIF
          ...
          IF (lot.LT.1) THEN
             WRITE(*,*) &
                  ...
                  'least one 1-d FFT of this size even though this will' // &
                  'reduce the performance for shorter transform lengths'
             CALL cp__b("pw/ps_wavelet_base.F",229,"")
          ENDIF
...
! *****************************************************************************
  SUBROUTINE S_PoissonSolver(n1,n2,n3,nd1,nd2,nd3,md1,md2,md3,nproc,iproc,pot,zf,&
    ...
    INTEGER                                  :: handle, i, i1, i3, ic1, ic2, &
                                                ic3, inzee, j, j2, J2stb, &
                                                J2stf, j3, Jp2stb, Jp2stf, &
                                                lot, lzt, ma, mb, ncache, nfft
    INTEGER, ALLOCATABLE, DIMENSION(:)       :: after1, after2, after3, &
                                                before1, before2, before3, &
                                                now1, now2, now3
    ...
    ! check input
    IF (MOD(n3,2).NE.0) CALL cp__b("pw/ps_wavelet_base.F",888,"Parallel convolution:ERROR:n3")
    IF (nd1.LT.n1/2+1) CALL cp__b("pw/ps_wavelet_base.F",889,"Parallel convolution:ERROR:nd1")
    IF (nd2.LT.n2/2+1) CALL cp__b("pw/ps_wavelet_base.F",890,"Parallel convolution:ERROR:nd2")
    IF (nd3.LT.n3/2+1) CALL cp__b("pw/ps_wavelet_base.F",891,"Parallel convolution:ERROR:nd3")
    IF (md1.LT.n1) CALL cp__b("pw/ps_wavelet_base.F",892,"Parallel convolution:ERROR:md1")
    IF (md2.LT.n2) CALL cp__b("pw/ps_wavelet_base.F",893,"Parallel convolution:ERROR:md2")
    IF (md3.LT.n3/2) CALL cp__b("pw/ps_wavelet_base.F",894,"Parallel convolution:ERROR:md3")
    IF (MOD(nd3,nproc).NE.0) CALL cp__b("pw/ps_wavelet_base.F",895,"Parallel convolution:ERROR:nd3")
    IF (MOD(md2,nproc).NE.0) CALL cp__b("pw/ps_wavelet_base.F",896,"Parallel convolution:ERROR:md2")
    ...
    IF (lot.LT.1) THEN
       ...
       CALL cp__b("pw/ps_wavelet_base.F",970,"")
    ENDIF
       ...
       IF (iproc*(nd3/nproc)+j3.LE.n3/2+1) THEN
          ...
          IF (lot.LT.1) THEN
             WRITE(*,*) &
                  ...
                  'least one 1-d FFT of this size even though this will' // &
                  'reduce the performance for shorter transform lengths'
             CALL cp__b("pw/ps_wavelet_base.F",1024,"")
          ENDIF
          ...
          IF (lot.LT.1) THEN
             WRITE(*,*) &
                  ...
                  'least one 1-d FFT of this size even though this will' // &
                  'reduce the performance for shorter transform lengths'
             CALL cp__b("pw/ps_wavelet_base.F",1064,"")
          ENDIF
...
! *****************************************************************************
  SUBROUTINE F_PoissonSolver(n1,n2,n3,nd1,nd2,nd3,md1,md2,md3,nproc,iproc,pot,zf,&
    ...
    IF (MOD(n1,2).NE.0) CALL cp__b("pw/ps_wavelet_base.F",1648,"Parallel convolution:ERROR:n1")
    IF (MOD(n2,2).NE.0) CALL cp__b("pw/ps_wavelet_base.F",1649,"Parallel convolution:ERROR:n2")
    IF (MOD(n3,2).NE.0) CALL cp__b("pw/ps_wavelet_base.F",1650,"Parallel convolution:ERROR:n3")
    IF (nd1.LT.n1/2+1) CALL cp__b("pw/ps_wavelet_base.F",1651,"Parallel convolution:ERROR:nd1")
    IF (nd2.LT.n2/2+1) CALL cp__b("pw/ps_wavelet_base.F",1652,"Parallel convolution:ERROR:nd2")
    IF (nd3.LT.n3/2+1) CALL cp__b("pw/ps_wavelet_base.F",1653,"Parallel convolution:ERROR:nd3")
    IF (md1.LT.n1/2) CALL cp__b("pw/ps_wavelet_base.F",1654,"Parallel convolution:ERROR:md1")
    IF (md2.LT.n2/2) CALL cp__b("pw/ps_wavelet_base.F",1655,"Parallel convolution:ERROR:md2")
    IF (md3.LT.n3/2) CALL cp__b("pw/ps_wavelet_base.F",1656,"Parallel convolution:ERROR:md3")
    IF (MOD(nd3,nproc).NE.0) CALL cp__b("pw/ps_wavelet_base.F",1657,"Parallel convolution:ERROR:nd3")
    IF (MOD(md2,nproc).NE.0) CALL cp__b("pw/ps_wavelet_base.F",1658,"Parallel convolution:ERROR:md2")
    ...
    IF (lot.LT.1) THEN
       WRITE(*,*) &
            ...
            'least one 1-d FFT of this size even though this will' // &
            'reduce the performance for shorter transform lengths'
       CALL cp__b("pw/ps_wavelet_base.F",1722,"")
    ENDIF
       ...
       IF (iproc*(nd3/nproc)+j3.LE.n3/2+1) THEN
          ...
          IF (lot.LT.1) THEN
             WRITE(*,*) &
                  ...
                  'least one 1-d FFT of this size even though this will' // &
                  'reduce the performance for shorter transform lengths'
             CALL cp__b("pw/ps_wavelet_base.F",1779,"")
          ENDIF
          ...
          IF (lot.LT.1) THEN
             WRITE(*,*) &
                  ...
                  'least one 1-d FFT of this size even though this will' // &
                  'reduce the performance for shorter transform lengths'
             CALL cp__b("pw/ps_wavelet_base.F",1819,"")
          ENDIF
