# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/subsys/cell_types.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/subsys/cell_types.F"
!-----------------------------------------------------------------------------!
...
# 23 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/subsys/cell_types.F" 2
...
! *****************************************************************************
  SUBROUTINE cell_clone (cell_in, cell_out)
    ...
    IF(.NOT.(ASSOCIATED(cell_in)))CALL cp__a("subsys/cell_types.F",103)
    IF(.NOT.(ASSOCIATED(cell_out)))CALL cp__a("subsys/cell_types.F",104)
...
! *****************************************************************************
  SUBROUTINE cell_copy (cell_in, cell_out)
    ...
    IF(.NOT.(ASSOCIATED(cell_in)))CALL cp__a("subsys/cell_types.F",130)
    IF(.NOT.(ASSOCIATED(cell_out)))CALL cp__a("subsys/cell_types.F",131)
...
! *****************************************************************************
  SUBROUTINE set_cell_param(cell,cell_length,cell_angle,periodic,do_init_cell)
    ...
    IF(.NOT.(ALL(cell_angle/=0.0_dp)))CALL cp__a("subsys/cell_types.F",305)
    eps = EPSILON(0.0_dp)
...
! *****************************************************************************
  SUBROUTINE init_cell(cell,hmat,periodic)
    ...
    IF (cell%deth < 1.0E-10_dp) THEN
       CALL cp_abort(cp__l("subsys/cell_types.F",368),&
    ...
    IF ((dim == 1).AND.(.NOT.cell%orthorhombic)) THEN
       CALL cp__b("subsys/cell_types.F",462,"Non-orthorhombic and not periodic")
    END IF
...
! *****************************************************************************
  SUBROUTINE cell_create(cell,hmat,periodic)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(cell)))CALL cp__a("subsys/cell_types.F",774)
    ALLOCATE (cell)
    last_cell_id = last_cell_id + 1
...
! *****************************************************************************
  SUBROUTINE cell_retain(cell)
    ...
    IF(.NOT.(ASSOCIATED(cell)))CALL cp__a("subsys/cell_types.F",805)
    IF(.NOT.(cell%ref_count>0))CALL cp__a("subsys/cell_types.F",806)
...
! *****************************************************************************
  SUBROUTINE cell_release(cell)
    ...
    IF (ASSOCIATED(cell)) THEN
       IF(.NOT.(cell%ref_count>0))CALL cp__a("subsys/cell_types.F",826)
       cell%ref_count=cell%ref_count-1
...
# 861 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/subsys/cell_types.F"
