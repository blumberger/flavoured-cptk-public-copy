# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/common/list_routinereport.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/common/list_routinereport.F"
!-----------------------------------------------------------------------------!
...
# 28 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/common/list_routinereport.F" 2
...
SUBROUTINE list_routinereport_init(list, initial_capacity)
    ...
    IF(initial_capacity_ < 0) & 
      CALL cp__b("common/list_routinereport.F",111,"list_routinereport_create: initial_capacity < 0")

    IF(ASSOCIATED(list%arr)) &
       CALL cp__b("common/list_routinereport.F",114,"list_routinereport_create: list is already initialized.")

    ALLOCATE(list%arr(initial_capacity_), stat=stat)
    IF (stat/=0)&
       CALL cp__b("common/list_routinereport.F",118,"list_routinereport_init: allocation failed")
...
SUBROUTINE list_routinereport_destroy(list)
    ...
    IF(.NOT. ASSOCIATED(list%arr)) &
       CALL cp__b("common/list_routinereport.F",139,"list_routinereport_destroy: list is not initialized.")
...
SUBROUTINE list_routinereport_set(list, value, pos)
    ...
    IF(.NOT. ASSOCIATED(list%arr)) &
       CALL cp__b("common/list_routinereport.F",168,"list_routinereport_set: list is not initialized.")
    IF(pos < 1)&
       CALL cp__b("common/list_routinereport.F",170,"list_routinereport_set: pos < 1")
    IF(pos > list%size)&
       CALL cp__b("common/list_routinereport.F",172,"list_routinereport_set: pos > size")
...
SUBROUTINE list_routinereport_push(list, value)
    ...
    IF(.NOT. ASSOCIATED(list%arr)) &
       CALL cp__b("common/list_routinereport.F",194,"list_routinereport_push: list is not initialized.")
    ...
    IF (stat/=0)&
       CALL cp__b("common/list_routinereport.F",201,"list_routinereport_push: allocation failed")
...
SUBROUTINE list_routinereport_insert(list, value, pos)
    ...
    IF(.NOT. ASSOCIATED(list%arr)) &
       CALL cp__b("common/list_routinereport.F",226,"list_routinereport_insert: list is not initialized.")
    IF(pos < 1)&
       CALL cp__b("common/list_routinereport.F",228,"list_routinereport_insert: pos < 1")
    IF(pos > list%size+1)&
       CALL cp__b("common/list_routinereport.F",230,"list_routinereport_insert: pos > size+1")
    ...
    ALLOCATE(list%arr(pos)%p, stat=stat)
     IF (stat/=0)&
        CALL cp__b("common/list_routinereport.F",242,"list_routinereport_insert: allocation failed.")
    list%arr(pos)%p%value => value
...
FUNCTION list_routinereport_peek(list) RESULT(value)
    ...
    IF(.NOT. ASSOCIATED(list%arr)) &
       CALL cp__b("common/list_routinereport.F",262,"list_routinereport_peek: list is not initialized.")
    IF(list%size < 1) &
       CALL cp__b("common/list_routinereport.F",264,"list_routinereport_peek: list is empty.")
...
FUNCTION list_routinereport_pop(list) RESULT(value)
    ...
    IF(.NOT. ASSOCIATED(list%arr)) &
       CALL cp__b("common/list_routinereport.F",288,"list_routinereport_pop: list is not initialized.")
    IF(list%size < 1) &
       CALL cp__b("common/list_routinereport.F",290,"list_routinereport_pop: list is empty.")
...
SUBROUTINE list_routinereport_clear(list)
    ...
    IF(.NOT. ASSOCIATED(list%arr)) &
       CALL cp__b("common/list_routinereport.F",313,"list_routinereport_clear: list is not initialized.")
...
FUNCTION list_routinereport_get(list, pos) RESULT(value)
    ...
    IF(.NOT. ASSOCIATED(list%arr)) &
       CALL cp__b("common/list_routinereport.F",339,"list_routinereport_get: list is not initialized.")
    IF(pos < 1)&
       CALL cp__b("common/list_routinereport.F",341,"list_routinereport_get: pos < 1")
    IF(pos > list%size)&
       CALL cp__b("common/list_routinereport.F",343,"list_routinereport_get: pos > size")
...
SUBROUTINE list_routinereport_del(list, pos)
    ...
    IF(.NOT. ASSOCIATED(list%arr)) &
       CALL cp__b("common/list_routinereport.F",366,"list_routinereport_del: list is not initialized.")
    IF(pos < 1)&
       CALL cp__b("common/list_routinereport.F",368,"list_routinereport_det: pos < 1")
    IF(pos > list%size)&
       CALL cp__b("common/list_routinereport.F",370,"list_routinereport_det: pos > size")
...
FUNCTION list_routinereport_size(list) RESULT(size)
    ...
    IF(.NOT. ASSOCIATED(list%arr)) &
       CALL cp__b("common/list_routinereport.F",395,"list_routinereport_size: list is not initialized.")
...
SUBROUTINE change_capacity(list, new_capacity)
   ...
   IF(new_cap < 0) &
      CALL cp__b("common/list_routinereport.F",420,"list_routinereport_change_capacity: new_capacity < 0")
   IF(new_cap < list%size) &
      CALL cp__b("common/list_routinereport.F",422,"list_routinereport_change_capacity: new_capacity < size")
   IF(new_cap > HUGE(i)) THEN
      IF(SIZE(list%arr) == HUGE(i)) &
      CALL cp__b("common/list_routinereport.F",425,"list_routinereport_change_capacity: list has reached integer limit.")
   ...
   IF (stat/=0)&
      CALL cp__b("common/list_routinereport.F",432,"list_routinereport_change_capacity: allocation failed")

   DO i=1, list%size
      ALLOCATE(list%arr(i)%p, stat=stat)
      IF (stat/=0)&
         CALL cp__b("common/list_routinereport.F",437,"list_routinereport_change_capacity: allocation failed")
