# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/lri_environment_init.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/lri_environment_init.F"
!-----------------------------------------------------------------------------!
...
# 37 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/lri_environment_init.F" 2
  ...
  SUBROUTINE lri_basis_init(lri_env)
    ...
    IF (ASSOCIATED(lri_env)) THEN
       IF (ASSOCIATED(lri_env%orb_basis)) THEN
          IF(.NOT.(ASSOCIATED(lri_env%ri_basis)))CALL cp__a("lri_environment_init.F",149)
          ...
          DO ikind = 1, nkind
             ...
             IF (ASSOCIATED(orb_basis)) THEN
                ...
                IF(.NOT.(ASSOCIATED(ri_basis)))CALL cp__a("lri_environment_init.F",158)
                NULLIFY(ri_norm_r)
