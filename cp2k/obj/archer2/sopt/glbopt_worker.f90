# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/swarm/glbopt_worker.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/swarm/glbopt_worker.F"
!-----------------------------------------------------------------------------!
...
# 42 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/swarm/glbopt_worker.F" 2
...
! *****************************************************************************
   SUBROUTINE glbopt_worker_init(worker, input_declaration, para_env, root_section,&
    ...
    CHARACTER(len=*), PARAMETER :: routineN = 'glbopt_worker_init', &
...
! *****************************************************************************
   SUBROUTINE glbopt_worker_execute(worker, cmd, report)
    ...
    CHARACTER(len=*), PARAMETER :: routineN = 'glbopt_worker_execute', &
      routineP = moduleN//':'//routineN
    ...
    CHARACTER(len=default_string_length)     :: command
       ...
       ELSE
          CALL cp__b("swarm/glbopt_worker.F",161,"Worker: received unknown command")
       END IF
...
! *****************************************************************************
   SUBROUTINE glbopt_worker_finalize(worker)
    ...
    CHARACTER(len=*), PARAMETER :: routineN = 'glbopt_worker_finalize', &
      routineP = moduleN//':'//routineN
    ...
    INTEGER                                  :: ierr
     ...
     IF(ierr /= 0) CALL cp__b("swarm/glbopt_worker.F",393,"destroy_force_env failed")
