# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/qs_loc_molecules.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/qs_loc_molecules.F"
!-----------------------------------------------------------------------------!
...
# 43 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/qs_loc_molecules.F" 2
...
! *****************************************************************************
  SUBROUTINE wfc_to_molecule(qs_env, qs_loc_env, loc_print_key, center, &
    ...
    INTEGER :: akind, counter, first_atom, i, iatom, ikind, imol, imol_now, &
      ...
      nstate, output_unit, reference
    INTEGER, POINTER                         :: wfc_to_atom_map( : )
    LOGICAL                                  :: do_berry, ghost
    ...
    IF( BTEST(cp_print_key_should_output(logger%iter_info,loc_print_key,&
       ...
       IF (nspins>1) THEN
          CALL cp_abort(cp__l("qs_loc_molecules.F",108),&
