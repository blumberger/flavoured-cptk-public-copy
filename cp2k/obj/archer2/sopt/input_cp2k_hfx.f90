# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/input_cp2k_hfx.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/input_cp2k_hfx.F"
!-----------------------------------------------------------------------------!
...
MODULE input_cp2k_hfx
  ...
  USE input_constants,                 ONLY: &
       ...
       do_hfx_potential_short, do_hfx_potential_truncated, ehrenfest, gaussian
...
# 35 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/input_cp2k_hfx.F" 2
...
! *****************************************************************************
  SUBROUTINE create_hfx_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_hfx.F",60)
...
! *****************************************************************************
  SUBROUTINE create_hf_load_balance_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_hfx.F",146)
...
! *****************************************************************************
  SUBROUTINE create_hf_potential_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_hfx.F",219)
...
! *****************************************************************************
  SUBROUTINE create_hf_screening_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_hfx.F",317)
...
! *****************************************************************************
  SUBROUTINE create_hf_pbc_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_hfx.F",393)
...
! *****************************************************************************
  SUBROUTINE create_hf_memory_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_hfx.F",427)
