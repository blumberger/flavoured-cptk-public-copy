# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/swarm/glbopt_master.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/swarm/glbopt_master.F"
!-----------------------------------------------------------------------------!
...
# 55 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/swarm/glbopt_master.F" 2
...
! *****************************************************************************
 SUBROUTINE glbopt_master_init(this, para_env, root_section,  n_walkers, iw)
    ...
    CHARACTER(len=*), PARAMETER :: routineN = 'glbopt_master_init', &
    ...
    SELECT CASE (this%method)
       ...
       CASE DEFAULT
        CALL cp__b("swarm/glbopt_master.F",134,"Unknown glbopt_method")
    END SELECT
...
! *****************************************************************************
 SUBROUTINE glbopt_master_steer(this, report, cmd, should_stop)
    ...
    CHARACTER(len=*), PARAMETER :: routineN = 'glbopt_master_steer', &
      routineP = moduleN//':'//routineN
    ...
    SELECT CASE (this%method)
      ...
      CASE DEFAULT
       CALL cp__b("swarm/glbopt_master.F",223,"Unknown glbopt_method")
    END SELECT
...
! *****************************************************************************
 SUBROUTINE glbopt_master_finalize(this)
    ...
    CHARACTER(len=*), PARAMETER :: routineN = 'glbopt_master_finalize', &
      routineP = moduleN//':'//routineN
    ...
    SELECT CASE (this%method)
       ...
       CASE DEFAULT
        CALL cp__b("swarm/glbopt_master.F",347,"Unknown glbopt_method")
    END SELECT
