# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/force_field_types.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/force_field_types.F"
!-----------------------------------------------------------------------------!
...
# 26 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/force_field_types.F" 2
...
! *****************************************************************************
  SUBROUTINE deallocate_amb_info(amb_info)
    ...
    CHARACTER(LEN=*), PARAMETER :: routineN = 'deallocate_amb_info', &
      routineP = moduleN//':'//routineN
