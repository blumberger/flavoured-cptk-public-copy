# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/cp_control_types.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/cp_control_types.F"
!-----------------------------------------------------------------------------!
...
# 21 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/cp_control_types.F" 2
...
! *****************************************************************************
  SUBROUTINE mulliken_control_create(mulliken_restraint_control)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(mulliken_restraint_control)))CALL cp__a("cp_control_types.F",471)
...
! *****************************************************************************
  SUBROUTINE mulliken_control_release(mulliken_restraint_control)
    ...
    IF(.NOT.(ASSOCIATED(mulliken_restraint_control)))CALL cp__a("cp_control_types.F",493)
    IF(.NOT.(mulliken_restraint_control%ref_count>0))CALL cp__a("cp_control_types.F",494)
...
! *****************************************************************************
  SUBROUTINE mulliken_control_retain(mulliken_restraint_control)
    ...
    IF(.NOT.(ASSOCIATED(mulliken_restraint_control)))CALL cp__a("cp_control_types.F",519)
...
! *****************************************************************************
  SUBROUTINE ddapc_control_create(ddapc_restraint_control)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(ddapc_restraint_control)))CALL cp__a("cp_control_types.F",536)
...
! *****************************************************************************
  SUBROUTINE ddapc_control_release(ddapc_restraint_control)
    ...
    IF(.NOT.(ASSOCIATED(ddapc_restraint_control)))CALL cp__a("cp_control_types.F",563)
    IF(.NOT.(ddapc_restraint_control%ref_count>0))CALL cp__a("cp_control_types.F",564)
...
! *****************************************************************************
  SUBROUTINE ddapc_control_retain(ddapc_restraint_control)
    ...
    IF(.NOT.(ASSOCIATED(ddapc_restraint_control)))CALL cp__a("cp_control_types.F",591)
...
! *****************************************************************************
  SUBROUTINE becke_control_create(becke_control)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(becke_control)))CALL cp__a("cp_control_types.F",608)
...
! *****************************************************************************
  SUBROUTINE becke_control_release(becke_control)
    ...
    IF(.NOT.(ASSOCIATED(becke_control)))CALL cp__a("cp_control_types.F",636)
    IF(.NOT.(becke_control%ref_count>0))CALL cp__a("cp_control_types.F",637)
...
! *****************************************************************************
  SUBROUTINE becke_control_retain(becke_control)
    ...
    IF(.NOT.(ASSOCIATED(becke_control)))CALL cp__a("cp_control_types.F",664)
    becke_control%ref_count=becke_control%ref_count+1
...
! *****************************************************************************
  SUBROUTINE s2_control_create(s2_restraint_control)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(s2_restraint_control)))CALL cp__a("cp_control_types.F",680)
...
! *****************************************************************************
  SUBROUTINE s2_control_release(s2_restraint_control)
    ...
    IF(.NOT.(ASSOCIATED(s2_restraint_control)))CALL cp__a("cp_control_types.F",702)
    IF(.NOT.(s2_restraint_control%ref_count>0))CALL cp__a("cp_control_types.F",703)
...
! *****************************************************************************
  SUBROUTINE s2_control_retain(s2_restraint_control)
    ...
    IF(.NOT.(ASSOCIATED(s2_restraint_control)))CALL cp__a("cp_control_types.F",725)
    s2_restraint_control%ref_count=s2_restraint_control%ref_count+1
...
! *****************************************************************************
  SUBROUTINE dft_control_create(dft_control)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(dft_control)))CALL cp__a("cp_control_types.F",742)
...
! *****************************************************************************
  SUBROUTINE dft_control_retain(dft_control)
    ...
    IF(.NOT.(ASSOCIATED(dft_control)))CALL cp__a("cp_control_types.F",772)
    IF(.NOT.(dft_control%ref_count>0))CALL cp__a("cp_control_types.F",773)
...
! *****************************************************************************
  SUBROUTINE dft_control_release(dft_control)
    ...
    IF (ASSOCIATED(dft_control)) THEN
       IF(.NOT.(dft_control%ref_count>0))CALL cp__a("cp_control_types.F",791)
       dft_control%ref_count=dft_control%ref_count-1
       IF (dft_control%ref_count==0) THEN
          ...
          IF (ASSOCIATED(dft_control%period_efield))THEN
             DEALLOCATE(dft_control%period_efield%polarisation)
...
! *****************************************************************************
  SUBROUTINE gapw_control_create(gapw_control)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(gapw_control)))CALL cp__a("cp_control_types.F",823)
...
! *****************************************************************************
  SUBROUTINE qs_control_create(qs_control)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(qs_control)))CALL cp__a("cp_control_types.F",837)
    ALLOCATE (qs_control)
...
! *****************************************************************************
  SUBROUTINE tddfpt_control_create(tddfpt_control)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(tddfpt_control)))CALL cp__a("cp_control_types.F",906)
...
! *****************************************************************************
  SUBROUTINE dftb_control_create(dftb_control)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(dftb_control)))CALL cp__a("cp_control_types.F",988)
...
! *****************************************************************************
  SUBROUTINE scptb_control_create(scptb_control)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(scptb_control)))CALL cp__a("cp_control_types.F",1022)
...
! *****************************************************************************
  SUBROUTINE se_control_create(se_control)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(se_control)))CALL cp__a("cp_control_types.F",1053)
    ALLOCATE(se_control)
...
! *****************************************************************************
  SUBROUTINE admm_control_create(admm_control)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(admm_control)))CALL cp__a("cp_control_types.F",1083)
...
! *****************************************************************************
  SUBROUTINE sccs_control_create(sccs_control)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(sccs_control)))CALL cp__a("cp_control_types.F",1117)
...
! *****************************************************************************
  SUBROUTINE sccs_control_release(sccs_control)
    ...
    IF (ASSOCIATED(sccs_control)) THEN
       IF(.NOT.(sccs_control%ref_count > 0))CALL cp__a("cp_control_types.F",1155)
