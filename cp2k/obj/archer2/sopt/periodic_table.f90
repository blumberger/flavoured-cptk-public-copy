# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/common/periodic_table.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/common/periodic_table.F"
!-----------------------------------------------------------------------------!
...
!> \par Literature
!>      M. E. Wieser and M. Berglund,
!>      Atomic weights of the elements 2007 (IUPAC Technical Report),
!>      Pure Appl. Chem. 81, 2131-2156 (2009)
!> \par History
!>      27.05.2010 Update of the atomic weights
!>      20.10.2009 Use vdW Radii from the Cambridge Structural Database
!> \author JGH, MK
! *****************************************************************************
...
# 22 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/common/periodic_table.F" 2

  IMPLICIT NONE

  PRIVATE

  PUBLIC :: init_periodic_table, ptable, nelem,&
            get_ptable_info
...
! *****************************************************************************
!> \brief Pass information about the kind given the element symbol
!> \param symbol ...
!> \param number ...
!> \param amass ...
!> \param ielement ...
  ...
  SUBROUTINE get_ptable_info(symbol,number,amass,ielement,covalent_radius,&
    ...
    ELSE
      IF (ielem_found < 0) THEN
        CALL cp__b("common/periodic_table.F",102,"Unknown element symbol <"//TRIM(symbol)//"> found.")
      END IF
    END IF
