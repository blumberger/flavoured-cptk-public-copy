# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/qmmm_se_forces.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/qmmm_se_forces.F"
!-----------------------------------------------------------------------------!
...
# 52 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/qmmm_se_forces.F" 2
...
! *****************************************************************************
  SUBROUTINE deriv_se_qmmm_matrix(qs_env,qmmm_env,particles_mm,mm_cell,para_env,&
    ...
    IF (calc_force) THEN
       ...
       CASE DEFAULT
          ! Otherwise stop..
          CALL cp__b("qmmm_se_forces.F",133,"Method not available")
       END SELECT
       ...
       DO ispin = 1, dft_control%nspins
          ...
          END DO Kinds
       END DO
       IF(.NOT.(iqm==number_qm_atoms))CALL cp__a("qmmm_se_forces.F",214)
