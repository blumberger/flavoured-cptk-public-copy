# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/input_cp2k_restarts_util.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/input_cp2k_restarts_util.F"
!-----------------------------------------------------------------------------!
...
# 20 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/input_cp2k_restarts_util.F" 2
...
! *****************************************************************************
  SUBROUTINE section_velocity_val_set(velocity_section, particles, velocity, conv_factor)
    ...
    IF(.NOT.(ASSOCIATED(velocity_section)))CALL cp__a("input_cp2k_restarts_util.F",62)
    IF(.NOT.(velocity_section%ref_count>0))CALL cp__a("input_cp2k_restarts_util.F",63)
    section => velocity_section%section
    ik=section_get_keyword_index(section,"_DEFAULT_KEYWORD_")
    IF(ik==-2)&
       CALL cp_abort(cp__l("input_cp2k_restarts_util.F",67),&
    ...
    IF(.NOT.(check))CALL cp__a("input_cp2k_restarts_util.F",73)
