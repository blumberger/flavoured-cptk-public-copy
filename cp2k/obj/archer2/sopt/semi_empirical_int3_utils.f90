# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/semi_empirical_int3_utils.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/semi_empirical_int3_utils.F"
!-----------------------------------------------------------------------------!
...
# 20 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/semi_empirical_int3_utils.F" 2
...
! *****************************************************************************
  FUNCTION ijkl_low_3(sepi, sepj, ij, kl, li, lj, lk, ll, ic, itype, eval) RESULT(res)
...
! Computing only residual Integral Values
    ...
    CALL cp__b("semi_empirical_int3_utils.F",143,"")
...
!> \author Teodoro Laino [tlaino]
! *****************************************************************************
  FUNCTION coeff_int_3(l1, l2, add) RESULT(coeff)
    INTEGER, INTENT(in)                      :: l1, l2
    REAL(KIND=dp), INTENT(in)                :: add
    REAL(KIND=dp)                            :: coeff
...
! Computing only residual Integral Values
    ...
    END IF
    ! We should NEVER reach this point
    CALL cp__b("semi_empirical_int3_utils.F",177,"")
...
! Computing only residual Integral Derivatives
    ...
    END IF
    ! We should NEVER reach this point
    CALL cp__b("semi_empirical_int3_utils.F",214,"")
