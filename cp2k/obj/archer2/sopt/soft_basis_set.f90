# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/aobasis/soft_basis_set.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/aobasis/soft_basis_set.F"
!-----------------------------------------------------------------------------!
...
# 27 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/aobasis/soft_basis_set.F" 2
...
! *****************************************************************************
  SUBROUTINE create_soft_basis(orb_basis,soft_basis,eps_fit,rc,paw_atom,&
    ...
    INTEGER :: ico, ipgf, ipgf_s, iset, iset_s, ishell, lshell, lshell_old, &
      m, maxco, maxpgf, maxpgf_s, maxshell, maxshell_s, ncgf, nset, nset_s, &
      nsgf
