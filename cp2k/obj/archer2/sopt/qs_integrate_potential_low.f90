# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/qs_integrate_potential_low.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/qs_integrate_potential_low.F"
!-----------------------------------------------------------------------------!
...
# 22 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/qs_integrate_potential_low.F" 2
...
! *****************************************************************************
    ...
    IF(PRESENT(use_subpatch)) THEN
       IF(use_subpatch)THEN
         ...
         IF(.NOT.(PRESENT(subpatch_pattern)))CALL cp__a("qs_integrate_potential_low.F",151)
       ENDIF
    ENDIF
    ...
    DO i=1,3
      ...
      ELSE
        ...
        IF (ub_cube(i)+offset>UBOUND(grid,i).OR.lb_cube(i)+offset<LBOUND(grid,i)) THEN
           CALL cp__b("qs_integrate_potential_low.F",391,"")
        ENDIF
...
# 406 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/qs_integrate_potential_low.F" 2
