# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/eri_mme_methods.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/eri_mme_methods.F"
!-----------------------------------------------------------------------------!
...
# 41 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/eri_mme_methods.F" 2
...
! *****************************************************************************
  SUBROUTINE error_est_pgf_params_from_basis(qs_kind_set, basis_type, zet_mm, zet_c, l_c)
    ...
    DO ikind = 1, nkind
      ...
      IF(.NOT.(ASSOCIATED(basis_set)))CALL cp__a("eri_mme_methods.F",247)
    ...
    ALLOCATE(l_c(2))
    ALLOCATE(zet_c(2))
    IF(.NOT.(zet_l .GT. 0.0_dp .AND. l_zet .GT. 0))CALL cp__a("eri_mme_methods.F",274)
