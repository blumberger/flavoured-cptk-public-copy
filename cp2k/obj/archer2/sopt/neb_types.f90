# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/motion/neb_types.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/motion/neb_types.F"
!-----------------------------------------------------------------------------!
...
# 27 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/motion/neb_types.F" 2
...
! *****************************************************************************
  SUBROUTINE neb_var_create(neb_var, neb_env, full_allocation)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(neb_var)))CALL cp__a("motion/neb_types.F",89)
    allocate_all = .FALSE.
    ...
    IF (neb_env%use_colvar) THEN
       ...
       IF(.NOT.(neb_env%nsize_int>0))CALL cp__a("motion/neb_types.F",101)
...
! *****************************************************************************
  SUBROUTINE neb_var_release(neb_var)
    ...
    IF(.NOT.(ASSOCIATED(neb_var)))CALL cp__a("motion/neb_types.F",130)
