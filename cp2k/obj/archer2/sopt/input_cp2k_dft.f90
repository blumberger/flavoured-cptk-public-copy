# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/input_cp2k_dft.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/input_cp2k_dft.F"
!-----------------------------------------------------------------------------!
...
MODULE input_cp2k_dft
  USE bibliography,                    ONLY: &
       Andreussi2012, Avezac2005, Bengtsson1999, Blochl1995, Brelaz1979, &
       Dewar1977, Dewar1985, Dudarev1997, Dudarev1998, Elstner1998, &
       Fattebert2002, Guidon2010, Hu2007, Hunt2003, Iannuzzi2005, &
       Iannuzzi2006, Iannuzzi2007, Kolafa2004, Krack2000, Krack2002, &
       Kunert2003, Lippert1997, Lippert1999, Perdew1981, Porezag1995, &
       Repasky2002, Rocha2006, Schenter2008, Schiffmann2015, Seifert1996, &
       Souza2002, Stengel2009, Stewart1982, Stewart1989, Stewart2007, &
       Thiel1992, Tozer1996, Umari2002, VandeVondele2003, VandeVondele2005a, &
       VandeVondele2005b, VandeVondele2006, Weber2008, Zhao1994, Zhechkov2005
  ...
  USE input_constants,                 ONLY: &
       atomic_guess, cholesky_dbcsr, cholesky_inverse, cholesky_off, &
       cholesky_reduce, cholesky_restore, constant_env, core_guess, &
       diag_block_davidson, diag_block_krylov, diag_filter_matrix, diag_ot, &
       diag_standard, dispersion_d3, dispersion_uff, &
       do_admm_aux_exch_func_bee, do_admm_aux_exch_func_default, &
       do_admm_aux_exch_func_none, do_admm_aux_exch_func_opt, &
       do_admm_aux_exch_func_pbex, do_admm_basis_projection, &
       do_admm_blocked_projection, do_admm_blocking_purify_full, &
       do_admm_charge_constrained_projection, do_admm_exch_scaling_merlot, &
       do_admm_exch_scaling_none, do_admm_purify_cauchy, &
       do_admm_purify_cauchy_subspace, do_admm_purify_mcweeny, &
       do_admm_purify_mo_diag, do_admm_purify_mo_no_diag, &
       do_admm_purify_none, do_admm_purify_none_dm, do_arnoldi, do_bch, &
       do_cn, do_ddapc_constraint, do_ddapc_restraint, do_em, do_etrs, &
       ...
       do_lri_inv, do_lri_inv_auto, do_lri_opt_all, do_lri_opt_coeff, &
       do_lri_opt_exps, do_lri_pseudoinv_diag, do_lri_pseudoinv_svd, &
       ...
       general_roks, high_spin_roks, history_guess, kg_color_dsatur, &
       kg_color_greedy, kg_tnadd_atomic, kg_tnadd_embed, ls_2pnt, ls_3pnt, &
       ls_gold, ls_none, mopac_guess, no_excitations, no_guess, numerical, &
       oe_gllb, oe_lb, oe_none, oe_saop, oe_sic, op_loc_berry, op_loc_boys, &
       op_loc_pipek, orb_dx2, orb_dxy, orb_dy2, orb_dyz, orb_dz2, orb_dzx, &
       orb_px, orb_py, orb_pz, orb_s, ot_algo_irac, ot_algo_taylor_or_diag, &
       ot_chol_irac, ot_lwdn_irac, ot_mini_broyden, ot_mini_cg, ot_mini_diis, &
       ot_mini_sd, ot_poly_irac, ot_precond_full_all, &
       ...
       outer_scf_s2_constraint, plus_u_lowdin, plus_u_mulliken, &
       plus_u_mulliken_charges, pw_interp, ramp_env, random_guess, &
       real_time_propagation, ref_charge_atomic, ref_charge_mulliken, &
       rel_dkh, rel_none, rel_pot_erfc, rel_pot_full, rel_sczora_mp, &
       rel_trans_atom, rel_trans_full, rel_trans_molecule, rel_zora, &
       rel_zora_full, rel_zora_mp, restart_guess, sccs_andreussi, &
       sccs_derivative_cd3, sccs_derivative_cd5, sccs_derivative_cd7, &
       sccs_derivative_fft, sccs_fattebert_gygi, shape_function_density, &
       shape_function_gaussian, sic_ad, sic_eo, sic_list_all, &
       sic_list_unpaired, sic_mauri_spz, sic_mauri_us, sic_none, slater, &
       smear_energy_window, smear_fermi_dirac, smear_list, sparse_guess, &
       spline3_nopbc_interp, spline3_pbc_interp, tddfpt_davidson, &
       tddfpt_excitations, tddfpt_lanczos, tddfpt_singlet, tddfpt_triplet, &
       use_coulomb, use_diff, use_no, use_restart_wfn, use_rt_restart, &
       use_scf_wfn, weight_type_mass, weight_type_unit, wfi_aspc_nr, &
       ...
       wfi_use_prev_wf_method_nr, xas_1s_type, xas_2p_type, xas_2s_type, &
       xas_dip_len2, xas_dip_vel, xas_dscf, xas_none, xas_tp_fh, xas_tp_flex, &
...
# 136 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/input_cp2k_dft.F" 2
...
! *****************************************************************************
  SUBROUTINE create_dft_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_dft.F",163)
...
! *****************************************************************************
  SUBROUTINE create_implicit_solv_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_dft.F",435)
...
! *****************************************************************************
  SUBROUTINE create_sphere_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_dft.F",482)
...
! *****************************************************************************
  SUBROUTINE create_center_section(section)
    ...
    NULLIFY(keyword)
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_dft.F",515)
...
! *****************************************************************************
  SUBROUTINE create_localize_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_dft.F",571)
...
! *****************************************************************************
  SUBROUTINE print_wanniers(section)
    ...
    IF(.NOT.(ASSOCIATED(section)))CALL cp__a("input_cp2k_dft.F",795)
...
! *****************************************************************************
  SUBROUTINE create_print_dft_section(section)
    ...
    TYPE(keyword_type), POINTER              :: keyword
    TYPE(section_type), POINTER              :: print_key, sub_print_key, &
                                                subsection

    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_dft.F",882)
...
! *****************************************************************************
  SUBROUTINE create_wfn_mix_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_dft.F",2135)
...
! *****************************************************************************
  SUBROUTINE create_molecular_states_section(print_key)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(print_key)))CALL cp__a("input_cp2k_dft.F",2241)
...
! *****************************************************************************
  SUBROUTINE create_wannier_states_section(print_key)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(print_key)))CALL cp__a("input_cp2k_dft.F",2295)
    NULLIFY(print_key2, keyword)
...
! *****************************************************************************
  SUBROUTINE create_qs_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_dft.F",2348)
    ...
    CALL keyword_create(keyword, name="METHOD",&
         ...
         usage="METHOD GAPW",&
         enum_c_vals=s2a("GAPW","GAPW_XC","GPW","LRIGPW",&
         ...
         enum_i_vals=(/ do_method_gapw, do_method_gapw_xc, do_method_gpw, do_method_lrigpw,&
...
! *****************************************************************************
  SUBROUTINE create_dftb_control_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_dft.F",2729)
...
! *****************************************************************************
  SUBROUTINE create_scptb_control_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_dft.F",2803)
...
! *****************************************************************************
  SUBROUTINE create_admm_section(section)
    ...
    NULLIFY(keyword)
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_dft.F",2894)
...
! *****************************************************************************
  SUBROUTINE create_dftb_parameter_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_dft.F",2996)
...
! *****************************************************************************
  SUBROUTINE create_se_control_section(section)
    ...
    NULLIFY(keyword)
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_dft.F",3097)
...
! *****************************************************************************
  SUBROUTINE create_lr_corr_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_dft.F",3247)
...
! *****************************************************************************
  SUBROUTINE create_coulomb_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_dft.F",3290)
...
! *****************************************************************************
  SUBROUTINE create_exchange_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_dft.F",3335)
...
! *****************************************************************************
  SUBROUTINE create_screening_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_dft.F",3383)
...
! *****************************************************************************
  SUBROUTINE create_se_print_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_dft.F",3418)
    CALL section_create(section,name="print",&
...
! *****************************************************************************
  SUBROUTINE create_se_ga_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_dft.F",3460)
...
! *****************************************************************************
  SUBROUTINE create_se_memory_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_dft.F",3490)
...
! *****************************************************************************
  SUBROUTINE create_mulliken_section(section)
    ...
    NULLIFY(keyword)
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_dft.F",3537)
...
! *****************************************************************************
  SUBROUTINE create_density_fitting_section(section)
    ...
    NULLIFY(keyword, print_key)
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_dft.F",3578)
...
! *****************************************************************************
  SUBROUTINE create_ddapc_restraint_section(section)
    ...
    NULLIFY(keyword, print_key)
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_dft.F",3654)
...
! *****************************************************************************
  SUBROUTINE create_becke_restraint_section(section)
    ...
    NULLIFY(keyword, print_key)
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_dft.F",3729)
...
! *****************************************************************************
  SUBROUTINE create_s2_restraint_section(section)
    ...
    NULLIFY(keyword)
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_dft.F",3802)
...
! *****************************************************************************
  SUBROUTINE create_tddfpt_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_dft.F",3847)
...
! *****************************************************************************
  SUBROUTINE create_relativistic_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_dft.F",3998)
    ...
    CALL keyword_create(keyword, name="transformation",&
         ...
         usage="transformation (FULL|MOLECULE|ATOM)", default_i_val=rel_trans_full,&
...
! *****************************************************************************
  SUBROUTINE create_scf_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_dft.F",4076)
...
! *****************************************************************************
  SUBROUTINE create_kg_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_dft.F",4393)
...
! *****************************************************************************
  SUBROUTINE create_outer_scf_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_dft.F",4482)
    ...
    CALL keyword_create(keyword, name="TYPE",&
         ...
         enum_c_vals=s2a( "DDAPC_CONSTRAINT", "S2_CONSTRAINT", "BECKE_CONSTRAINT", "NONE" ),&
...
! *****************************************************************************
  SUBROUTINE create_bsse_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_dft.F",4583)
...
! *****************************************************************************
  SUBROUTINE create_print_bsse_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_dft.F",4677)
    CALL section_create(section,name="print",&
...
! *****************************************************************************
  SUBROUTINE create_gspace_interp_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_dft.F",4714)
...
! *****************************************************************************
  SUBROUTINE create_lrigpw_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_dft.F",4790)
...
! *****************************************************************************
  SUBROUTINE create_optimize_lri_basis_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_dft.F",4863)
...
! *****************************************************************************
  SUBROUTINE create_mgrid_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_dft.F",4984)
...
! *****************************************************************************
  SUBROUTINE create_interp_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_dft.F",5082)
    CALL section_create(section,name="interpolator",&
...
! *****************************************************************************
  SUBROUTINE create_sic_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_dft.F",5175)
...
! *****************************************************************************
  SUBROUTINE create_low_spin_roks_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_dft.F",5242)
...
! *****************************************************************************
  SUBROUTINE create_ext_pot_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_dft.F",5281)
...
! *****************************************************************************
  SUBROUTINE create_ext_den_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_dft.F",5371)
...
! *****************************************************************************
  SUBROUTINE create_ext_vxc_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_dft.F",5438)
...
! *****************************************************************************
  SUBROUTINE create_per_efield_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_dft.F",5472)
...
! *****************************************************************************
  SUBROUTINE create_efield_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_dft.F",5522)
...
! *****************************************************************************
  SUBROUTINE create_ot_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_dft.F",5602)
...
! *****************************************************************************
  SUBROUTINE create_diagonalization_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_dft.F",5968)
...
! *****************************************************************************
  SUBROUTINE create_davidson_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_dft.F",6084)
...
! *****************************************************************************
  SUBROUTINE create_krylov_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_dft.F",6171)
...
! *****************************************************************************
  SUBROUTINE create_diag_subspace_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_dft.F",6234)
...
! *****************************************************************************
  SUBROUTINE create_xas_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_dft.F",6300)
...
! *****************************************************************************
  SUBROUTINE create_smear_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_dft.F",6574)
...
! *****************************************************************************
  SUBROUTINE create_rtp_section(section)
    ...
    NULLIFY(keyword)
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_dft.F",6686)
...
! *****************************************************************************
  SUBROUTINE create_constant_env_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_dft.F",6940)
...
! *****************************************************************************
  SUBROUTINE create_gaussian_env_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_dft.F",6975)
...
! *****************************************************************************
  SUBROUTINE create_ramp_env_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_dft.F",7011)
...
! *****************************************************************************
  SUBROUTINE create_sccs_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_dft.F",7066)
