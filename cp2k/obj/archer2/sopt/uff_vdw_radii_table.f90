# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/uff_vdw_radii_table.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/uff_vdw_radii_table.F"
!-----------------------------------------------------------------------------!
...
# 17 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/uff_vdw_radii_table.F" 2
...
! *****************************************************************************
  PURE SUBROUTINE get_uff_vdw_radius(z, radius, found)
    ...
    CHARACTER(len=*), PARAMETER :: routineN = 'get_uff_vdw_radius', &
