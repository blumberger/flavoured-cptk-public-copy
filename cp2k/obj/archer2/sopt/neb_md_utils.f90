# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/motion/neb_md_utils.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/motion/neb_md_utils.F"
!-----------------------------------------------------------------------------!
...
# 37 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/motion/neb_md_utils.F" 2
...
! *****************************************************************************
  SUBROUTINE get_temperatures(vels,particle_set,temperatures,ekin,factor)
    ...
    INTEGER                                  :: i_rep, iatom, ivar, n_rep, &
                                                natom, nvar
