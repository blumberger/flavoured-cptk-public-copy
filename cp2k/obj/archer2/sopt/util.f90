# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/common/util.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/common/util.F"
!-----------------------------------------------------------------------------!
...
! *****************************************************************************
MODULE util
  USE cp_array_sort_i4,                ONLY: cp_1d_i4_sort
  USE cp_array_sort_i8,                ONLY: cp_1d_i8_sort
  ...
  INTERFACE sort
     MODULE PROCEDURE cp_1d_r_sort, cp_1d_i4_sort, cp_1d_i8_sort,&
...
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/common/sort_m.f90" 1
    isize   = iend-istart+1
...
# 178 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/common/util.F" 2
...
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/common/sort_m.f90" 1
    ...
    END IF
    DEALLOCATE(work, work2, tmp_index, bck_index)
# 204 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/common/util.F" 2
