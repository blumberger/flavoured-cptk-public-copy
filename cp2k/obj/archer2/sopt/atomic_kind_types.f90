# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/subsys/atomic_kind_types.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/subsys/atomic_kind_types.F"
!-----------------------------------------------------------------------------!
...
# 34 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/subsys/atomic_kind_types.F" 2
...
! *****************************************************************************
  SUBROUTINE deallocate_atomic_kind_set(atomic_kind_set)
    ...
    ELSE
       CALL cp_abort(cp__l("subsys/atomic_kind_types.F",113),&
...
! *****************************************************************************
  SUBROUTINE get_atomic_kind_set(atomic_kind_set,&
    ...
    IF (ASSOCIATED(atomic_kind_set)) THEN
       ...
       END DO
    ELSE
       CALL cp__b("subsys/atomic_kind_types.F",323,"The pointer atomic_kind_set is not associated")
    END IF
...
! *****************************************************************************
  SUBROUTINE set_atomic_kind(atomic_kind,element_symbol,name,mass,kind_number,&
    ...
    IF (ASSOCIATED(atomic_kind)) THEN
       ...
       IF (PRESENT(atom_list)) THEN
          ...
          IF (n > 0) THEN
             ...
             atomic_kind%natom = n
          ELSE
             CALL cp__b("subsys/atomic_kind_types.F",381,"An invalid atom_list was supplied")
          END IF
       END IF
    ...
    ELSE
       CALL cp__b("subsys/atomic_kind_types.F",394,"The pointer atomic_kind is not associated")
    END IF
