# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/core_ae.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/core_ae.F"
!-----------------------------------------------------------------------------!
...
# 44 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/core_ae.F" 2
  ...
  SUBROUTINE build_core_ae(matrix_h, matrix_p, force, virial, calculate_forces, use_virial, nder,&
    ...
    DO WHILE (neighbor_list_iterate(nl_iterator)==0)
       ...
       IF (calculate_forces) THEN
          ...
          IF(.NOT.(ASSOCIATED(p_block)))CALL cp__a("core_ae.F",246)
