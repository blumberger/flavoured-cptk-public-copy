# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/farming_methods.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/farming_methods.F"
!-----------------------------------------------------------------------------!
...
# 26 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/farming_methods.F" 2
...
! *****************************************************************************
  SUBROUTINE farming_parse_input(farming_env,root_section,para_env)
    ...
    IF (has_dep) THEN
       IF(.NOT.(farming_env%master_slave))CALL cp__a("farming_methods.F",236)
       IF(.NOT.(.NOT.farming_env%cycle))CALL cp__a("farming_methods.F",237)
    ENDIF
