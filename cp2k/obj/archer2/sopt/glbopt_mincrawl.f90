# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/swarm/glbopt_mincrawl.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/swarm/glbopt_mincrawl.F"
!-----------------------------------------------------------------------------!
...
# 40 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/swarm/glbopt_mincrawl.F" 2
...
! *****************************************************************************
 FUNCTION temp2tempstep(this, temp_in_au) RESULT(step)
   ...
   !WRITE(*,*) "step: ", step
   IF(step > this%tempstep_max) CALL cp__b("swarm/glbopt_mincrawl.F",347,"temp2tempstep: step > tempstep_max")
...
! *****************************************************************************
 SUBROUTINE mincrawl_register_minima(this, report)
    ...
    IF(ASSOCIATED(start_minima)) THEN
      ...
      IF(start_minima%n_active < 0) CALL cp__b("swarm/glbopt_mincrawl.F",390,"negative n_active")
