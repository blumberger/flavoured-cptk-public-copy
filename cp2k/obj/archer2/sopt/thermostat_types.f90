# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/motion/thermostat/thermostat_types.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/motion/thermostat/thermostat_types.F"
!-----------------------------------------------------------------------------!
...
# 36 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/motion/thermostat/thermostat_types.F" 2
...
! *****************************************************************************
  SUBROUTINE allocate_thermostats(thermostats)
    ...
    IF(.NOT.(check))CALL cp__a("motion/thermostat/thermostat_types.F",118)
...
! *****************************************************************************
  SUBROUTINE retain_thermostats(thermostats)
    ...
    IF (ASSOCIATED(thermostats)) THEN
       IF(.NOT.(thermostats%ref_count>0))CALL cp__a("motion/thermostat/thermostat_types.F",163)
...
! *****************************************************************************
  SUBROUTINE release_thermostats(thermostats)
    ...
    IF (check) THEN
       ...
       IF(.NOT.(check))CALL cp__a("motion/thermostat/thermostat_types.F",187)
       thermostats%ref_count=thermostats%ref_count-1
...
! *****************************************************************************
  SUBROUTINE create_thermostat_type(thermostat, simpar, section, skip_region, label)
    ...
    TYPE(section_vals_type), POINTER         :: al_section, csvr_section, &
    ...
    ELSE IF (thermostat%type_of_thermostat==do_thermo_gle) THEN
     ...
     section=gle_section)
       ...
       IF(.NOT.(region==do_region_massive))CALL cp__a("motion/thermostat/thermostat_types.F",282)
    END IF
...
! *****************************************************************************
  SUBROUTINE release_thermostat_type(thermostat)
    ...
    IF (check) THEN
       ...
       IF(.NOT.(check))CALL cp__a("motion/thermostat/thermostat_types.F",326)
