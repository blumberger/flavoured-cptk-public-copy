# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/admm_methods.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/admm_methods.F"
!-----------------------------------------------------------------------------!
...
# 84 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/admm_methods.F" 2
  ...
  SUBROUTINE admm_mo_merge_ks_matrix(qs_env)
    ...
    SELECT CASE(admm_env%purification_method)
      ...
      CASE(do_admm_purify_mo_diag, do_admm_purify_mo_no_diag)
         !do nothing
      CASE DEFAULT
         CALL cp__b("admm_methods.F",247,"admm_mo_merge_ks_matrix: unknown purification method")
    END SELECT
  ...
  SUBROUTINE admm_mo_merge_derivs(ispin, admm_env, mo_set, mo_coeff, mo_coeff_aux_fit, mo_derivs, &
    ...
    SELECT CASE(admm_env%purification_method)
      ...
      CASE(do_admm_purify_none, do_admm_purify_cauchy,do_admm_purify_cauchy_subspace)
          !do nothing
      CASE DEFAULT
          CALL cp__b("admm_methods.F",294,"admm_mo_merge_derivs: unknown purification method")
    END SELECT
