# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/common/distribution_1d_types.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/common/distribution_1d_types.F"
!-----------------------------------------------------------------------------!
...
# 31 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/common/distribution_1d_types.F" 2
...
SUBROUTINE distribution_1d_create(distribution_1d,para_env,listbased_distribution,&
  ...
  ALLOCATE(distribution_1d%n_el(my_n_lists), distribution_1d%list(my_n_lists),&
       stat=stat)
  IF(.NOT.(stat==0))CALL cp__a("common/distribution_1d_types.F",132)
...
SUBROUTINE distribution_1d_retain(distribution_1d)
  ...
  IF(.NOT.(ASSOCIATED(distribution_1d)))CALL cp__a("common/distribution_1d_types.F",164)
  IF(.NOT.(distribution_1d%ref_count>0))CALL cp__a("common/distribution_1d_types.F",165)
...
SUBROUTINE distribution_1d_release(distribution_1d)
  ...
  IF (ASSOCIATED(distribution_1d)) THEN
     IF(.NOT.(distribution_1d%ref_count>0))CALL cp__a("common/distribution_1d_types.F",190)
     distribution_1d%ref_count=distribution_1d%ref_count-1
