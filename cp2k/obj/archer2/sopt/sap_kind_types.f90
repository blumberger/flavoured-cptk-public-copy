# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/sap_kind_types.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/sap_kind_types.F"
!-----------------------------------------------------------------------------!
...
# 16 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/sap_kind_types.F" 2
...
! *****************************************************************************
  SUBROUTINE release_sap_int(sap_int)
    ...
    IF(.NOT.(ASSOCIATED(sap_int)))CALL cp__a("sap_kind_types.F",70)
...
! *****************************************************************************
  SUBROUTINE get_alist(sap_int, alist, atom)
    ...
    ELSE IF (i==0) THEN
      NULLIFY(alist)
    ELSE
      CALL cp__b("sap_kind_types.F",130,"")
    END IF
