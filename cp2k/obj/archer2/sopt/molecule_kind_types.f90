# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/subsys/molecule_kind_types.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/subsys/molecule_kind_types.F"
!-----------------------------------------------------------------------------!
...
# 44 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/subsys/molecule_kind_types.F" 2
  ...
  SUBROUTINE setup_colvar_counters(colv_list, ncolv)
    ...
    IF (ASSOCIATED(colv_list)) THEN
       DO k = 1, SIZE(colv_list)
          ...
          CASE DEFAULT
             CALL cp__b("subsys/molecule_kind_types.F",301,"")
          END SELECT
       END DO
    END IF
...
! *****************************************************************************
  SUBROUTINE deallocate_molecule_kind_set(molecule_kind_set)
        ...
        IF (ASSOCIATED(molecule_kind_set(imolecule_kind)%bend_kind_set)) THEN
           DO i = 1, SIZE(molecule_kind_set(imolecule_kind)%bend_kind_set)
              IF (ASSOCIATED(molecule_kind_set(imolecule_kind)%bend_kind_set(i)%legendre%coeffs)) &
                 ...
                 NULLIFY(molecule_kind_set(imolecule_kind)%bend_kind_set(i)%legendre%coeffs)
           END DO
    ...
    ELSE
      CALL cp__b("subsys/molecule_kind_types.F",500,"The pointer molecule_kind_set is not associated and cannot be deallocated")
    END IF
...
! *****************************************************************************
  SUBROUTINE get_molecule_kind(molecule_kind,atom_list,bond_list,bend_list,&
    ...
    ELSE
      ...
      CALL cp__b("subsys/molecule_kind_types.F",713,"The pointer molecule_kind is not associated")
...
! *****************************************************************************
  SUBROUTINE get_molecule_kind_set(molecule_kind_set,maxatom,natom,&
    ...
    ELSE
      ...
      CALL cp__b("subsys/molecule_kind_types.F",807,"The pointer molecule_kind_set is not associated")
...
! *****************************************************************************
 SUBROUTINE set_molecule_kind(molecule_kind,name,mass,charge,kind_number,&
    ...
    ELSE
      ...
      CALL cp__b("subsys/molecule_kind_types.F",998,"The pointer molecule_kind is not associated")
...
! *****************************************************************************
  SUBROUTINE write_molecule_kind(molecule_kind,output_unit)
    ...
    IF (output_unit>0) THEN
      ...
      ELSE
          CALL cp__b("subsys/molecule_kind_types.F",1078,"")
      END IF
  ...
  SUBROUTINE write_molecule_kind_set(molecule_kind_set,subsys_section)
    ...
    IF (output_unit>0) THEN
      IF (ASSOCIATED(molecule_kind_set)) THEN
        ...
        END IF
      ELSE
         CALL cp__b("subsys/molecule_kind_types.F",1159,"")
      END IF
