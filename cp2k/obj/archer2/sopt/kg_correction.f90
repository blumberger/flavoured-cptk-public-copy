# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/kg_correction.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/kg_correction.F"
!-----------------------------------------------------------------------------!
...
# 39 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/kg_correction.F" 2
  ...
  SUBROUTINE kg_ekin_embed(qs_env, ks_matrix, gapw, gapw_xc, ekin_mol, calc_force)
    ...
    DO isub=1,kg_env%nsubsets
      ...
      IF(my_gapw.OR.my_gapw_xc)&
         CALL cp__b("kg_correction.F",169," KG is currently not compatible with all electron calculations.")
      ...
      ! this case has NOT been tested yet...
        ...
        IF(.NOT.ASSOCIATED(vxc_tau))&
           CALL cp_abort(cp__l("kg_correction.F",206),&
