# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/topology_gromos.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/topology_gromos.F"
!-----------------------------------------------------------------------------!
...
# 33 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/topology_gromos.F" 2
...
! *****************************************************************************
  SUBROUTINE read_topology_gromos (file_name,topology,para_env,subsys_section)
    ...
    INTEGER :: begin, handle, i, iatom, ibond, icon, ii(50), index_now, &
      iresid, isolvent, itemp, itype, iw, jatom, natom, natom_prev, nbond, &
      nbond_prev, ncon, nsolute, nsolvent, ntype, offset, offset2, stat
    ...
    DO ibond=1+nbond_prev,nbond+nbond_prev
       ...
       ELSE
          IF(atom_info%id_molname(iatom)/=atom_info%id_molname(jatom)) THEN
             CALL cp__b("topology_gromos.F",603,"")
          END IF
       END IF
    END DO
