# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/qmmm_pw_grid.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/qmmm_pw_grid.F"
!-----------------------------------------------------------------------------!
...
# 32 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/qmmm_pw_grid.F" 2
...
! *****************************************************************************
  SUBROUTINE pw_grid_create_copy_no_pbc(pw_grid_in, pw_grid_out, pw_mode)
    ...
    IF(.NOT.(pw_grid_in%ngpts_cut>0))CALL cp__a("qmmm_pw_grid.F",130)
    IF(.NOT.(.NOT.ASSOCIATED(pw_grid_out)))CALL cp__a("qmmm_pw_grid.F",131)
    ...
    IF(.NOT.(pw_grid_in%grid_span==FULLSPACE))CALL cp__a("qmmm_pw_grid.F",195)
