# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/qs_subsys_methods.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/qs_subsys_methods.F"
!-----------------------------------------------------------------------------!
...
# 43 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/qs_subsys_methods.F" 2
...
! *****************************************************************************
  SUBROUTINE qs_subsys_create(subsys, para_env, root_section,force_env_section, subsys_section, &
    ...
    IF(ASSOCIATED(subsys)) CALL cp__b("qs_subsys_methods.F",91,"qs_subsys_create: subsys already associated")
    ...
    IF (PRESENT(cell)) THEN
       ...
       ELSE
          ...
          CALL cell_clone(my_cell, my_cell_ref)
          use_ref_cell = .FALSE.
       END IF
    ELSE
    ...
    CALL write_cell(my_cell,subsys_section,cell_ref=my_cell_ref)
