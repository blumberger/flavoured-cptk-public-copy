# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/qs_dftb3_methods.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/qs_dftb3_methods.F"
!-----------------------------------------------------------------------------!
...
# 44 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/qs_dftb3_methods.F" 2
...
! *****************************************************************************
  SUBROUTINE build_dftb3_diagonal(qs_env,ks_matrix,rho,mcharge,energy,&
    ...
    INTEGER                                  :: atom_i, atom_j, handle, i, &
                                                ia, iatom, ic, icol, ikind, &
                                                irow, is, jatom, jkind, &
                                                natom, nimg
    ...
    REAL(KIND=dp)                            :: dr, eb3, eloc, fi, gmij, ua, &
                                                ui, uj, zeff
    ...
    IF ( calculate_forces ) THEN
       ...
       DO WHILE (neighbor_list_iterate(nl_iterator)==0)
          ...
          ELSE
             ...
             IF(.NOT.(ic > 0))CALL cp__a("qs_dftb3_methods.F",183)
          END IF
    ...
    IF ( .NOT. just_energy ) THEN
       ...
       DO WHILE (neighbor_list_iterate(nl_iterator)==0)
          ...
          ELSE
             ic = cell_to_index(cellind(1),cellind(2),cellind(3))
             IF(.NOT.(ic > 0))CALL cp__a("qs_dftb3_methods.F",263)
          END IF
          ...
          IF(.NOT.(found))CALL cp__a("qs_dftb3_methods.F",277)
          DO is=1,SIZE(ks_matrix,1)
             ...
             IF(.NOT.(found))CALL cp__a("qs_dftb3_methods.F",282)
