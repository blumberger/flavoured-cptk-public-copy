# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/eip_environment.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/eip_environment.F"
!-----------------------------------------------------------------------------!
...
# 43 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/eip_environment.F" 2
...
! *****************************************************************************
  SUBROUTINE eip_init(eip_env, root_section, para_env, force_env_section,&
    ...
    IF(.NOT.(ASSOCIATED(eip_env)))CALL cp__a("eip_environment.F",91)
...
!   ------------------------------------------------------------------------
    ...
    DO i=1,SIZE(atomic_kind_set)
      ...
      SELECT CASE(eip_atomic_kind_name)
        ...
        CASE DEFAULT
          CALL cp_abort(cp__l("eip_environment.F",256),&
