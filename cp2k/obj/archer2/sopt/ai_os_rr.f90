# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/aobasis/ai_os_rr.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/aobasis/ai_os_rr.F"
!-----------------------------------------------------------------------------!
...
# 12 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/aobasis/ai_os_rr.F" 2
...
! *****************************************************************************
!> \brief   Calculation of the basic Obara-Saika reccurence relation
!> \param rap ...
!> \param la_max ...
!> \param rbp ...
!> \param lb_max ...
...
! *****************************************************************************
  SUBROUTINE os_rr_coul(rap,la_max,rbp,lb_max,rcp,zet,ldrr1,ldrr2,rr)
    ...
    CHARACTER(len=*), PARAMETER :: routineN = 'os_rr_coul', &
    ...
    DO la=1,la_max
       ...
       DO ay=0,la-ax
          ...
          ELSEIF(ax.GT.0) THEN
             ...
             ENDIF
          ELSE
             CALL cp__b("aobasis/ai_os_rr.F",186,"")
          ENDIF
       ENDDO
       ENDDO
    ENDDO
          ...
          DO lb=1,lb_max
             ...
             DO by=0,lb-bx
                ...
                ELSEIF(bx.GT.0) THEN
                   ...
                   ENDIF
                ELSE
                   CALL cp__b("aobasis/ai_os_rr.F",259,"")
                ENDIF
             ENDDO
             ENDDO
          ENDDO
