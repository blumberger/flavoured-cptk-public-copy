# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/input_cp2k_mp2.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/input_cp2k_mp2.F"
!-----------------------------------------------------------------------------!
...
MODULE input_cp2k_mp2
  ...
  USE input_constants,                 ONLY: &
       ...
       mp2_ri_optimize_basis, numerical, ri_coulomb, ri_mp2_laplace, &
       ri_mp2_method_gpw, ri_overlap, ri_rpa_g0w0_crossing_newton, &
...
# 45 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/input_cp2k_mp2.F" 2
...
! *****************************************************************************
  SUBROUTINE create_mp2_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_mp2.F",69)
    CALL section_create(section,"WF_CORRELATION",&
         ...
         citations=(/DelBen2012,DelBen2013,DelBen2015,DelBen2015b/))
...
! *****************************************************************************
  SUBROUTINE create_mp2_direct(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_mp2.F",239)
...
! *****************************************************************************
  SUBROUTINE create_ri_mp2(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_mp2.F",271)
...
! *****************************************************************************
  SUBROUTINE create_opt_ri_basis(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_mp2.F",325)
...
! *****************************************************************************
  SUBROUTINE create_ri_laplace(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_mp2.F",407)
...
! *****************************************************************************
  SUBROUTINE create_ri_rpa(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_mp2.F",450)
    ...
    CALL keyword_create(&
     ...
     CALL keyword_create(&
          ...
          name="IM_TIME",&
          variants=(/"IMAG_TIME"/),&
          description="Decide whether to calculate Q-matrix for imaginary times.",&
          usage="IM_TIME",&
          default_l_val=.FALSE.,&
          lone_keyword_l_val=.TRUE.)
     CALL section_add_keyword(section,keyword)
...
! *****************************************************************************
  SUBROUTINE create_ri_g0w0(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_mp2.F",563)
...
! *****************************************************************************
  SUBROUTINE create_wfc_gpw(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_mp2.F",814)
...
! *****************************************************************************
  SUBROUTINE create_cphf(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_mp2.F",886)
...
! *****************************************************************************
  SUBROUTINE create_mp2_potential(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_mp2.F",926)
