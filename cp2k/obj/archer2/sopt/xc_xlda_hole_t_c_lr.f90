# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/xc/xc_xlda_hole_t_c_lr.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/xc/xc_xlda_hole_t_c_lr.F"
!-----------------------------------------------------------------------------!
...
# 29 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/xc/xc_xlda_hole_t_c_lr.F" 2
...
! *****************************************************************************
  SUBROUTINE xlda_hole_t_c_lr_lda_eval ( rho_set, deriv_set, order, params)
    ...
    IF(.NOT.(ASSOCIATED(rho_set)))CALL cp__a("xc/xc_xlda_hole_t_c_lr.F",148)
    IF(.NOT.(rho_set%ref_count>0))CALL cp__a("xc/xc_xlda_hole_t_c_lr.F",149)
    IF(.NOT.(ASSOCIATED(deriv_set)))CALL cp__a("xc/xc_xlda_hole_t_c_lr.F",150)
    IF(.NOT.(deriv_set%ref_count>0))CALL cp__a("xc/xc_xlda_hole_t_c_lr.F",151)
    ...
    END IF
    IF (order>1.OR.order<-1) THEN
       CALL cp__b("xc/xc_xlda_hole_t_c_lr.F",174,"derivatives bigger than 1 not implemented")
    END IF

    IF ( R == 0.0_dp ) THEN
      CALL cp__b("xc/xc_xlda_hole_t_c_lr.F",178,"Cutoff_Radius 0.0 not implemented")
    END IF
...
! *****************************************************************************
  SUBROUTINE xlda_hole_t_c_lr_lsd_eval ( rho_set, deriv_set, order, params)
    ...
    IF(.NOT.(ASSOCIATED(rho_set)))CALL cp__a("xc/xc_xlda_hole_t_c_lr.F",347)
    IF(.NOT.(rho_set%ref_count>0))CALL cp__a("xc/xc_xlda_hole_t_c_lr.F",348)
    IF(.NOT.(ASSOCIATED(deriv_set)))CALL cp__a("xc/xc_xlda_hole_t_c_lr.F",349)
    IF(.NOT.(deriv_set%ref_count>0))CALL cp__a("xc/xc_xlda_hole_t_c_lr.F",350)
    ...
    END IF
    IF (order>1.OR.order<-1) THEN
       CALL cp__b("xc/xc_xlda_hole_t_c_lr.F",377,"derivatives bigger than 2 not implemented")
    END IF
    IF ( R == 0.0_dp ) THEN
      CALL cp__b("xc/xc_xlda_hole_t_c_lr.F",380,"Cutoff_Radius 0.0 not implemented")
    END IF
