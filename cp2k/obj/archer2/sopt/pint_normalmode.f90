# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/motion/pint_normalmode.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/motion/pint_normalmode.F"
!-----------------------------------------------------------------------------!
...
# 26 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/motion/pint_normalmode.F" 2
...
! *****************************************************************************
  SUBROUTINE normalmode_env_create(normalmode_env,normalmode_section,p,kT,propagator)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(normalmode_env)))CALL cp__a("motion/pint_normalmode.F",67)
    ...
    ELSE IF (propagator == propagator_rpmd) THEN
     ...
     ELSE
        CALL cp__b("motion/pint_normalmode.F",155,"UNKNOWN PROPAGATOR FOR PINT SELECTED")
     END IF
...
! *****************************************************************************
  SUBROUTINE normalmode_release(normalmode_env)
    ...
    IF (ASSOCIATED(normalmode_env)) THEN
      IF(.NOT.(normalmode_env%ref_count>0))CALL cp__a("motion/pint_normalmode.F",174)
...
! *****************************************************************************
  SUBROUTINE normalmode_retain(normalmode_env)
    ...
    IF(.NOT.(ASSOCIATED(normalmode_env)))CALL cp__a("motion/pint_normalmode.F",200)
    IF(.NOT.(normalmode_env%ref_count>0))CALL cp__a("motion/pint_normalmode.F",201)
    normalmode_env%ref_count=normalmode_env%ref_count+1
...
! *****************************************************************************
  SUBROUTINE normalmode_x2u(normalmode_env,ux,x)
    ...
    IF(.NOT.(ASSOCIATED(normalmode_env)))CALL cp__a("motion/pint_normalmode.F",275)
    IF(.NOT.(normalmode_env%ref_count>0))CALL cp__a("motion/pint_normalmode.F",276)
...
! *****************************************************************************
  SUBROUTINE normalmode_u2x(normalmode_env,ux,x)
    ...
    IF(.NOT.(ASSOCIATED(normalmode_env)))CALL cp__a("motion/pint_normalmode.F",301)
    IF(.NOT.(normalmode_env%ref_count>0))CALL cp__a("motion/pint_normalmode.F",302)
...
! *****************************************************************************
  SUBROUTINE normalmode_f2uf(normalmode_env,uf,f)
    ...
    IF(.NOT.(ASSOCIATED(normalmode_env)))CALL cp__a("motion/pint_normalmode.F",326)
    IF(.NOT.(normalmode_env%ref_count>0))CALL cp__a("motion/pint_normalmode.F",327)
