# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/rpa_im_time.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/rpa_im_time.F"
!-----------------------------------------------------------------------------!
...
# 42 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/rpa_im_time.F" 2
...
! *****************************************************************************
    ...
    DO i_block_virt = 1,n_blocks_local_virt
      ...
      DO i_block_occ = 1,n_blocks_local_occ
        ...
        IF(.NOT.(size_occ==size_virt))CALL cp__a("rpa_im_time.F",839)
    ...
    DO group_iter=1,ngroup-1
      ...
      DO i_block_virt = 1,buffer_rec(group_iter)%sizes(1)
        ...
        DO i_block_occ = 1,n_blocks_local_occ
          ...
          IF(.NOT.(size_occ==size_virt))CALL cp__a("rpa_im_time.F",955)
