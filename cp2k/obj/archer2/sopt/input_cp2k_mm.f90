# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/input_cp2k_mm.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/input_cp2k_mm.F"
!-----------------------------------------------------------------------------!
...
MODULE input_cp2k_mm
  ...
  USE force_field_kind_types,          ONLY: &
       ...
       do_ff_g96, do_ff_harmonic, do_ff_legendre, do_ff_mixed_bend_stretch, &
       do_ff_mm2, do_ff_mm3, do_ff_mm4, do_ff_morse, do_ff_opls, &
       do_ff_quartic, do_ff_undef
...
# 51 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/input_cp2k_mm.F" 2
...
! *****************************************************************************
  SUBROUTINE create_mm_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_mm.F",79)
...
! *****************************************************************************
  SUBROUTINE create_print_mm_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_mm.F",119)
...
! *****************************************************************************
  SUBROUTINE create_forcefield_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_mm.F",219)
...
! *****************************************************************************
  SUBROUTINE create_SPLINE_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_mm.F",378)
...
! *****************************************************************************
  SUBROUTINE create_TORSION_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_mm.F",456)
...
! *****************************************************************************
  SUBROUTINE create_IMPROPER_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_mm.F",523)
...
! *****************************************************************************
  SUBROUTINE create_OPBEND_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_mm.F",581)
...
! *****************************************************************************
  SUBROUTINE create_BEND_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_mm.F",642)
    ...
    CALL keyword_create(keyword, name="LEGENDRE",&
...
! *****************************************************************************
  SUBROUTINE create_BOND_section(section,label)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_mm.F",772)
    NULLIFY(keyword)
...
! *****************************************************************************
  SUBROUTINE create_charges_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_mm.F",861)
...
! *****************************************************************************
  SUBROUTINE create_charge_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_mm.F",890)
...
! *****************************************************************************
  SUBROUTINE create_quadrupole_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_mm.F",926)
...
! *****************************************************************************
  SUBROUTINE create_dipole_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_mm.F",964)
...
! *****************************************************************************
  SUBROUTINE create_damping_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_mm.F",1004)
...
! *****************************************************************************
  SUBROUTINE create_shell_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_mm.F",1062)
...
! *****************************************************************************
  SUBROUTINE create_NONBONDED14_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_mm.F",1159)
...
! *****************************************************************************
  SUBROUTINE create_NONBONDED_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_mm.F",1198)
...
! *****************************************************************************
  SUBROUTINE create_neighbor_lists_section(section)
    ...
    NULLIFY(keyword)
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_mm.F",1275)
...
! *****************************************************************************
  SUBROUTINE create_GENPOT_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_mm.F",1322)
...
! *****************************************************************************
  SUBROUTINE create_EAM_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_mm.F",1414)
...
! *****************************************************************************
  SUBROUTINE create_QUIP_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_mm.F",1459)
...
! *****************************************************************************
  SUBROUTINE create_LJ_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_mm.F",1518)
...
! *****************************************************************************
  SUBROUTINE create_Williams_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_mm.F",1584)
...
! *****************************************************************************
  SUBROUTINE create_Goodwin_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_mm.F",1657)
...
! *****************************************************************************
  SUBROUTINE create_ipbv_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_mm.F",1743)
...
! *****************************************************************************
  SUBROUTINE create_BMHFT_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_mm.F",1795)
...
! *****************************************************************************
  SUBROUTINE create_BMHFTD_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_mm.F",1883)
...
! *****************************************************************************
  SUBROUTINE create_Buck4r_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_mm.F",1987)
...
! *****************************************************************************
  SUBROUTINE create_Buckmorse_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_mm.F",2102)
...
! *****************************************************************************
  SUBROUTINE create_Tersoff_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_mm.F",2218)
...
! *****************************************************************************
 SUBROUTINE create_Siepmann_section(section)
   ...
   IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_mm.F",2370)
...
! *****************************************************************************
  SUBROUTINE create_dipoles_section(print_key,label,print_level)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(print_key)))CALL cp__a("input_cp2k_mm.F",2467)
