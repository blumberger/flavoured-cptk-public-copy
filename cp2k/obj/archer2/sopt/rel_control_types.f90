# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/rel_control_types.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/rel_control_types.F"
!-----------------------------------------------------------------------------!
...
# 24 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/rel_control_types.F" 2
...
! *****************************************************************************
  SUBROUTINE rel_c_retain(rel_control)
    ...
    IF(.NOT.(ASSOCIATED(rel_control)))CALL cp__a("rel_control_types.F",113)

    IF(.NOT.(rel_control%ref_count > 0))CALL cp__a("rel_control_types.F",115)
...
! *****************************************************************************
  SUBROUTINE rel_c_release(rel_control)
    ...
    IF (ASSOCIATED(rel_control)) THEN
      IF(.NOT.(rel_control%ref_count>0))CALL cp__a("rel_control_types.F",138)
      rel_control%ref_count = rel_control%ref_count - 1
...
! *****************************************************************************
  SUBROUTINE rel_c_read_parameters(rel_control,dft_section)
    ...
    IF(.NOT.(ASSOCIATED(rel_control)))CALL cp__a("rel_control_types.F",169)
    IF(.NOT.(rel_control%ref_count > 0))CALL cp__a("rel_control_types.F",170)
    IF(.NOT.(ASSOCIATED(dft_section)))CALL cp__a("rel_control_types.F",171)
