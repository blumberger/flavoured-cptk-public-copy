# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/aobasis/ai_onecenter.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/aobasis/ai_onecenter.F"
!-----------------------------------------------------------------------------!
...
# 36 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/aobasis/ai_onecenter.F" 2
...
! *****************************************************************************
  SUBROUTINE sg_overlap ( smat, l, pa, pb )
    ...
    CHARACTER(len=*), PARAMETER :: routineN = 'sg_overlap', &
    ...
    IF(.NOT.(.NOT.(n>SIZE(smat,1).OR.m>SIZE(smat,2))))CALL cp__a("aobasis/ai_onecenter.F",78)
...
! *****************************************************************************
  SUBROUTINE sg_kinetic ( kmat, l, pa, pb )
    ...
    CHARACTER(len=*), PARAMETER :: routineN = 'sg_kinetic', &
      routineP = moduleN//':'//routineN
    ...
    IF(.NOT.(.NOT.(n>SIZE(kmat,1).OR.m>SIZE(kmat,2))))CALL cp__a("aobasis/ai_onecenter.F",119)
...
! *****************************************************************************
  SUBROUTINE sg_nuclear ( umat, l, pa, pb )
    ...
    CHARACTER(len=*), PARAMETER :: routineN = 'sg_nuclear', &
      routineP = moduleN//':'//routineN
    ...
    IF(.NOT.(.NOT.(n>SIZE(umat,1).OR.m>SIZE(umat,2))))CALL cp__a("aobasis/ai_onecenter.F",158)
...
! *****************************************************************************
  SUBROUTINE sg_kinnuc ( umat, l, pa, pb )
    ...
    CHARACTER(len=*), PARAMETER :: routineN = 'sg_kinnuc', &
      routineP = moduleN//':'//routineN
    ...
    IF(.NOT.(.NOT.(n>SIZE(umat,1).OR.m>SIZE(umat,2))))CALL cp__a("aobasis/ai_onecenter.F",197)
...
! *****************************************************************************
  SUBROUTINE sg_erf ( upmat, l, a, pa, pb )
    ...
    CHARACTER(len=*), PARAMETER :: routineN = 'sg_erf', &
      routineP = moduleN//':'//routineN
    ...
    IF(.NOT.(.NOT.(n>SIZE(upmat,1).OR.m>SIZE(upmat,2))))CALL cp__a("aobasis/ai_onecenter.F",263)
    ...
    DO iq = 1, m
      SELECT CASE ( l )
      CASE DEFAULT
        CALL cp__b("aobasis/ai_onecenter.F",278,"")
      CASE ( 0 )
        ! nothing left to do
      CASE ( 1 )
        DO ip = 1, n
...
! *****************************************************************************
  SUBROUTINE sg_proj_ol ( spmat, l, p, k, rc )
    ...
    CHARACTER(len=*), PARAMETER :: routineN = 'sg_proj_ol', &
      routineP = moduleN//':'//routineN

    REAL(KIND=dp)                            :: orc, pf

    IF(.NOT.(SIZE(spmat)>=SIZE(p)))CALL cp__a("aobasis/ai_onecenter.F",350)
...
! *****************************************************************************
  SUBROUTINE sg_gpot ( vpmat, k, rc, l, pa, pb )
    ...
    CHARACTER(len=*), PARAMETER :: routineN = 'sg_gpot', &
      routineP = moduleN//':'//routineN
    ...
    IF(.NOT.(.NOT.(n>SIZE(vpmat,1).OR.m>SIZE(vpmat,2))))CALL cp__a("aobasis/ai_onecenter.F",394)
...
! *****************************************************************************
  SUBROUTINE sg_conf ( gmat, rc, k, l, pa, pb )
    ...
    CHARACTER(len=*), PARAMETER :: routineN = 'sg_conf', &
      routineP = moduleN//':'//routineN
    ...
    IF(.NOT.(.NOT.(n>SIZE(gmat,1).OR.m>SIZE(gmat,2))))CALL cp__a("aobasis/ai_onecenter.F",438)
...
! *****************************************************************************
  SUBROUTINE sg_exchange ( eri, nu, pa, lac, pb, lbd )
    ...
    CHARACTER(len=*), PARAMETER :: routineN = 'sg_exchange', &
      routineP = moduleN//':'//routineN
...
! *****************************************************************************
  SUBROUTINE sg_erfc ( umat, l, a, pa, pb )
    ...
    CHARACTER(len=*), PARAMETER :: routineN = 'sg_erfc', &
      routineP = moduleN//':'//routineN
    ...
    IF(.NOT.(.NOT.(n>SIZE(umat,1).OR.m>SIZE(umat,2))))CALL cp__a("aobasis/ai_onecenter.F",642)
...
! *****************************************************************************
  SUBROUTINE sto_overlap ( smat,  na, pa, nb, pb )
    ...
    CHARACTER(len=*), PARAMETER :: routineN = 'sto_overlap', &
      routineP = moduleN//':'//routineN
    ...
    IF(.NOT.(.NOT.(n>SIZE(smat,1).OR.m>SIZE(smat,2))))CALL cp__a("aobasis/ai_onecenter.F",725)
...
! *****************************************************************************
  SUBROUTINE sto_kinetic ( kmat, l, na, pa, nb, pb )
    ...
    CHARACTER(len=*), PARAMETER :: routineN = 'sto_kinetic', &
      routineP = moduleN//':'//routineN
    ...
    IF(.NOT.(.NOT.(n>SIZE(kmat,1).OR.m>SIZE(kmat,2))))CALL cp__a("aobasis/ai_onecenter.F",774)
...
! *****************************************************************************
  SUBROUTINE sto_nuclear ( umat, na, pa, nb, pb )
    ...
    CHARACTER(len=*), PARAMETER :: routineN = 'sto_nuclear', &
      routineP = moduleN//':'//routineN
    ...
    IF(.NOT.(.NOT.(n>SIZE(umat,1).OR.m>SIZE(umat,2))))CALL cp__a("aobasis/ai_onecenter.F",823)
...
! *****************************************************************************
  SUBROUTINE sto_conf ( gmat, rc, k, na, pa, nb, pb )
    ...
    CHARACTER(len=*), PARAMETER :: routineN = 'sto_conf', &
      routineP = moduleN//':'//routineN
    ...
    IF(.NOT.(.NOT.(n>SIZE(gmat,1).OR.m>SIZE(gmat,2))))CALL cp__a("aobasis/ai_onecenter.F",871)
...
! *****************************************************************************
  SUBROUTINE num_overlap ( smat, ra, rb, wr )
    ...
    CHARACTER(len=*), PARAMETER :: routineN = 'num_overlap', &
      routineP = moduleN//':'//routineN
    ...
    IF(.NOT.(.NOT.(n>SIZE(smat,1).OR.m>SIZE(smat,2))))CALL cp__a("aobasis/ai_onecenter.F",944)
...
! *****************************************************************************
  SUBROUTINE num_kinetic ( kmat, l, ra, dra, rb, drb, r, wr )
    ...
    CHARACTER(len=*), PARAMETER :: routineN = 'num_kinetic', &
      routineP = moduleN//':'//routineN
    ...
    IF(.NOT.(.NOT.(n>SIZE(kmat,1).OR.m>SIZE(kmat,2))))CALL cp__a("aobasis/ai_onecenter.F",987)
...
! *****************************************************************************
  SUBROUTINE num_nuclear ( umat, ra, rb, r, wr )
    ...
    CHARACTER(len=*), PARAMETER :: routineN = 'num_nuclear', &
      routineP = moduleN//':'//routineN
    ...
    IF(.NOT.(.NOT.(n>SIZE(umat,1).OR.m>SIZE(umat,2))))CALL cp__a("aobasis/ai_onecenter.F",1027)
...
! *****************************************************************************
  SUBROUTINE num_kinnuc ( umat, l, ra, dra, rb, drb, r, wr )
    ...
    CHARACTER(len=*), PARAMETER :: routineN = 'num_kinnuc', &
      routineP = moduleN//':'//routineN
    ...
    IF(.NOT.(.NOT.(n>SIZE(umat,1).OR.m>SIZE(umat,2))))CALL cp__a("aobasis/ai_onecenter.F",1070)
...
! *****************************************************************************
  SUBROUTINE num_erf ( upmat, a, ra, rb, r, wr )
    ...
    CHARACTER(len=*), PARAMETER :: routineN = 'num_erf', &
      routineP = moduleN//':'//routineN
    ...
    IF(.NOT.(.NOT.(n>SIZE(upmat,1).OR.m>SIZE(upmat,2))))CALL cp__a("aobasis/ai_onecenter.F",1112)
...
! *****************************************************************************
  SUBROUTINE num_proj_ol ( spmat, l, ra, k, rc, r, wr )
    ...
    CHARACTER(len=*), PARAMETER :: routineN = 'num_proj_ol', &
      routineP = moduleN//':'//routineN
    ...
    n =  SIZE ( ra, 2 )
    IF(.NOT.(SIZE(spmat)>=n))CALL cp__a("aobasis/ai_onecenter.F",1163)
...
! *****************************************************************************
  SUBROUTINE num_gpot ( vpmat, k, rc,  ra, rb, r, wr )
    ...
    CHARACTER(len=*), PARAMETER :: routineN = 'num_gpot', &
      routineP = moduleN//':'//routineN
    ...
    IF(.NOT.(.NOT.(n>SIZE(vpmat,1).OR.m>SIZE(vpmat,2))))CALL cp__a("aobasis/ai_onecenter.F",1216)
...
! *****************************************************************************
  SUBROUTINE num_conf ( gmat, rc, k, ra, rb, r, wr )
    ...
    CHARACTER(len=*), PARAMETER :: routineN = 'num_conf', &
      routineP = moduleN//':'//routineN
    ...
    IF(.NOT.(.NOT.(n>SIZE(gmat,1).OR.m>SIZE(gmat,2))))CALL cp__a("aobasis/ai_onecenter.F",1267)
