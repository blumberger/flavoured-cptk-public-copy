# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/subsys/virial_types.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/subsys/virial_types.F"
!-----------------------------------------------------------------------------!
...
# 15 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/subsys/virial_types.F" 2
...
! *****************************************************************************
  SUBROUTINE virial_release(virial)
    ...
    IF (ASSOCIATED(virial)) THEN
       IF(.NOT.(virial%ref_count>0))CALL cp__a("subsys/virial_types.F",218)
