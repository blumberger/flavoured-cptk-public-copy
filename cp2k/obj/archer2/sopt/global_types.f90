# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/global_types.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/global_types.F"
!-----------------------------------------------------------------------------!
...
# 29 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/global_types.F" 2
...
! *****************************************************************************
  SUBROUTINE globenv_create(globenv)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(globenv)))CALL cp__a("global_types.F",101)
    ALLOCATE(globenv)
...
SUBROUTINE globenv_retain(globenv)
  ...
  IF(.NOT.(ASSOCIATED(globenv)))CALL cp__a("global_types.F",129)
  IF(.NOT.(globenv%ref_count>0))CALL cp__a("global_types.F",130)
...
SUBROUTINE globenv_release(globenv)
  ...
  IF (ASSOCIATED(globenv)) THEN
     IF(.NOT.(globenv%ref_count>0))CALL cp__a("global_types.F",146)
     globenv%ref_count=globenv%ref_count-1
