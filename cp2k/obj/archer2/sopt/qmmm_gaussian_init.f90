# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/qmmm_gaussian_init.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/qmmm_gaussian_init.F"
!-----------------------------------------------------------------------------!
...
# 39 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/qmmm_gaussian_init.F" 2
...
! Statements
    ...
    ELSE
       use_geep_lib = .TRUE.
       IF(.NOT.(num_geep_gauss>=min_geep_lib_gauss))CALL cp__a("qmmm_gaussian_init.F",107)
       IF(.NOT.(num_geep_gauss<=max_geep_lib_gauss))CALL cp__a("qmmm_gaussian_init.F",108)
    END IF
    ...
    CASE(do_qmmm_gauss,do_qmmm_swave)
       ...
       ELSE IF (Ndim-1 == 0) THEN
          ...
          DEALLOCATE(c_radius)
       ELSE
          CALL cp__b("qmmm_gaussian_init.F",143,"")
       END IF
       !
