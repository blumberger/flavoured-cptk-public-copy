# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/input_cp2k_mixed.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/input_cp2k_mixed.F"
!-----------------------------------------------------------------------------!
...
# 45 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/input_cp2k_mixed.F" 2
...
! *****************************************************************************
  SUBROUTINE create_mix_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_mixed.F",73)
...
!    CALL section_release(sub2section)
    ...
    !----------PC
     ...
     CALL cp_print_key_section_create(print_key_section=print_key,&
          name="NEW_STATE_INDICES",&
          description="Prints the mapping of the adiabatic state indices of the previous timestep onto the new timestep", &
          common_iter_levels=1,&
          filename="")
     CALL section_add_subsection(sub2section,print_key)
     CALL section_release(print_key)
...
! *****************************************************************************
  SUBROUTINE create_print_mix_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_mixed.F",1288)
