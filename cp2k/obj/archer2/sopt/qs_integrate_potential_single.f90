# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/qs_integrate_potential_single.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/qs_integrate_potential_single.F"
!-----------------------------------------------------------------------------!
...
# 79 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/qs_integrate_potential_single.F" 2
    ...
    DO ikind=1,SIZE(atomic_kind_set)
       ...
       DO j=1,lppl
         SELECT CASE (j)
           ...
           CASE DEFAULT
             CALL cp__b("qs_integrate_potential_single.F",389,"")
         END SELECT
       END DO
       ...
       DO j=1,npme
         ...
         IF (use_virial) THEN
           ...
           CALL cp__b("qs_integrate_potential_single.F",435,"Virial not debuged for CORE_PPL")
         END IF
       END DO
      ...
      DO iexp_nlcc=1,nexp_nlcc
         ...
         DO j=1,nc
           SELECT CASE (j)
             ...
             CASE DEFAULT
               CALL cp__b("qs_integrate_potential_single.F",587,"")
           END SELECT
         END DO
