# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/input_cp2k_almo.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/input_cp2k_almo.F"
!-----------------------------------------------------------------------------!
...
# 33 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/input_cp2k_almo.F" 2
...
SUBROUTINE create_almo_scf_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_almo.F",63)
...
SUBROUTINE create_almo_eda_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_almo.F",554)
...
SUBROUTINE create_optimizer_section(section,optimizer_id)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_almo.F",604)
    ...
    CASE(optimizer_xalmo_pcg)
       ...
       optimizer_type=optimizer_pcg
    CASE DEFAULT
       CALL cp__b("input_cp2k_almo.F",624,"No default values allowed")
    END SELECT
