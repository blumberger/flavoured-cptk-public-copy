# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/common/cg_test.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/common/cg_test.F"
!-----------------------------------------------------------------------------!
...
# 28 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/common/cg_test.F" 2
...
SUBROUTINE clebsch_gordon_test ()
    ...
    CHARACTER(len=*), PARAMETER :: routineN = 'clebsch_gordon_test', &
      routineP = moduleN//':'//routineN
    INTEGER, PARAMETER                       :: l = 7

    COMPLEX(KIND=dp), ALLOCATABLE, &
      DIMENSION(:)                           :: a1, a2, a3
    INTEGER                                  :: il, iw, l1, l2, ll, lp, m1, &
                                                m2, mm, mp, na
