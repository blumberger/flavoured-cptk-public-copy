# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/qs_dftb_utils.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/qs_dftb_utils.F"
!-----------------------------------------------------------------------------!
...
# 23 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/qs_dftb_utils.F" 2
...
! *****************************************************************************
  SUBROUTINE deallocate_dftb_atom_param(dftb_parameter)
    ...
    IF(.NOT.(ASSOCIATED(dftb_parameter)))CALL cp__a("qs_dftb_utils.F",83)
...
! *****************************************************************************
  SUBROUTINE get_dftb_atom_param(dftb_parameter,name,typ,defined,z,zeff,natorb,&
    ...
    REAL(KIND=dp), OPTIONAL                  :: energy, cutoff, xi, di, &
                                                rcdisp, dudq

    CHARACTER(LEN=*), PARAMETER :: routineN = 'get_dftb_atom_param', &
      routineP = moduleN//':'//routineN

    IF(.NOT.(ASSOCIATED(dftb_parameter)))CALL cp__a("qs_dftb_utils.F",125)
...
! *****************************************************************************
  SUBROUTINE set_dftb_atom_param(dftb_parameter,name,typ,defined,z,zeff,natorb,&
    ...
    IF(.NOT.(ASSOCIATED(dftb_parameter)))CALL cp__a("qs_dftb_utils.F",183)
