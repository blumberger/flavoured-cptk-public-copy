# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/input_cp2k_atom.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/input_cp2k_atom.F"
!-----------------------------------------------------------------------------!
...
MODULE input_cp2k_atom
  ...
  USE input_constants,                 ONLY: &
       atom_basis_run, atom_energy_run, atom_no_run, atom_pseudo_run, &
       barrier_conf, contracted_gto, do_analytic, do_dkh0_atom, do_dkh1_atom, &
...
# 41 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/input_cp2k_atom.F" 2
...
! *****************************************************************************
  SUBROUTINE create_atom_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_atom.F",68)
...
! *****************************************************************************
  SUBROUTINE create_atom_print_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_atom.F",203)
...
! *****************************************************************************
  SUBROUTINE create_atom_aebasis_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_atom.F",333)
...
! *****************************************************************************
  SUBROUTINE create_atom_ppbasis_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_atom.F",353)
...
! *****************************************************************************
  SUBROUTINE atom_basis_section(section)
    ...
    IF(.NOT.(ASSOCIATED(section)))CALL cp__a("input_cp2k_atom.F",376)
    NULLIFY(keyword)
...
! *****************************************************************************
  SUBROUTINE create_atom_method_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_atom.F",537)
...
! *****************************************************************************
  SUBROUTINE create_zmp_section(section)
    ...
    NULLIFY(subsection,keyword)
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_atom.F",623)
...
! *****************************************************************************
  SUBROUTINE create_zmp_restart_section(section)
    ...
    NULLIFY(keyword)
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_atom.F",674)
...
! *****************************************************************************
  SUBROUTINE create_external_vxc(section)
    ...
    NULLIFY(keyword)
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_atom.F",704)
...
! *****************************************************************************
  SUBROUTINE create_optimization_section(section)
    ...
    NULLIFY(keyword)
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_atom.F",739)
...
! *****************************************************************************
  SUBROUTINE create_potential_section(section)
    ...
    NULLIFY(keyword)
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_atom.F",791)
