# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/emd/rt_propagation_utils.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/emd/rt_propagation_utils.F"
!-----------------------------------------------------------------------------!
...
# 62 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/emd/rt_propagation_utils.F" 2
    ...
    IF(rtp%iter<2) THEN
       ...
       ELSE
          CALL build_overlap_matrix(ks_env,nderivative=nder,matrix_s=s_derivs,&
               basis_type_a="ORB",basis_type_b="ORB",sab_nl=sab_orb,qs_input=qs_env%input)
       END IF        
