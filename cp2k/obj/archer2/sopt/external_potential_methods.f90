# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/external_potential_methods.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/external_potential_methods.F"
!-----------------------------------------------------------------------------!
...
# 37 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/external_potential_methods.F" 2
       ...
       DO i = 1, natom
          ...
          DO j = 1, 3
             ...
             IF (ABS(err)>lerr) THEN
                ...
                CALL cp_warn(cp__l("external_potential_methods.F",123),&
                     'ASSERTION (cond) failed at line '//cp_to_string(124)//&
