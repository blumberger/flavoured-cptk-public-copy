# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/dbcsr/base/dbcsr_config.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/dbcsr/base/dbcsr_config.F"
!-----------------------------------------------------------------------------!
...
# 21 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/dbcsr/base/dbcsr_config.F" 2
...
!defaults
    ...
    CASE (mm_driver_blas)
       mm_driver = mm_driver_blas ! always available
    CASE (mm_driver_smm)
       IF(.NOT.has_smm) CALL cp__b("dbcsr/base/dbcsr_config.F",217,"Support for libsmm not compiled in.")
       mm_driver = mm_driver_smm
    CASE (mm_driver_xsmm)
       IF(.NOT.has_xsmm) CALL cp__b("dbcsr/base/dbcsr_config.F",220,"Support for libxsmm not compiled in.")
       mm_driver = mm_driver_xsmm
    CASE DEFAULT
       CALL cp__b("dbcsr/base/dbcsr_config.F",223,"Unkown MM driver")
    END SELECT
