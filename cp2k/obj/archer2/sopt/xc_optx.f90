# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/xc/xc_optx.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/xc/xc_optx.F"
!-----------------------------------------------------------------------------!
...
# 25 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/xc/xc_optx.F" 2
...
! *****************************************************************************
  SUBROUTINE optx_lda_eval(rho_set,deriv_set,grad_deriv,optx_params)
    ...
    IF(.NOT.(ASSOCIATED(rho_set)))CALL cp__a("xc/xc_optx.F",130)
    IF(.NOT.(rho_set%ref_count>0))CALL cp__a("xc/xc_optx.F",131)
    IF(.NOT.(ASSOCIATED(deriv_set)))CALL cp__a("xc/xc_optx.F",132)
    IF(.NOT.(deriv_set%ref_count>0))CALL cp__a("xc/xc_optx.F",133)
    ...
    IF (grad_deriv>1.OR.grad_deriv<-1) THEN
       CALL cp__b("xc/xc_optx.F",149,"derivatives bigger than 1 not implemented")
    END IF
...
! *****************************************************************************
  SUBROUTINE optx_lsd_eval(rho_set,deriv_set,grad_deriv,optx_params)
    ...
    IF(.NOT.(ASSOCIATED(rho_set)))CALL cp__a("xc/xc_optx.F",198)
    IF(.NOT.(rho_set%ref_count>0))CALL cp__a("xc/xc_optx.F",199)
    IF(.NOT.(ASSOCIATED(deriv_set)))CALL cp__a("xc/xc_optx.F",200)
    IF(.NOT.(deriv_set%ref_count>0))CALL cp__a("xc/xc_optx.F",201)
    ...
    IF (grad_deriv>1.OR.grad_deriv<-1) THEN
       CALL cp__b("xc/xc_optx.F",226,"derivatives bigger than 1 not implemented")
    END IF
    DO ispin=1,2
