# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/motion/input_cp2k_vib.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/motion/input_cp2k_vib.F"
!-----------------------------------------------------------------------------!
...
# 41 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/motion/input_cp2k_vib.F" 2
...
! *****************************************************************************
  SUBROUTINE create_vib_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("motion/input_cp2k_vib.F",65)
    ...
    CALL keyword_create(keyword, name="THERMOCHEMISTRY",&
         description="Calculation of the thermochemical data. Valid for molecules in the gas phase. ",&
         default_l_val=.FALSE., lone_keyword_l_val=.TRUE.)
    CALL section_add_keyword(section,keyword)
    CALL keyword_release(keyword)

    CALL keyword_create(keyword, name="TC_TEMPERATURE",&
    ...
    CALL keyword_create(keyword, name="TC_PRESSURE",&
...
! *****************************************************************************
  SUBROUTINE create_print_vib_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("motion/input_cp2k_vib.F",154)
...
! *****************************************************************************
  SUBROUTINE create_mode_selective_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("motion/input_cp2k_vib.F",210)
...
! *****************************************************************************
  SUBROUTINE create_involved_atoms_section(section)
    ...
    NULLIFY(keyword)
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("motion/input_cp2k_vib.F",308)
