# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/motion/dimer_utils.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/motion/dimer_utils.F"
!-----------------------------------------------------------------------------!
...
# 22 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/motion/dimer_utils.F" 2
...
! *****************************************************************************
  SUBROUTINE rotate_dimer(nvec,theta,dt)
    ...
    END IF
    IF(.NOT.(check))CALL cp__a("motion/dimer_utils.F",61)
  ...
  SUBROUTINE update_dimer_vec(dimer_env, motion_section)
    ...
    Main_Loop: DO i = 1, SIZE(dimer_env%nvec), size_array
       ...
       CALL section_vals_val_set(nvec_section,"_DEFAULT_KEYWORD_",r_vals_ptr=array,&
            i_rep_val=i_rep_val)
    END DO Main_Loop
    IF(.NOT.(isize==SIZE(dimer_env%nvec)))CALL cp__a("motion/dimer_utils.F",110)
