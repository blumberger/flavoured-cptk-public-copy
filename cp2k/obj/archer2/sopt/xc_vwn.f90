# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/xc/xc_vwn.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/xc/xc_vwn.F"
!-----------------------------------------------------------------------------!
...
# 37 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/xc/xc_vwn.F" 2
...
! *** Global parameters ***
  ...
  PUBLIC :: vwn_lda_info, vwn_lda_eval, vwn_lsd_eval
...
! *****************************************************************************
  SUBROUTINE vwn_init ( cutoff, vwn_params)
    ...
    CHARACTER(LEN=*), PARAMETER :: routineN = 'vwn_init', &
    ...
    SELECT CASE(TYPE)
       ...
       CASE(do_vwn3)
          ...
          x0a = -0.00475840_dp
       CASE DEFAULT
         CALL cp__b("xc/xc_vwn.F",99," Only functionals VWN3 and VWN5 are supported")
...
! *****************************************************************************
  SUBROUTINE vwn_lda_eval(rho_set,deriv_set,order,vwn_params)
    ...
    IF(.NOT.(ASSOCIATED(rho_set)))CALL cp__a("xc/xc_vwn.F",162)
    IF(.NOT.(rho_set%ref_count>0))CALL cp__a("xc/xc_vwn.F",163)
    IF(.NOT.(ASSOCIATED(deriv_set)))CALL cp__a("xc/xc_vwn.F",164)
    IF(.NOT.(deriv_set%ref_count>0))CALL cp__a("xc/xc_vwn.F",165)
    ...
    END IF
    IF ( order>3.OR.order<-3) THEN
       CALL cp__b("xc/xc_vwn.F",211,"derivatives bigger than 3 not implemented")
    END IF
...
! *****************************************************************************
  SUBROUTINE vwn_lda_0 ( rho, x, e_0, npoints, sc)
    ...
    INTEGER                                  :: ip
    REAL(KIND=dp)                            :: at, dpx, ln1, ln2, px, px0, &
                                                q, xb
...
! *****************************************************************************
  SUBROUTINE vwn_lda_2 ( rho, x, e_rho_rho, npoints, sc)
    ...
    INTEGER                                  :: ip
    REAL(KIND=dp)                            :: at, d2at, d2ex, d2ln1, d2ln2, &
                                                dat, dex, dln1, dln2, dpx, &
                                                fp, ln1, ln2, pa, px, px0, q, &
                                                xb
...
! *****************************************************************************
  SUBROUTINE vwn_lda_3 ( rho, x, e_rho_rho_rho, npoints, sc)
    ...
    INTEGER                                  :: ip
    REAL(KIND=dp) :: at, ax, bx, cx, d2at, d2bx, d2dx, d2ex, d2ln1, d2ln2, &
      d3at, d3ex, d3ln1, d3ln2, dat, dbx, ddx, dex, dln1, dln2, dpx, dx, fp, &
      ln1, ln2, pa, px, px0, q, xb
...
! *****************************************************************************
  SUBROUTINE vwn_lsd_eval(rho_set,deriv_set,order,vwn_params)
    ...
    REAL(KIND=dp)                            :: epsilon_rho, sc
    REAL(KIND=dp), DIMENSION(:, :, :), &
      POINTER                                :: dummy, e_0, e_a, e_aa, e_aaa, &
                                                e_aab, e_ab, e_abb, e_b, &
                                                e_bb, e_bbb, rhoa, rhob
    TYPE(xc_derivative_type), POINTER        :: deriv
    ...
    IF(.NOT.(ASSOCIATED(rho_set)))CALL cp__a("xc/xc_vwn.F",534)
    IF(.NOT.(rho_set%ref_count>0))CALL cp__a("xc/xc_vwn.F",535)
    IF(.NOT.(ASSOCIATED(deriv_set)))CALL cp__a("xc/xc_vwn.F",536)
    IF(.NOT.(deriv_set%ref_count>0))CALL cp__a("xc/xc_vwn.F",537)
    ...
    END IF
    IF ( order>3.OR.order<-3) THEN
      CALL cp__b("xc/xc_vwn.F",602,"derivatives bigger than 3 not implemented")
    END IF
    ...
    SELECT CASE(TYPE)
      ...
      CASE DEFAULT
        CALL cp__b("xc/xc_vwn.F",642," Only functionals VWN3 and VWN5 are supported")
    END SELECT
...
! *****************************************************************************
  SUBROUTINE vwn3_lsd_calc ( rhoa, rhob, e_0, e_a, e_b, e_aa, e_bb, e_ab,&
    ...
    REAL(KIND=dp), DIMENSION(*), &
      INTENT(INOUT)                          :: rhoa, rhob, e_0, e_a, e_b, &
                                                e_aa, e_bb, e_ab, e_aaa, &
                                                e_bbb, e_aab, e_abb
    INTEGER, INTENT(in)                      :: order, npoints
    REAL(KIND=dp)                            :: sc

    INTEGER                                  :: ip
    REAL(KIND=dp) :: ap, bp, cp, myrho, myrhoa, myrhob, Qf, Qp, t1, t10, &
      t100, t101, t1019, t102, t1031, t105, t108, t109, t11, t110, t113, &
      t114, t115, t116, t117, t119, t120, t121, t124, t125, t126, t127, t130, &
      t132, t133, t134, t136, t137, t14, t144, t145, t146, t147, t15, t150, &
      t151, t154, t155, t156, t159, t16, t160, t161, t162, t165, t168, t169, &
      t172, t173, t174, t175, t176, t178, t179, t180, t183, t184, t187, t189, &
