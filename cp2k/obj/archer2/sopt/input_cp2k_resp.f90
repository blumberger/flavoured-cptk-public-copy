# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/input_cp2k_resp.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/input_cp2k_resp.F"
!-----------------------------------------------------------------------------!
...
MODULE input_cp2k_resp
  ...
  USE input_constants,                 ONLY: &
       ...
       do_resp_x_dir, do_resp_y_dir, do_resp_z_dir, gaussian, &
       use_cambridge_vdw_radii, use_uff_vdw_radii
...
# 39 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/input_cp2k_resp.F" 2
...
! *****************************************************************************
  SUBROUTINE create_resp_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_resp.F",64)
    ...
    CALL keyword_create(keyword, name="USE_REPEAT_METHOD",&
...
! *****************************************************************************
  SUBROUTINE create_constraint_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_resp.F",170)
...
! *****************************************************************************
  SUBROUTINE create_restraint_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_resp.F",227)
...
! *****************************************************************************
  SUBROUTINE create_sphere_sampling_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_resp.F",284)
    ...
    CALL keyword_create(keyword, name="AUTO_VDW_RADII_TABLE",&
    ...
    CALL keyword_create(keyword, name="AUTO_RMAX_SCALE",&
    ...
    CALL keyword_create(keyword, name="AUTO_RMIN_SCALE",&
...
! *****************************************************************************
  SUBROUTINE create_slab_sampling_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_resp.F",429)
...
! *****************************************************************************
  SUBROUTINE create_print_resp_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_resp.F",503)
