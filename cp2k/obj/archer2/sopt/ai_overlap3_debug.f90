# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/aobasis/ai_overlap3_debug.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/aobasis/ai_overlap3_debug.F"
!-----------------------------------------------------------------------------!
...
# 19 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/aobasis/ai_overlap3_debug.F" 2
...
! *****************************************************************************
  RECURSIVE FUNCTION os_overlap3(an,cn,bn) RESULT(IACB)
    ...
    INTEGER, DIMENSION(3), PARAMETER         :: i1 = (/1,0,0/), &
                                                i2 = (/0,1,0/), i3 = (/0,0,1/)
    ...
    ELSE
      ...
      ELSE
        ...
        ELSE
            CALL cp__b("aobasis/ai_overlap3_debug.F",122,"I(0000)")
        ENDIF
      ENDIF
    ENDIF
