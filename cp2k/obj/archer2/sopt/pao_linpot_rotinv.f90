# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/pao_linpot_rotinv.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/pao_linpot_rotinv.F"
!-----------------------------------------------------------------------------!
...
# 30 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/pao_linpot_rotinv.F" 2
...
! *****************************************************************************
  SUBROUTINE linpot_rotinv_calc_term(qs_env, iatom, kterm, block_V)
    ...
    TYPE(qs_kind_type), DIMENSION(:), &
     ...
     IF(.NOT.(neighbor_order(1) == iatom))CALL cp__a("pao_linpot_rotinv.F",199) !central atom should be closesd to itself
