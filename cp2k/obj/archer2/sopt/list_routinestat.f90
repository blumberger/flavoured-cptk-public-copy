# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/common/list_routinestat.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/common/list_routinestat.F"
!-----------------------------------------------------------------------------!
...
# 28 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/common/list_routinestat.F" 2
...
SUBROUTINE list_routinestat_init(list, initial_capacity)
    ...
    IF(initial_capacity_ < 0) & 
      CALL cp__b("common/list_routinestat.F",110,"list_routinestat_create: initial_capacity < 0")

    IF(ASSOCIATED(list%arr)) &
       CALL cp__b("common/list_routinestat.F",113,"list_routinestat_create: list is already initialized.")

    ALLOCATE(list%arr(initial_capacity_), stat=stat)
    IF (stat/=0)&
       CALL cp__b("common/list_routinestat.F",117,"list_routinestat_init: allocation failed")
...
SUBROUTINE list_routinestat_destroy(list)
    ...
    IF(.NOT. ASSOCIATED(list%arr)) &
       CALL cp__b("common/list_routinestat.F",138,"list_routinestat_destroy: list is not initialized.")
...
SUBROUTINE list_routinestat_set(list, value, pos)
    ...
    IF(.NOT. ASSOCIATED(list%arr)) &
       CALL cp__b("common/list_routinestat.F",167,"list_routinestat_set: list is not initialized.")
    IF(pos < 1)&
       CALL cp__b("common/list_routinestat.F",169,"list_routinestat_set: pos < 1")
    IF(pos > list%size)&
       CALL cp__b("common/list_routinestat.F",171,"list_routinestat_set: pos > size")
...
SUBROUTINE list_routinestat_push(list, value)
    ...
    IF(.NOT. ASSOCIATED(list%arr)) &
       CALL cp__b("common/list_routinestat.F",193,"list_routinestat_push: list is not initialized.")
    ...
    IF (stat/=0)&
       CALL cp__b("common/list_routinestat.F",200,"list_routinestat_push: allocation failed")
...
SUBROUTINE list_routinestat_insert(list, value, pos)
    ...
    IF(.NOT. ASSOCIATED(list%arr)) &
       CALL cp__b("common/list_routinestat.F",225,"list_routinestat_insert: list is not initialized.")
    IF(pos < 1)&
       CALL cp__b("common/list_routinestat.F",227,"list_routinestat_insert: pos < 1")
    IF(pos > list%size+1)&
       CALL cp__b("common/list_routinestat.F",229,"list_routinestat_insert: pos > size+1")
    ...
    ALLOCATE(list%arr(pos)%p, stat=stat)
     IF (stat/=0)&
        CALL cp__b("common/list_routinestat.F",241,"list_routinestat_insert: allocation failed.")
    list%arr(pos)%p%value => value
...
FUNCTION list_routinestat_peek(list) RESULT(value)
    ...
    IF(.NOT. ASSOCIATED(list%arr)) &
       CALL cp__b("common/list_routinestat.F",261,"list_routinestat_peek: list is not initialized.")
    IF(list%size < 1) &
       CALL cp__b("common/list_routinestat.F",263,"list_routinestat_peek: list is empty.")
...
FUNCTION list_routinestat_pop(list) RESULT(value)
    ...
    IF(.NOT. ASSOCIATED(list%arr)) &
       CALL cp__b("common/list_routinestat.F",287,"list_routinestat_pop: list is not initialized.")
    IF(list%size < 1) &
       CALL cp__b("common/list_routinestat.F",289,"list_routinestat_pop: list is empty.")
...
SUBROUTINE list_routinestat_clear(list)
    ...
    IF(.NOT. ASSOCIATED(list%arr)) &
       CALL cp__b("common/list_routinestat.F",312,"list_routinestat_clear: list is not initialized.")
...
FUNCTION list_routinestat_get(list, pos) RESULT(value)
    ...
    IF(.NOT. ASSOCIATED(list%arr)) &
       CALL cp__b("common/list_routinestat.F",337,"list_routinestat_get: list is not initialized.")
    IF(pos < 1)&
       CALL cp__b("common/list_routinestat.F",339,"list_routinestat_get: pos < 1")
    IF(pos > list%size)&
       CALL cp__b("common/list_routinestat.F",341,"list_routinestat_get: pos > size")
...
SUBROUTINE list_routinestat_del(list, pos)
    ...
    IF(.NOT. ASSOCIATED(list%arr)) &
       CALL cp__b("common/list_routinestat.F",364,"list_routinestat_del: list is not initialized.")
    IF(pos < 1)&
       CALL cp__b("common/list_routinestat.F",366,"list_routinestat_det: pos < 1")
    IF(pos > list%size)&
       CALL cp__b("common/list_routinestat.F",368,"list_routinestat_det: pos > size")
...
FUNCTION list_routinestat_size(list) RESULT(size)
    ...
    IF(.NOT. ASSOCIATED(list%arr)) &
       CALL cp__b("common/list_routinestat.F",392,"list_routinestat_size: list is not initialized.")
...
SUBROUTINE change_capacity(list, new_capacity)
   ...
   IF(new_cap < 0) &
      CALL cp__b("common/list_routinestat.F",417,"list_routinestat_change_capacity: new_capacity < 0")
   IF(new_cap < list%size) &
      CALL cp__b("common/list_routinestat.F",419,"list_routinestat_change_capacity: new_capacity < size")
   IF(new_cap > HUGE(i)) THEN
      IF(SIZE(list%arr) == HUGE(i)) &
      CALL cp__b("common/list_routinestat.F",422,"list_routinestat_change_capacity: list has reached integer limit.")
   ...
   IF (stat/=0)&
      CALL cp__b("common/list_routinestat.F",429,"list_routinestat_change_capacity: allocation failed")

   DO i=1, list%size
      ALLOCATE(list%arr(i)%p, stat=stat)
      IF (stat/=0)&
         CALL cp__b("common/list_routinestat.F",434,"list_routinestat_change_capacity: allocation failed")
