# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/semi_empirical_store_int_types.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/semi_empirical_store_int_types.F"
!-----------------------------------------------------------------------------!
...
# 28 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/semi_empirical_store_int_types.F" 2
...
! *****************************************************************************
  SUBROUTINE semi_empirical_si_create(store_int_env, se_section, compression)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(store_int_env)))CALL cp__a("semi_empirical_store_int_types.F",81)
    ...
    IF(store_int_env%memory_parameter%do_disk_storage)&
       CALL cp__b("semi_empirical_store_int_types.F",104,"Disk storage for SEMIEMPIRICAL methods disabled! ")
