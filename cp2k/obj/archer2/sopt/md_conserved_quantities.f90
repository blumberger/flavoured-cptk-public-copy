# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/motion/md_conserved_quantities.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/motion/md_conserved_quantities.F"
!-----------------------------------------------------------------------------!
...
# 50 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/motion/md_conserved_quantities.F" 2
...
! *****************************************************************************
  SUBROUTINE compute_conserved_quantity (md_env, md_ener, tkind, tshell,&
    ...
    CALL get_part_ke ( md_env, md_ener, tkind, tshell, para_env%group)
    ...
    CASE DEFAULT
       CALL cp__b("motion/md_conserved_quantities.F",145,'Unknown ensemble')
...
! *****************************************************************************
  FUNCTION calc_nfree_qm(md_env, md_ener) RESULT(nfree_qm)
    ...
    CHARACTER(LEN=*), PARAMETER :: routineN = 'calc_nfree_qm', &
      routineP = moduleN//':'//routineN
    ...
    IF(.NOT.(.NOT.(ASSOCIATED(qmmm_env) .AND. ASSOCIATED(qmmmx_env))))CALL cp__a("motion/md_conserved_quantities.F",240)
...
! *****************************************************************************
  SUBROUTINE get_econs_nvt_adiabatic ( md_env, md_ener,  para_env)
    ...
    CHARACTER(LEN=*), PARAMETER :: routineN = 'get_econs_nvt_adiabatic', &
      routineP = moduleN//':'//routineN
...
! *****************************************************************************
  SUBROUTINE get_part_ke ( md_env, md_ener, tkind, tshell, group)
    ...
    IF(ASSOCIATED(qmmm_env) .AND. ASSOCIATED(qmmmx_env)) CALL cp__b("motion/md_conserved_quantities.F",675,"get_part_ke: qmmm bug")
