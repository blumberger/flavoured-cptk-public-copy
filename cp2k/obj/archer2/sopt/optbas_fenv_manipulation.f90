# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/optbas_fenv_manipulation.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/optbas_fenv_manipulation.F"
!-----------------------------------------------------------------------------!
...
# 67 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/optbas_fenv_manipulation.F" 2
    ...
    TYPE(section_vals_type), POINTER         :: admm_section, dft_section, &
     ...
     DO ikind=1,nkind
       ...
       CALL section_vals_val_get(kind_section,"BASIS_SET",&
             c_val=orig_basis,i_rep_section=ikind)
...
!> \param qs_input ...
! *****************************************************************************
   SUBROUTINE calculate_overlap(ks_env,S_type,qs_input)
