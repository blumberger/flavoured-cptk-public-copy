# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/common/dict_str_i4.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/common/dict_str_i4.F"
!-----------------------------------------------------------------------------!
...
# 30 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/common/dict_str_i4.F" 2
...
SUBROUTINE dict_str_i4_init(dict, initial_capacity)
    ...
    IF(initial_capacity_ < 1) & 
       CALL cp__b("common/dict_str_i4.F",133,"dict_str_i4_init: initial_capacity < 1")

    IF(ASSOCIATED(dict%buckets)) &
       CALL cp__b("common/dict_str_i4.F",136,"dict_str_i4_init: dictionary is already initialized.")
...
SUBROUTINE dict_str_i4_destroy(dict)
    ...
    IF(.NOT. ASSOCIATED(dict%buckets)) &
       CALL cp__b("common/dict_str_i4.F",176,"dict_str_i4_destroy: dictionary is not initialized.")
...
SUBROUTINE dict_str_i4_set(dict, key, value)
    ...
    IF(.NOT. ASSOCIATED(dict%buckets)) &
       CALL cp__b("common/dict_str_i4.F",210,"dict_str_i4_set: dictionary is not initialized.")
...
RECURSIVE SUBROUTINE change_capacity(dict, new_capacity)
    ...
    END IF
    IF(new_cap < 1) &
       CALL cp__b("common/dict_str_i4.F",293,"dict_str_i4_change_capacity: new_capacity < 1.")
    IF(4*dict%size > 3*new_cap) &
       CALL cp__b("common/dict_str_i4.F",295,"dict_str_i4_change_capacity: new_capacity too small.")
    ...
    IF(old_size /= dict%size) &
       CALL cp__b("common/dict_str_i4.F",314,"dict_str_i4_change_capacity: assertion failed")
...
FUNCTION dict_str_i4_get(dict, key, default_value) RESULT(value)
    ...
    IF(.NOT. ASSOCIATED(dict%buckets)) &
       CALL cp__b("common/dict_str_i4.F",340,"dict_str_i4_get: dictionary is not initialized.")
    ...
    CALL cp__b("common/dict_str_i4.F",361,"dict_str_i4_get: Key not found in dictionary.")
...
SUBROUTINE dict_str_i4_del(dict, key)
    ...
    IF(.NOT. ASSOCIATED(dict%buckets)) &
       CALL cp__b("common/dict_str_i4.F",382,"dict_str_i4_del: dictionary is not initialized.")
    ...
    CALL cp__b("common/dict_str_i4.F",406,"dict_str_i4_del: Key not found in dictionary.")
...
FUNCTION dict_str_i4_size(dict) RESULT(size)
    ...
    IF(.NOT. ASSOCIATED(dict%buckets)) &
       CALL cp__b("common/dict_str_i4.F",422,"dict_str_i4_size: dictionary is not initialized.")
...
FUNCTION dict_str_i4_haskey(dict, key) RESULT(res)
    ...
    IF(.NOT. ASSOCIATED(dict%buckets)) &
       CALL cp__b("common/dict_str_i4.F",446,"dict_str_i4_haskey: dictionary is not initialized.")
...
FUNCTION dict_str_i4_items(dict) RESULT(items)
    ...
    IF(.NOT. ASSOCIATED(dict%buckets)) &
       CALL cp__b("common/dict_str_i4.F",487,"dict_str_i4_items: dictionary is not initialized.")
    ...
    IF(j /= dict%size + 1) &
       CALL cp__b("common/dict_str_i4.F",502,"dict_str_i4_items: assertion failed!")
...
SUBROUTINE dict_str_i4_update(dict, from_dict)
    ...
    IF(.NOT. ASSOCIATED(dict%buckets)) &
       CALL cp__b("common/dict_str_i4.F",525,"dict_str_i4_update: dictionary is not initialized.")
    IF(.NOT. ASSOCIATED(from_dict%buckets)) &
       CALL cp__b("common/dict_str_i4.F",527,"dict_str_i4_update: from_dict is not initialized.")
