# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/input_cp2k_subsys.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/input_cp2k_subsys.F"
!-----------------------------------------------------------------------------!
...
MODULE input_cp2k_subsys
  ...
  USE cell_types,                      ONLY: &
       ...
       cell_sym_tetragonal_bc, cell_sym_triclinic, use_perd_none, use_perd_x, &
  ...
  USE input_constants,                 ONLY: &
       do_add, do_bondparm_covalent, do_bondparm_vdw, do_cell_cp2k, &
       do_cell_xsc, do_conn_amb7, do_conn_g87, do_conn_g96, do_conn_generate, &
...
# 58 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/input_cp2k_subsys.F" 2
...
! *****************************************************************************
  RECURSIVE SUBROUTINE create_cell_section(section,periodic,label)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_subsys.F",96)
...
! *****************************************************************************
  SUBROUTINE create_rng_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_subsys.F",236)
...
!> \param section the section to create
!> \author fawzi
!> \note A keyword added "number_decompositions" by Matt to enable a different 
!>        energy decomposition for non-adiabatic dynamics
! *****************************************************************************
  SUBROUTINE create_subsys_section(section)
    ...
    TYPE(section_type), POINTER              :: subsection
    TYPE(keyword_type), POINTER :: keyword !CHANGE MATT 

    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_subsys.F",267)
    ...
    NULLIFY(subsection, keyword) !CHANGE MATT
...
! *****************************************************************************
  SUBROUTINE create_subsys_print_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_subsys.F",343)
...
! *****************************************************************************
  SUBROUTINE create_multipole_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_subsys.F",584)
...
! *****************************************************************************
  SUBROUTINE create_structure_data_section(print_key)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(print_key)))CALL cp__a("input_cp2k_subsys.F",633)
...
! *****************************************************************************
  SUBROUTINE create_velocity_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_subsys.F",696)
...
! *****************************************************************************
  SUBROUTINE create_shell_vel_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_subsys.F",736)
...
! *****************************************************************************
  SUBROUTINE create_core_vel_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_subsys.F",768)
...
! *****************************************************************************
  SUBROUTINE create_coord_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_subsys.F",906)
...
! *****************************************************************************
  SUBROUTINE create_shell_coord_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_subsys.F",952)
...
! *****************************************************************************
  SUBROUTINE create_core_coord_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_subsys.F",997)
...
! *****************************************************************************
  SUBROUTINE create_kind_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_subsys.F",1043)
    ...
    CALL keyword_create(keyword, name="LMAX_DFTB",&
    ...
    CALL keyword_create(keyword, name="PAO_BASIS_SIZE",&
            description="The block size used for the polarized atomic orbital basis.",&
            default_i_val=-1)
    CALL section_add_keyword(section,keyword)
    CALL keyword_release(keyword)

    CALL keyword_create(keyword, name="PAO_POTENTIAL_MAXL",&
         description="Maximum angular moment of the potential's zonal harmonic.",&
         default_i_val=0)
    CALL section_add_keyword(section,keyword)
    CALL keyword_release(keyword)

    CALL keyword_create(keyword, name="PAO_POTENTIAL_BETA",&
         description="Scaling factor of the potential's Gaussian Hull functions. "//&
         "The exponent is given by pot_exp = 0.5/(R_vdw*pot_beta)**2.",&
         default_r_val=1.0_dp)
    CALL section_add_keyword(section,keyword)
    CALL keyword_release(keyword)

    CALL keyword_create(keyword, name="PAO_POTENTIAL_NEIGHBORS",&
         description="Number of neigbors used for spanning the potential.",&
         default_i_val=4)
    CALL section_add_keyword(section,keyword)
    CALL keyword_release(keyword)
...
! *****************************************************************************
  SUBROUTINE create_bs_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_subsys.F",1323)
...
! *****************************************************************************
  SUBROUTINE create_topology_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_subsys.F",1452)
...
! *****************************************************************************
  SUBROUTINE create_exclude_list_section(section, header)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_subsys.F",1682)
    NULLIFY(keyword)
...
! *****************************************************************************
  SUBROUTINE create_center_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_subsys.F",1713)
    NULLIFY(keyword)
...
! *****************************************************************************
  SUBROUTINE create_molset_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_subsys.F",1750)
...
! *****************************************************************************
  SUBROUTINE create_generate_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_subsys.F",1846)
    NULLIFY(keyword,subsection)
...
! *****************************************************************************
  SUBROUTINE create_gen_print_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_subsys.F",2040)
    CALL section_create(section,name="print",&
...
! *****************************************************************************
  SUBROUTINE connectivity_framework(section,default)
    ...
    IF(.NOT.(ASSOCIATED(section)))CALL cp__a("input_cp2k_subsys.F",2077)
    NULLIFY(keyword)
...
! *****************************************************************************
  SUBROUTINE create_dft_plus_u_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_subsys.F",2135)
