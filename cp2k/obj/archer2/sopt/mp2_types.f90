# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/mp2_types.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/mp2_types.F"
!-----------------------------------------------------------------------------!
...
# 30 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/mp2_types.F" 2
...
! *****************************************************************************
  SUBROUTINE mp2_env_release(mp2_env)
    ...
    IF(.NOT.(ASSOCIATED(mp2_env)))CALL cp__a("mp2_types.F",215)
...
! *****************************************************************************
  SUBROUTINE mp2_env_create(mp2_env)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(mp2_env)))CALL cp__a("mp2_types.F",242)
