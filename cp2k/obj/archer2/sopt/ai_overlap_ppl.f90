# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/aobasis/ai_overlap_ppl.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/aobasis/ai_overlap_ppl.F"
!-----------------------------------------------------------------------------!
...
# 31 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/aobasis/ai_overlap_ppl.F" 2
...
! *****************************************************************************
  SUBROUTINE ppl_integral(la_max_set,la_min_set,npgfa,rpgfa,zeta,&
    ...
    INTEGER                                  :: iexp, ij, ipgf, jpgf, mmax, &
                                                nexp
    ...
    IF (PRESENT(pab)) THEN
      IF(.NOT.(PRESENT(force_a)))CALL cp__a("aobasis/ai_overlap_ppl.F",126)
      IF(.NOT.(PRESENT(force_b)))CALL cp__a("aobasis/ai_overlap_ppl.F",127)
      IF(.NOT.(PRESENT(fs)))CALL cp__a("aobasis/ai_overlap_ppl.F",128)
...
! *****************************************************************************
  SUBROUTINE ppl_aux(auxint,mmax,t,rho,nexp_ppl,cexp_ppl,zetc)
    ...
    END IF
    IF(nexp_ppl > 4) THEN
      CALL cp__b("aobasis/ai_overlap_ppl.F",235,"nexp_ppl > 4")
    END IF
