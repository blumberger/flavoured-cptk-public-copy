# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/aobasis/ai_overlap_debug.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/aobasis/ai_overlap_debug.F"
!-----------------------------------------------------------------------------!
...
# 19 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/aobasis/ai_overlap_debug.F" 2
...
! *****************************************************************************
  RECURSIVE FUNCTION os_overlap2(an,bn) RESULT(IAB)
    ...
    ELSE
     ...
     ELSE
         CALL cp__b("aobasis/ai_overlap_debug.F",103,"I(0000)")
     ENDIF
    ENDIF
