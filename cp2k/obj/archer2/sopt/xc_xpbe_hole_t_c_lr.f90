# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/xc/xc_xpbe_hole_t_c_lr.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/xc/xc_xpbe_hole_t_c_lr.F"
!-----------------------------------------------------------------------------!
...
# 31 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/xc/xc_xpbe_hole_t_c_lr.F" 2
...
! *****************************************************************************
  SUBROUTINE xpbe_hole_t_c_lr_lda_eval ( rho_set, deriv_set, order, params)
    ...
    IF(.NOT.(ASSOCIATED(rho_set)))CALL cp__a("xc/xc_xpbe_hole_t_c_lr.F",175)
    IF(.NOT.(rho_set%ref_count>0))CALL cp__a("xc/xc_xpbe_hole_t_c_lr.F",176)
    IF(.NOT.(ASSOCIATED(deriv_set)))CALL cp__a("xc/xc_xpbe_hole_t_c_lr.F",177)
    IF(.NOT.(deriv_set%ref_count>0))CALL cp__a("xc/xc_xpbe_hole_t_c_lr.F",178)
    ...
    END IF
    IF (order>1.OR.order<-1) THEN
       CALL cp__b("xc/xc_xpbe_hole_t_c_lr.F",205,"derivatives bigger than 2 not implemented")
    END IF

    IF ( R == 0.0_dp ) THEN
      CALL cp__b("xc/xc_xpbe_hole_t_c_lr.F",209,"Cutoff_Radius 0.0 not implemented")
    END IF
...
! *****************************************************************************
  SUBROUTINE xpbe_hole_t_c_lr_lsd_eval ( rho_set, deriv_set, order, params)
    ...
    IF(.NOT.(ASSOCIATED(rho_set)))CALL cp__a("xc/xc_xpbe_hole_t_c_lr.F",342)
    IF(.NOT.(rho_set%ref_count>0))CALL cp__a("xc/xc_xpbe_hole_t_c_lr.F",343)
    IF(.NOT.(ASSOCIATED(deriv_set)))CALL cp__a("xc/xc_xpbe_hole_t_c_lr.F",344)
    IF(.NOT.(deriv_set%ref_count>0))CALL cp__a("xc/xc_xpbe_hole_t_c_lr.F",345)
    ...
    END IF
    IF (order>1.OR.order<-1) THEN
       CALL cp__b("xc/xc_xpbe_hole_t_c_lr.F",380,"derivatives bigger than 2 not implemented")
    END IF

    IF ( R == 0.0_dp ) THEN
      CALL cp__b("xc/xc_xpbe_hole_t_c_lr.F",384,"Cutoff_Radius 0.0 not implemented")
    END IF
