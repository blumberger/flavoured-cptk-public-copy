# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/manybody_tersoff.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/manybody_tersoff.F"
!-----------------------------------------------------------------------------!
...
# 26 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/manybody_tersoff.F" 2
...
! *****************************************************************************
  SUBROUTINE tersoff_energy(pot_loc, tersoff, r_last_update_pbc, atom_a, atom_b, nloc_size,&
    ...
    CHARACTER(LEN=*), PARAMETER :: routineN = 'tersoff_energy', &
...
! *****************************************************************************
  SUBROUTINE setup_tersoff_arrays(nonbonded, potparm, glob_loc_list, glob_cell_v, glob_loc_list_a, cell)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(glob_loc_list)))CALL cp__a("manybody_tersoff.F",769)
    IF(.NOT.(.NOT.ASSOCIATED(glob_loc_list_a)))CALL cp__a("manybody_tersoff.F",770)
    IF(.NOT.(.NOT.ASSOCIATED(glob_cell_v)))CALL cp__a("manybody_tersoff.F",771)
    CALL timeset ( routineN, handle )
    npairs_tot = 0
...
! *****************************************************************************
  SUBROUTINE destroy_tersoff_arrays(glob_loc_list, glob_cell_v, glob_loc_list_a)
    ...
    CHARACTER(LEN=*), PARAMETER :: routineN = 'destroy_tersoff_arrays', &
      routineP = moduleN//':'//routineN
