# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/qs_linres_epr_utils.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/qs_linres_epr_utils.F"
!-----------------------------------------------------------------------------!
...
# 63 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/qs_linres_epr_utils.F" 2
...
! *****************************************************************************
  SUBROUTINE epr_env_init(epr_env,qs_env)
    ...
    !   CALL cp__b("qs_linres_epr_utils.F",160,"restart_epr requires density_guess=restart")
    !ENDIF
    !
    ! check that the psi0 are localized and you have all the centers
    IF(.NOT.(linres_control%localized_psi0))CALL cp__a("qs_linres_epr_utils.F",164)
    IF(output_unit>0) THEN
       WRITE(output_unit,'(A)') &
