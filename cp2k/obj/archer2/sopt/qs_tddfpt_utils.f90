# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/qs_tddfpt_utils.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/qs_tddfpt_utils.F"
!-----------------------------------------------------------------------------!
...
# 43 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/qs_tddfpt_utils.F" 2
...
! number of vectors to initialize
    ...
    IF (.NOT.ASSOCIATED(tddfpt_control%lumos)) THEN
       CALL cp__b("qs_tddfpt_utils.F",189,"LUMOS missing")
    END IF
