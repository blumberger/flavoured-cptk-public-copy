# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/xc/xc_xbecke88.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/xc/xc_xbecke88.F"
!-----------------------------------------------------------------------------!
...
# 28 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/xc/xc_xbecke88.F" 2
...
! *****************************************************************************
  SUBROUTINE xb88_lda_eval(rho_set,deriv_set,grad_deriv,xb88_params)
    ...
    IF(.NOT.(ASSOCIATED(rho_set)))CALL cp__a("xc/xc_xbecke88.F",148)
    IF(.NOT.(rho_set%ref_count>0))CALL cp__a("xc/xc_xbecke88.F",149)
    IF(.NOT.(ASSOCIATED(deriv_set)))CALL cp__a("xc/xc_xbecke88.F",150)
    IF(.NOT.(deriv_set%ref_count>0))CALL cp__a("xc/xc_xbecke88.F",151)
    ...
    END IF
    IF (grad_deriv>3.OR.grad_deriv<-3) THEN
       CALL cp__b("xc/xc_xbecke88.F",208,"derivatives bigger than 3 not implemented")
    END IF
...
! *****************************************************************************
  SUBROUTINE xb88_lsd_eval(rho_set,deriv_set,grad_deriv,xb88_params)
    ...
    CALL section_vals_val_get(xb88_params,"scale_x",r_val=sx)
    IF(.NOT.(ASSOCIATED(rho_set)))CALL cp__a("xc/xc_xbecke88.F",677)
    IF(.NOT.(rho_set%ref_count>0))CALL cp__a("xc/xc_xbecke88.F",678)
    IF(.NOT.(ASSOCIATED(deriv_set)))CALL cp__a("xc/xc_xbecke88.F",679)
    IF(.NOT.(deriv_set%ref_count>0))CALL cp__a("xc/xc_xbecke88.F",680)
    ...
    END IF
    IF (grad_deriv>3.OR.grad_deriv<-3) THEN
       CALL cp__b("xc/xc_xbecke88.F",769,"derivatives bigger than 3 not implemented")
    END IF
