# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/qs_density_mixing_types.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/qs_density_mixing_types.F"
!-----------------------------------------------------------------------------!
...
# 36 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/qs_density_mixing_types.F" 2
...
! *****************************************************************************
  SUBROUTINE mixing_storage_create(mixing_store,  mixing_section, mixing_method, ecut)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(mixing_store)))CALL cp__a("qs_density_mixing_types.F",102)
...
! *****************************************************************************
 SUBROUTINE mixing_storage_release(mixing_store)
  ...
  IF (ASSOCIATED(mixing_store)) THEN
     IF(.NOT.(mixing_store%ref_count>0))CALL cp__a("qs_density_mixing_types.F",196)
...
! *****************************************************************************
  SUBROUTINE create_mixing_section(section, ls_scf)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("qs_density_mixing_types.F",393)
