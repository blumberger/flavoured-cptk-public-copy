# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/header.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/header.F"
!-----------------------------------------------------------------------------!
...
# 19 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/header.F" 2

  IMPLICIT NONE

  PRIVATE
  PUBLIC :: cp2k_header, cp2k_footer, vib_header, scptb_header
...
! *****************************************************************************
  SUBROUTINE scptb_header(iw)
    ...
    WRITE ( iw, '( 11(12x,a,/) )' ) &
         ...
         '                                                          ', &
         '                        Version 0.01                      ', &
         '         Juerg Hutter, Yannick Misteli, Ralph Koitz       ', &
         '                                                          '
  END SUBROUTINE scptb_header
...
! *****************************************************************************
  SUBROUTINE tmc_header(iw)
    ...
    WRITE (UNIT=iw,FMT="(/,(T2,A79))")&
         ...
         "**                          ###      ###  #  ###   ###                       **",&
         "**                          ###      ###     ###    ######                   **",&
         "**  TreeMonteCarlo                                        Mandes Schönherr   **",&
         "**                                                        2009 - 2015        **",&
         "*******************************************************************************",&
         "*******************************************************************************"
...
! *****************************************************************************
  SUBROUTINE tmc_ana_header(iw)
    ...
    WRITE (UNIT=iw,FMT="(/,(T2,A79))")&
         ...
         "**      ###      ###  #  ###   ###                ######  ##  ####  ######   **",&
         "**      ###      ###     ###    ######            ##  ##  ##   ###  ##  ##   **",&
         "**  Trajectory analyzer for TreeMonteCarlo ensembles      Mandes Schönherr   **",&
         "**                                                        2013 - 2015        **",&
         "*******************************************************************************",&
         "*******************************************************************************"
