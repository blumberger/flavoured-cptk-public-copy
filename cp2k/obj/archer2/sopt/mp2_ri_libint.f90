# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/mp2_ri_libint.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/mp2_ri_libint.F"
!-----------------------------------------------------------------------------!
...
# 71 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/mp2_ri_libint.F" 2
  ...
  SUBROUTINE read_RI_basis_set(qs_env,RI_basis_parameter,RI_basis_info,&
    ...
    DO ikind = 1,nkind
      ...
      IF(.NOT.(ASSOCIATED(orb_basis_a))) THEN
        CALL cp__b("mp2_ri_libint.F",209,"Initial RI auxiliary basis not specified.")
      END IF
...
! *****************************************************************************
  SUBROUTINE calc_lai_libint(mp2_env,qs_env,para_env,& 
    ...
    INTEGER :: orb_l_start, primitive_counter, sgfb, sphi_a_u1, sphi_a_u2, &
      sphi_a_u3, sphi_b_u1, sphi_b_u2, sphi_b_u3, sphi_c_u1, sphi_c_u2, &
      sphi_c_u3, sphi_d_u1, sphi_d_u2, sphi_d_u3, unit_id, virtual
   ...
   END IF
    ...
    IF(.NOT.(info_chol==0))CALL cp__a("mp2_ri_libint.F",1000)
