# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/input_cp2k_thermostats.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/input_cp2k_thermostats.F"
!-----------------------------------------------------------------------------!
...
# 42 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/input_cp2k_thermostats.F" 2
...
! *****************************************************************************
  SUBROUTINE create_thermo_slow_section(section, coupled_thermostat)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_thermostats.F",77)
...
! *****************************************************************************
  SUBROUTINE create_thermo_fast_section(section, coupled_thermostat)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_thermostats.F",153)
    my_coupled_thermostat = .FALSE.
    IF (PRESENT(coupled_thermostat)) my_coupled_thermostat = coupled_thermostat
    NULLIFY(nose_section, region_section)
...
! *****************************************************************************
  SUBROUTINE create_thermostat_section(section, coupled_thermostat)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_thermostats.F",232)
    my_coupled_thermostat = .FALSE.
    IF (PRESENT(coupled_thermostat)) my_coupled_thermostat = coupled_thermostat
...
! *****************************************************************************
  SUBROUTINE create_print_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_thermostats.F",320)
    NULLIFY(print_key)
...
! *****************************************************************************
  SUBROUTINE create_region_section(section, label)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_thermostats.F",364)
...
! *****************************************************************************
  SUBROUTINE create_nose_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_thermostats.F",428)
...
! *****************************************************************************
  SUBROUTINE create_gle_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_thermostats.F",498)
...
! *****************************************************************************
  SUBROUTINE create_gles_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_thermostats.F",569)
...
! *****************************************************************************
  SUBROUTINE create_csvr_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_thermostats.F",597)
...
! *****************************************************************************
  SUBROUTINE create_al_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_thermostats.F",639)
...
! *****************************************************************************
  SUBROUTINE create_thermo_chi_mass_section(section,sec_name)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_thermostats.F",699)
...
! *****************************************************************************
  SUBROUTINE create_thermo_energy_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_thermostats.F",727)
...
! *****************************************************************************
  SUBROUTINE create_force_section(section,name)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_thermostats.F",756)
...
! *****************************************************************************
  SUBROUTINE create_mass_section(section,name)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_thermostats.F",785)
...
! *****************************************************************************
  SUBROUTINE create_velocity_section(section,name)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_thermostats.F",814)
...
! *****************************************************************************
  SUBROUTINE create_coord_section(section,name)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_thermostats.F",843)
