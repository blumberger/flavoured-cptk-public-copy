# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/fist_neighbor_list_control.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/fist_neighbor_list_control.F"
!-----------------------------------------------------------------------------!
...
# 43 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/fist_neighbor_list_control.F" 2
...
! *****************************************************************************
  SUBROUTINE list_control ( atomic_kind_set, particle_set, local_particles, &
    ...
    LOGICAL :: build_from_scratch, geo_check, shell_adiabatic, shell_present, &
