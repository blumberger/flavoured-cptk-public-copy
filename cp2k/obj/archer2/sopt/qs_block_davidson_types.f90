# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/qs_block_davidson_types.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/qs_block_davidson_types.F"
!-----------------------------------------------------------------------------!
...
!>              methods in electronic structure calculations!> \par History
...
# 28 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/qs_block_davidson_types.F" 2
...
! *****************************************************************************
  SUBROUTINE block_davidson_env_create(bdav_env,nspins,scf_section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(bdav_env)))CALL cp__a("qs_block_davidson_types.F",66)
