# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/scptb_core_interactions.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/scptb_core_interactions.F"
!-----------------------------------------------------------------------------!
...
# 41 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/scptb_core_interactions.F" 2
...
! *****************************************************************************
  SUBROUTINE scptb_core_interaction(qs_env, calculate_forces)
    ...
    IF(.NOT.(ASSOCIATED(qs_env)))CALL cp__a("scptb_core_interactions.F",99)
