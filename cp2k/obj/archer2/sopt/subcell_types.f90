# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/subcell_types.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/subcell_types.F"
!-----------------------------------------------------------------------------!
...
# 20 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/subcell_types.F" 2
...
! *****************************************************************************
  SUBROUTINE deallocate_subcell(subcell)
    ...
    IF (ASSOCIATED(subcell)) THEN
       ...
       DEALLOCATE (subcell)
    ELSE
       CALL cp__b("subcell_types.F",146,"")
    END IF
