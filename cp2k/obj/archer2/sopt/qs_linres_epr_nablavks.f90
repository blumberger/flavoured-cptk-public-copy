# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/qs_linres_epr_nablavks.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/qs_linres_epr_nablavks.F"
!-----------------------------------------------------------------------------!
...
# 89 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/qs_linres_epr_nablavks.F" 2
...
! *****************************************************************************
  SUBROUTINE epr_nablavks(epr_env,qs_env)
    ...
    INTEGER :: bo_atom(2), ia, iat, iatom, idir, iexp, ig, ikind, ir, iso, &
      ispin, ix, iy, iz, natom, nexp_ppl, nkind, nspins, output_unit, unit_nr
    INTEGER, DIMENSION(2, 3)                 :: bo
    INTEGER, DIMENSION(:), POINTER           :: atom_list
    LOGICAL                                  :: gapw, gapw_xc, gth_gspace, &
                                                ionode, make_soft, paw_atom
    REAL(KIND=dp) :: alpha, alpha_core, arg, charge, ehartree, exc, exp_rap, &
      gapw_max_alpha, hard_radius, hard_value, soft_value, sqrt_alpha, &
      sqrt_rap
    ...
    TYPE(pw_p_type), DIMENSION(:), POINTER   :: rho1_r, rho2_r, rho_r, &
...
!   -------------------------------------
    ...
    IF (gapw) THEN
       ...
       CALL calculate_rho_atom_coeff(qs_env,rho_ao)
...
!   -------------------------------------
    ...
    DO idir = 1,3
       ...
       CALL pw_copy(rho1_r(1)%pw,rho2_r(1)%pw)
    END DO
