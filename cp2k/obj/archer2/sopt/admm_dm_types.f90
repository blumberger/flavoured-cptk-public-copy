# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/admm_dm_types.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/admm_dm_types.F"
!-----------------------------------------------------------------------------!
...
# 20 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/admm_dm_types.F" 2
  ...
  TYPE admm_dm_type
    ...
    INTEGER                                  :: method = -1
    TYPE(cp_dbcsr_type), POINTER             :: matrix_a => Null()
