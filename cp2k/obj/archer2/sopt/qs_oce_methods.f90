# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/qs_oce_methods.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/qs_oce_methods.F"
!-----------------------------------------------------------------------------!
...
# 46 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/qs_oce_methods.F" 2
      ...
      DO WHILE (neighbor_list_iterate(nl_iterator)==0)
         ...
         IF( local ) THEN
            ...
            IF(nsgf_cnt > 0) THEN
               ...
               IF(.NOT.(nsgf_cnt == nsgfa))CALL cp__a("qs_oce_methods.F",540)
               ! *** Special case: A=B
