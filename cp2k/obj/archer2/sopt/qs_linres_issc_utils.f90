# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/qs_linres_issc_utils.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/qs_linres_issc_utils.F"
!-----------------------------------------------------------------------------!
...
# 80 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/qs_linres_issc_utils.F" 2
...
!
    ...
    IF(.NOT.linres_control%localized_psi0)&
       CALL cp_warn(cp__l("qs_linres_issc_utils.F",875),'To get indirect spin-spin coupling parameters within '//&
    ...
    IF(.NOT.ASSOCIATED(issc_env%issc_on_atom_list)) THEN
       ...
       IF(.NOT.(istat.EQ.0))CALL cp__a("qs_linres_issc_utils.F",910)
       DO iatom = 1,natom
    ...
    ALLOCATE(issc_env%issc(3,3,issc_env%issc_natms,issc_env%issc_natms,4),&
             ...
             STAT=istat)
    IF(.NOT.(istat==0))CALL cp__a("qs_linres_issc_utils.F",922)
    ...
    ALLOCATE(issc_env%efg_psi0(nspins,6),issc_env%pso_psi0(nspins,3),issc_env%fc_psi0(nspins),&
             ...
             STAT=istat)
    IF(.NOT.(istat==0))CALL cp__a("qs_linres_issc_utils.F",931)
    DO ispin = 1,nspins
