# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/mol_force.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/mol_force.F"
!-----------------------------------------------------------------------------!
...
MODULE mol_force
  ...
  USE force_field_kind_types,          ONLY: &
       ...
       do_ff_quartic, legendre_data_type
  USE kinds,                           ONLY: dp
...
# 20 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/mol_force.F" 2
...
! *****************************************************************************
  SUBROUTINE force_bonds ( id_type, rij, r0, k, cs, energy, fscalar )
    ...
    CASE DEFAULT
       CALL cp__b("mol_force.F",105,"Unmatched bond kind")
    END SELECT
...
! *****************************************************************************
  SUBROUTINE force_bends (id_type, b12, b32, d12, d32, id12, id32, dist, &
    ...
    INTEGER                                  :: i
    REAL(KIND=dp)                            :: ctheta, denom, disp12, &
                                                disp32, y0, y1, y2, yd0, yd1, &
                                                yd2
    ...
    CASE DEFAULT
       CALL cp__b("mol_force.F",323,"Unmatched bend kind")
    END SELECT
...
! *****************************************************************************
  SUBROUTINE force_torsions (id_type, s32, is32, ism, isn,  dist1, dist2, tm,&
    ...
    CASE DEFAULT
       CALL cp__b("mol_force.F",383,"Unmatched torsion kind")
    END SELECT
...
! define cosphi
    ...
    CASE DEFAULT
       CALL cp__b("mol_force.F",457,"Unmatched improper kind")
    END SELECT
...
!Computing some necessary variables (see paper)
    ...
    CASE DEFAULT
       CALL cp__b("mol_force.F",548,"Unmatched opbend kind")
    END SELECT
