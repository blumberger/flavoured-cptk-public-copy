# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/qmmm_elpot.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/qmmm_elpot.F"
!-----------------------------------------------------------------------------!
...
# 36 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/qmmm_elpot.F" 2
...
! *****************************************************************************
  SUBROUTINE qmmm_potential_init(qmmm_coupl_type, mm_el_pot_radius, potentials,&
    ...
    !
    IF(.NOT.(.NOT.ASSOCIATED(potentials)))CALL cp__a("qmmm_elpot.F",121)
    ...
    Potential_Type: DO K = 1, SIZE(radius)
       ...
       CASE(do_qmmm_gauss,do_qmmm_swave)
          ...
          END IF
          pgf => pgfs(K)%pgf
          IF(.NOT.(pgf%Elp_Radius==rc))CALL cp__a("qmmm_elpot.F",165)
          ig_start = 1
