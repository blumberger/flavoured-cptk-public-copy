# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/input_constants.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/input_constants.F"
!-----------------------------------------------------------------------------!
...
MODULE input_constants
  ...
  INTEGER, PARAMETER, PUBLIC               :: momproj_sum=0,&
                                              momproj_norm=1
...
!> End CHANGE_AC
  ...
  INTEGER, PARAMETER, PUBLIC               :: ls_scf_ns=17, ls_scf_trs4=18,&
  ...
  ! Transport section
  INTEGER, PARAMETER, PUBLIC               :: transport_writeout      = 0,&
                                              transport_diagscalapack = 1,&
                                              transport_localscf      = 2,&
                                              transport_negf          = 3,&
                                              transport_transmission  = 4,&
