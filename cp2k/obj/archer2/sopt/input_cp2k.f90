# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/start/input_cp2k.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/start/input_cp2k.F"
!-----------------------------------------------------------------------------!
...
! *****************************************************************************
MODULE input_cp2k
  USE cp_dbcsr_interface,              ONLY: dbcsr_test_arnoldi,&
  ...
  USE cp_output_handling,              ONLY: add_last_numeric,&
                                             ...
                                             medium_print_level,&
                                             silent_print_level
  USE eri_mme_test,                    ONLY: create_eri_mme_test_section
  USE input_constants,                 ONLY: &
       do_diag_syevd, do_diag_syevx, do_mat_random, do_mat_read, &
...
# 58 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/start/input_cp2k.F" 2
...
! *****************************************************************************
  SUBROUTINE create_cp2k_root_section(root_section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(root_section)))CALL cp__a("start/input_cp2k.F",85)
...
! *****************************************************************************
  SUBROUTINE create_multi_force_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("start/input_cp2k.F",352)
...
! *****************************************************************************
  SUBROUTINE create_ext_restart_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("start/input_cp2k.F",391)
...
! *****************************************************************************
  SUBROUTINE create_farming_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("start/input_cp2k.F",626)
    ...
    CALL keyword_create(keyword, name="STRIDE",&
         description="Stride to be used when building working groups from the parent MPI comm."//&
                     "Can be used to layout slave groups over nodes in advanced ways (1 rank per node / 2 groups per node).",& 
    ...
    CALL keyword_create(keyword, name="MAX_JOBS_PER_GROUP",&
         ...
         usage="max_step 4", default_i_val=HUGE(0)/32768)
    CALL section_add_keyword(section,keyword)
    CALL keyword_release(keyword)
...
! *****************************************************************************
  SUBROUTINE create_rs_pw_transfer_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("start/input_cp2k.F",782)
...
! *****************************************************************************
  SUBROUTINE create_pw_transfer_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("start/input_cp2k.F",835)
...
! *****************************************************************************
  SUBROUTINE create_cp_fm_gemm_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("start/input_cp2k.F",914)
...
! *****************************************************************************
  SUBROUTINE create_eigensolver_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("start/input_cp2k.F",1003)
...
! *****************************************************************************
  SUBROUTINE create_cp_dbcsr_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("start/input_cp2k.F",1064)
    ...
    CALL keyword_create(keyword, name="TEST_TYPE",&
         description="Which part of DBCSR is tested",&
         usage="TEST_TYPE MM",&
         default_i_val=dbcsr_test_mm,&
         enum_c_vals=s2a("MM", "ARNOLDI","Binary_IO"),&
         enum_i_vals=(/ dbcsr_test_mm, dbcsr_test_arnoldi, dbcsr_test_binary_io/),&
         enum_desc=s2a(&
