# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/ewald_pw_methods.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/ewald_pw_methods.F"
!-----------------------------------------------------------------------------!
...
# 45 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/ewald_pw_methods.F" 2
...
SUBROUTINE ewald_pw_grid_update( ewald_pw, ewald_env, cell_hmat)
  ...
  CASE ( do_ewald_none )
  CASE default
     CALL cp__b("ewald_pw_methods.F",132,"")
  END SELECT
...
! This is the first ( and only ) double grid
  ...
  IF ( .NOT. ASSOCIATED ( zet ) ) THEN
    ...
    IF (isos /= 0) CALL stop_memory(routineN,moduleN,176,&
                                    "zet",dp_size)
  ENDIF
