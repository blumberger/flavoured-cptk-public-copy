# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/optimize_basis_types.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/optimize_basis_types.F"
!-----------------------------------------------------------------------------!
...
# 12 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/optimize_basis_types.F" 2
  ...
  TYPE subset_type
     ...
     TYPE(exp_constraint_type),DIMENSION(:),ALLOCATABLE :: exp_const   
  END TYPE
  ...
  TYPE kind_basis_type
     ...
     TYPE(derived_basis_info),DIMENSION(:),ALLOCATABLE :: deriv_info
...
! *****************************************************************************
   ...
   SUBROUTINE deallocate_basis_optimization_type(opt_bas)
    ...
    CHARACTER(len=*), PARAMETER :: &
      routineN = 'deallocate_basis_optimization_type', &
