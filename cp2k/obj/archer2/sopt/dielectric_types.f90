# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/pw/dielectric_types.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/pw/dielectric_types.F"
!-----------------------------------------------------------------------------!
...
# 21 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/pw/dielectric_types.F" 2
...
! *****************************************************************************
  SUBROUTINE dielectric_parameters_dealloc(dielec_params)
    ...
    CHARACTER(LEN=*), PARAMETER :: &
      routineN = 'dielectric_parameters_dealloc', &
      routineP = moduleN//':'//routineN
