# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/common/whittaker.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/common/whittaker.F"
!-----------------------------------------------------------------------------!
...
# 18 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/common/whittaker.F" 2
...
! *****************************************************************************
  SUBROUTINE whittaker_c0a ( wc, r, expa, erfa, alpha, l1, l2, n )
    ...
    CHARACTER(len=*), PARAMETER :: routineN = 'whittaker_c0a', &
    ...
    IF ( MOD(l,2) /= 0 ) THEN
        CALL cp__b("common/whittaker.F",64,"Total angular momentum has to be even")
    END IF
    IF ( l1 < l2 ) THEN
        CALL cp__b("common/whittaker.F",67,"l1 >= l2")
    END IF
...
! *****************************************************************************
  SUBROUTINE whittaker_c0 ( wc, r, expa, erfa, alpha, l, n )
    ...
    CHARACTER(len=*), PARAMETER :: routineN = 'whittaker_c0', &
      routineP = moduleN//':'//routineN

    INTEGER                                  :: i, k
    REAL(dp) :: t1, t10, t11, t12, t13, t14, t16, t17, t18, t19, t2, t21, &
      t22, t23, t25, t28, t3, t30, t31, t34, t36, t39, t4, t41, t44, t45, &
      t46, t5, t50, t51, t52, t56, t6, t61, t7, t8, t9, x

    IF ( MOD(l,2) /= 0 ) THEN
        CALL cp__b("common/whittaker.F",125,"Angular momentum has to be even")
    END IF
...
! *****************************************************************************
  SUBROUTINE whittaker_ci ( wc, r, expa, alpha, l, n )
    ...
    CHARACTER(len=*), PARAMETER :: routineN = 'whittaker_ci', &
      routineP = moduleN//':'//routineN

    INTEGER                                  :: i, k
    REAL(dp)                                 :: t1, t10, t13, t14, t17, t18, &
                                                t2, t21, t25, t29, t3, t30, &
                                                t33, t4, t5, t6, t7, t8, t9, x

    IF ( MOD(l,2) /= 0 ) THEN
        CALL cp__b("common/whittaker.F",353,"Angular momentum has to be even")
    END IF
