# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/preconditioner_solvers.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/preconditioner_solvers.F"
!-----------------------------------------------------------------------------!
...
# 46 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/preconditioner_solvers.F" 2
...
! here comes the solver
    ...
    CASE DEFAULT
       !
       CALL cp__b("preconditioner_solvers.F",115,"Doesn't know this type of solver")
    END SELECT
