# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/topology_connectivity_util.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/topology_connectivity_util.F"
!-----------------------------------------------------------------------------!
...
# 43 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/topology_connectivity_util.F" 2
...
! *****************************************************************************
  SUBROUTINE topology_connectivity_pack(molecule_kind_set,molecule_set,&
    ...
    IF(topology%nmol_type <= 0) THEN
       CALL cp__b("topology_connectivity_util.F",172,"No molecule kind defined")
    ELSE
    ...
    IF(topology%nmol <= 0) THEN
       CALL cp__b("topology_connectivity_util.F",187,"No molecule defined")
    ELSE
    ...
    DO j = 2, natom
       ...
       END IF
    END DO
    IF(.NOT.(imol==topology%nmol))CALL cp__a("topology_connectivity_util.F",310)
    ...
    END IF
    IF(.NOT.(nval_tot1==nval_tot2))CALL cp__a("topology_connectivity_util.F",470)
    ...
    END DO
    IF(.NOT.(nval_tot1==nval_tot2))CALL cp__a("topology_connectivity_util.F",629)
    DEALLOCATE(map_var_mol)
    DEALLOCATE(map_cvar_mol)
    DEALLOCATE(map_vars)
    DEALLOCATE(map_cvars)
    ...
    END DO
    IF(.NOT.(nval_tot1==nval_tot2))CALL cp__a("topology_connectivity_util.F",775)
    DEALLOCATE(map_var_mol)
    DEALLOCATE(map_cvar_mol)
    DEALLOCATE(map_vars)
    DEALLOCATE(map_cvars)
    ...
    END DO
    IF(.NOT.(nval_tot1==nval_tot2))CALL cp__a("topology_connectivity_util.F",949)
    DEALLOCATE(map_var_mol)
    DEALLOCATE(map_cvar_mol)
    DEALLOCATE(map_vars)
    DEALLOCATE(map_cvars)
    ...
    DO i=1,topology%nmol_type
       ...
       IF(.NOT.(stat==0))CALL cp__a("topology_connectivity_util.F",1067)
       iimpr  = 0
       DO j=bnd_type(1,i),bnd_type(2,i)
          IF (j==0) CYCLE
          iimpr  = iimpr + 1
    ...
    END DO
    IF(.NOT.(nval_tot1==nval_tot2))CALL cp__a("topology_connectivity_util.F",1175)
    DEALLOCATE(map_var_mol)
    DEALLOCATE(map_cvar_mol)
    DEALLOCATE(map_vars)
    DEALLOCATE(map_cvars)
