# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/dbcsr/base/btree_i8_k_sp2d_v.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/dbcsr/base/btree_i8_k_sp2d_v.F"
!-----------------------------------------------------------------------------!
...
MODULE btree_i8_k_sp2d_v
  ...
  TYPE btree_node
     ...
     TYPE(sp2d), DIMENSION(:), POINTER :: values
...
! *****************************************************************************
  SUBROUTINE btree_delete (tree, keys, values)
    ...
    TYPE(sp2d), DIMENSION(:), INTENT(OUT), &
      OPTIONAL                               :: values
...
! *****************************************************************************
  SUBROUTINE btree_add (tree, key, value, exists, existing_value, replace)
    ...
    TYPE(sp2d), INTENT(IN)                   :: value
    LOGICAL, INTENT(OUT), OPTIONAL           :: exists
    TYPE(sp2d), INTENT(OUT), OPTIONAL        :: existing_value
