# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/free_energy_types.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/free_energy_types.F"
!-----------------------------------------------------------------------------!
...
# 22 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/free_energy_types.F" 2
...
! *****************************************************************************
  SUBROUTINE fe_env_create(fe_env,fe_section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(fe_env)))CALL cp__a("free_energy_types.F",97)
