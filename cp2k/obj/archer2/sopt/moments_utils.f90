# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/moments_utils.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/moments_utils.F"
!-----------------------------------------------------------------------------!
...
# 34 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/moments_utils.F" 2
...
! *****************************************************************************
  SUBROUTINE get_reference_point(rpoint,drpoint,qs_env,fist_env,reference,ref_point,&
    ...
    LOGICAL                                  :: do_molecule
    REAL(dp)                                 :: charge, mass, mass_low, mtot, &
                                                ztot
    ...
    IF(.NOT.(PRESENT(ifirst).EQV.PRESENT(ilast)))CALL cp__a("moments_utils.F",88)
    ...
    CASE DEFAULT
       CALL cp__b("moments_utils.F",104,"Type of reference point not implemented")
