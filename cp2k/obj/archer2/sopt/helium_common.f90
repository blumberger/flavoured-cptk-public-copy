# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/motion/helium_common.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/motion/helium_common.F"
!-----------------------------------------------------------------------------!
...
# 40 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/motion/helium_common.F" 2
...
! *****************************************************************************
  SUBROUTINE helium_pbc( helium, r, enforce )
    ...
    SELECT CASE (helium%cell_shape)
      ...
      CASE DEFAULT
        CALL cp__b("motion/helium_common.F",107,"we should never get here")
    END SELECT
...
# 210 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/motion/helium_common.F"
  ...
  SUBROUTINE helium_calc_atom_cycle_length( helium )
    ...
    DO
      ...
      IF (.NOT.path_end_reached) THEN
        CALL cp__b("motion/helium_common.F",371,err_str)
      END IF
...
!          END DO
    ...
    IF (n_out_of_range .GT. 0) THEN
      CALL cp__b("motion/helium_common.F",665,msgstr)
    END IF
...
# 737 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/motion/helium_common.F"
  ...
  SUBROUTINE helium_calc_rdf (helium,centers)
    ...
    IF (.NOT. helium%periodic) THEN
      IF (n_out_of_range .GT. 0) THEN
        WRITE(msgstr,*) n_out_of_range
        msgstr = "Number of bead positions out of range: "//TRIM(ADJUSTL(msgstr))
        CALL cp__b("motion/helium_common.F",825,msgstr)
      END IF
    END IF
...
# 1206 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/motion/helium_common.F"
...
# 1348 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/motion/helium_common.F"
...
!TODO make it cp2k way
    IF (.NOT. found) THEN
        CALL cp__w("motion/helium_common.F",1527,"helium_cycle_number: we are going to return -1, problems ahead!")
    END IF
