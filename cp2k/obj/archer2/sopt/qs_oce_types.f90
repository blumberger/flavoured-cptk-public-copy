# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/qs_oce_types.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/qs_oce_types.F"
!-----------------------------------------------------------------------------!
...
# 14 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/qs_oce_types.F" 2
...
! *****************************************************************************
  SUBROUTINE create_oce_set(oce_set)
    ...
    IF (istat /= 0) CALL stop_memory(routineN,moduleN,91,"oce_set",0)
