# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/cp_dbcsr_output.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/cp_dbcsr_output.F"
!-----------------------------------------------------------------------------!
...
MODULE cp_dbcsr_output
  ...
  USE cp_dbcsr_interface,              ONLY: &
       ...
       cp_dbcsr_get_matrix_type, cp_dbcsr_get_num_blocks, cp_dbcsr_iterator, &
       cp_dbcsr_iterator_blocks_left, cp_dbcsr_iterator_next_block, &
       cp_dbcsr_iterator_start, cp_dbcsr_iterator_stop, cp_dbcsr_name, &
       cp_dbcsr_row_block_sizes, cp_dbcsr_type, dbcsr_type_antisymmetric, &
...
# 50 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/cp_dbcsr_output.F" 2
...
! *****************************************************************************
  SUBROUTINE cp_dbcsr_write_sparse_matrix(sparse_matrix,before,after,qs_env,para_env,&
    ...
    CASE(dbcsr_type_no_symmetry)
       print_sym = .FALSE.
    CASE DEFAULT
       CALL cp__b("cp_dbcsr_output.F",214,"WRONG")
    END SELECT
...
! *****************************************************************************
  SUBROUTINE copy_repl_dbcsr_to_repl_fm(sparse_matrix,fm)
    ...
    col_blk_size => cp_dbcsr_col_block_sizes(sparse_matrix)
    row_blk_size => cp_dbcsr_row_block_sizes(sparse_matrix)
...
! *****************************************************************************
  SUBROUTINE write_matrix_sym(matrix,matrix_name,before,after,qs_env,para_env,&
    ...
    INTEGER :: from, group, iatom, icol, ikind, irow, iset, isgf, ishell, &
      iso, jcol, l, left, natom, ncol, ndigits, nset, nsgf, right, to, width
