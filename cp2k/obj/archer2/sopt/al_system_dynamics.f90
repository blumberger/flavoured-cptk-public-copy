# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/motion/thermostat/al_system_dynamics.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/motion/thermostat/al_system_dynamics.F"
!-----------------------------------------------------------------------------!
...
# 28 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/motion/thermostat/al_system_dynamics.F" 2
...
! *****************************************************************************
  SUBROUTINE al_OU_step(step, al, force_env, map_info, molecule_kind_set, molecule_set, &
    ...
    IF(.NOT.(check))CALL cp__a("motion/thermostat/al_system_dynamics.F",223)
    check=ASSOCIATED(local_particles%local_particle_set)
    IF(.NOT.(check))CALL cp__a("motion/thermostat/al_system_dynamics.F",225)
    DO iparticle_kind=1,nparticle_kind
      nparticle_local = local_particles%n_el(iparticle_kind)
      check=(nparticle_local <= SIZE(local_particles%list(iparticle_kind)%array))
      IF(.NOT.(check))CALL cp__a("motion/thermostat/al_system_dynamics.F",229)
