# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/aobasis/sto_ng.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/aobasis/sto_ng.F"
!-----------------------------------------------------------------------------!
...
# 15 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/aobasis/sto_ng.F" 2
...
SUBROUTINE get_sto_ng ( zeta, n, nq, lq, alpha, coef)
    ...
    CHARACTER(len=*), PARAMETER :: routineN = 'get_sto_ng', &
  ...
  IF(.NOT.(n >= 1 .AND. n <= 6))CALL cp__a("aobasis/sto_ng.F",61)
  IF(.NOT.(na >= n))CALL cp__a("aobasis/sto_ng.F",62)
  IF(.NOT.(nc >= n))CALL cp__a("aobasis/sto_ng.F",63)
  IF(.NOT.(zeta > 0.0_dp))CALL cp__a("aobasis/sto_ng.F",64)
  IF(.NOT.(nq >= 1))CALL cp__a("aobasis/sto_ng.F",65)
  IF(.NOT.(lq >= 0))CALL cp__a("aobasis/sto_ng.F",66)
  ...
  SELECT CASE ( m )
    CASE (  1 ) ! 1s
       SELECT CASE ( n )
         ...
         CASE DEFAULT
           CALL cp__b("aobasis/sto_ng.F",100,"Illegal expansion")
       END SELECT
    CASE (  2 ) ! 2s
       SELECT CASE ( n )
         CASE ( 1 )
         ...
         CASE DEFAULT
           CALL cp__b("aobasis/sto_ng.F",132,"Illegal expansion")
       END SELECT
    CASE (  3 ) ! 2p
       SELECT CASE ( n )
         CASE ( 1 )
         ...
         CASE DEFAULT
           CALL cp__b("aobasis/sto_ng.F",164,"Illegal expansion")
       END SELECT
    CASE (  4 ) ! 3s
       SELECT CASE ( n )
         CASE ( 1 )
         ...
         CASE DEFAULT
           CALL cp__b("aobasis/sto_ng.F",196,"Illegal expansion")
       END SELECT
    CASE (  5 ) ! 3p
       SELECT CASE ( n )
         CASE ( 1 )
         ...
         CASE DEFAULT
           CALL cp__b("aobasis/sto_ng.F",228,"Illegal expansion")
       END SELECT
    CASE (  6 ) ! 3d
       SELECT CASE ( n )
         CASE ( 1 )
         ...
         CASE DEFAULT
           CALL cp__b("aobasis/sto_ng.F",260,"Illegal expansion")
       END SELECT
    CASE (  7 ) ! 4s
       SELECT CASE ( n )
         CASE ( 1 )
         ...
         CASE DEFAULT
           CALL cp__b("aobasis/sto_ng.F",292,"Illegal expansion")
       END SELECT
    CASE (  8 ) ! 4p
       SELECT CASE ( n )
         CASE ( 1 )
         ...
         CASE DEFAULT
           CALL cp__b("aobasis/sto_ng.F",324,"Illegal expansion")
       END SELECT
    CASE (  9 ) ! 4d
       SELECT CASE ( n )
         CASE ( 1 )
         ...
         CASE DEFAULT
           CALL cp__b("aobasis/sto_ng.F",356,"Illegal expansion")
       END SELECT
    CASE ( 10 ) ! 4f
       SELECT CASE ( n )
         CASE ( 1 )
         ...
         CASE DEFAULT
           CALL cp__b("aobasis/sto_ng.F",388,"Illegal expansion")
       END SELECT
    CASE ( 11 ) ! 5s
       SELECT CASE ( n )
         CASE ( 1 )
         ...
         CASE DEFAULT
           CALL cp__b("aobasis/sto_ng.F",420,"Illegal expansion")
       END SELECT
    CASE ( 12 ) ! 5p
       SELECT CASE ( n )
         CASE ( 1 )
         ...
         CASE DEFAULT
           CALL cp__b("aobasis/sto_ng.F",452,"Illegal expansion")
       END SELECT
    CASE ( 13 ) ! 5d
       SELECT CASE ( n )
         CASE ( 1 )
         ...
         CASE DEFAULT
           CALL cp__b("aobasis/sto_ng.F",484,"Illegal expansion")
       END SELECT
    CASE ( 14 ) ! 5f
       SELECT CASE ( n )
         CASE ( 1 )
         ...
         CASE DEFAULT
           CALL cp__b("aobasis/sto_ng.F",516,"Illegal expansion")
       END SELECT
    CASE ( 15 ) ! 5g
       SELECT CASE ( n )
         CASE ( 1 )
         ...
         CASE DEFAULT
           CALL cp__b("aobasis/sto_ng.F",548,"Illegal expansion")
       END SELECT
    CASE ( 16 ) ! 6s
       SELECT CASE ( n )
         CASE ( 1 )
         ...
         CASE DEFAULT
           CALL cp__b("aobasis/sto_ng.F",580,"Illegal expansion")
       END SELECT
    CASE ( 17 ) ! 6p
       SELECT CASE ( n )
         CASE ( 1 )
         ...
         CASE DEFAULT
           CALL cp__b("aobasis/sto_ng.F",612,"Illegal expansion")
       END SELECT
    CASE ( 18 ) ! 6d
       SELECT CASE ( n )
         CASE ( 1 )
         ...
         CASE DEFAULT
           CALL cp__b("aobasis/sto_ng.F",644,"Illegal expansion")
       END SELECT
    CASE ( 19 ) ! 6f
       SELECT CASE ( n )
         CASE ( 1 )
         ...
         CASE DEFAULT
           CALL cp__b("aobasis/sto_ng.F",676,"Illegal expansion")
       END SELECT
    CASE ( 20 ) ! 6g
       SELECT CASE ( n )
         CASE ( 1 )
         ...
         CASE DEFAULT
           CALL cp__b("aobasis/sto_ng.F",708,"Illegal expansion")
       END SELECT
    CASE ( 21 ) ! 6h
       SELECT CASE ( n )
         CASE ( 1 )
         ...
         CASE DEFAULT
           CALL cp__b("aobasis/sto_ng.F",740,"Illegal expansion")
       END SELECT
    CASE ( 22 ) ! 7s
       SELECT CASE ( n )
         CASE ( 1 )
         ...
         CASE DEFAULT
           CALL cp__b("aobasis/sto_ng.F",773,"Illegal expansion")
       END SELECT
    CASE ( 23 ) ! 7p
       SELECT CASE ( n )
         CASE ( 1 )
         ...
         CASE DEFAULT
           CALL cp__b("aobasis/sto_ng.F",806,"Illegal expansion")
       END SELECT
    CASE ( 24 ) ! 7d
       SELECT CASE ( n )
         CASE ( 1 )
         ...
         CASE DEFAULT
           CALL cp__b("aobasis/sto_ng.F",839,"Illegal expansion")
       END SELECT
    CASE ( 25 ) ! 7f
       SELECT CASE ( n )
         CASE ( 1 )
         ...
         CASE DEFAULT
           CALL cp__b("aobasis/sto_ng.F",871,"Illegal expansion")
       END SELECT
    CASE ( 26 ) ! 7g
       SELECT CASE ( n )
         CASE ( 1 )
         ...
         CASE DEFAULT
           CALL cp__b("aobasis/sto_ng.F",903,"Illegal expansion")
       END SELECT
    CASE ( 27 ) ! 7h
       SELECT CASE ( n )
         CASE ( 1 )
         ...
         CASE DEFAULT
           CALL cp__b("aobasis/sto_ng.F",935,"Illegal expansion")
       END SELECT
    CASE ( 28 ) ! 7i
       SELECT CASE ( n )
         CASE ( 1 )
         ...
         CASE DEFAULT
           CALL cp__b("aobasis/sto_ng.F",967,"Illegal expansion")
       END SELECT
    CASE DEFAULT
      CALL cp__b("aobasis/sto_ng.F",970,"Illegal STO")
  END SELECT
  ! scaling: a = zeta^2 * a
