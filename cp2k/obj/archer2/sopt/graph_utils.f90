# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/metadyn_tools/graph_utils.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/metadyn_tools/graph_utils.F"
!-----------------------------------------------------------------------------!
...
# 20 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/metadyn_tools/graph_utils.F" 2
...
! *****************************************************************************
  SUBROUTINE get_val_res(unit, section, keyword, subsection, i_val, r_val)
    ...
    IF (stat/=0) THEN 
       ...
       CALL cp__b("metadyn_tools/graph_utils.F",206,"Search failed!")
    END IF
