# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/scptb_types.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/scptb_types.F"
!-----------------------------------------------------------------------------!
...
# 24 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/scptb_types.F" 2
...
! *****************************************************************************
  SUBROUTINE deallocate_scptb_parameter(scptb_parameter)
    ...
    IF(.NOT.(ASSOCIATED(scptb_parameter)))CALL cp__a("scptb_types.F",151)
...
! *****************************************************************************
  SUBROUTINE get_scptb_parameter(scptb_parameter,key,atomname,parameterization,defined,z,zeff,natorb,&
    ...
    IF(.NOT.(ASSOCIATED(scptb_parameter)))CALL cp__a("scptb_types.F",201)
...
! *****************************************************************************
  SUBROUTINE set_scptb_parameter(scptb_parameter,key,atomname,parameterization,defined,z,zeff,natorb,&
    ...
    IF(.NOT.(ASSOCIATED(scptb_parameter)))CALL cp__a("scptb_types.F",270)
