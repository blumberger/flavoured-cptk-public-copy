# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/qs_linres_nmr_utils.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/qs_linres_nmr_utils.F"
!-----------------------------------------------------------------------------!
...
# 54 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/qs_linres_nmr_utils.F" 2
...
!
    ...
    !   CALL cp__b("qs_linres_nmr_utils.F",171,"restart_nmr requires density_guess=restart")
    !ENDIF
    !
    ! check that the psi0 are localized and you have all the centers
    IF(.NOT.linres_control%localized_psi0)&
       CALL cp__w("qs_linres_nmr_utils.F",176,' To get NMR parameters within PBC you need localized zero order orbitals ')
