# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/xc_adiabatic_utils.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/xc_adiabatic_utils.F"
!-----------------------------------------------------------------------------!
...
# 39 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/xc_adiabatic_utils.F" 2
...
! *****************************************************************************
  SUBROUTINE  rescale_xc_potential(qs_env,ks_matrix,rho,energy,v_rspace_new,v_tau_rspace,&
    ...
    IF(.NOT.(nimages==1))CALL cp__a("xc_adiabatic_utils.F",110)
    ...
    CASE (do_adiabatic_hybrid_mcy3)
       ...
       CASE(do_adiabatic_model_pade)
          IF(n_rep_hf /= 2)&
             CALL cp_abort(cp__l("xc_adiabatic_utils.F",136),&
          ...
          IF( calculate_forces ) THEN
             IF(.NOT.(.NOT.use_virial))CALL cp__a("xc_adiabatic_utils.F",151)
