# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/start/cp2k.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/start/cp2k.F"
!-----------------------------------------------------------------------------!
...
# 65 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/start/cp2k.F" 2
  ...
  IF (ierr==0) THEN
     ...
     IF (.NOT. command_line_error) THEN
        ...
        IF (run_it .OR. force_run) THEN
           ...
           IF (ierr.NE.0) CALL cp__b("start/cp2k.F",284,"Failed to run input")
        END IF
