# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/input_cp2k_properties_dft.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/input_cp2k_properties_dft.F"
!-----------------------------------------------------------------------------!
...
MODULE input_cp2k_properties_dft
  ...
  USE input_constants,                 ONLY: &
       ...
       current_orb_center_common, current_orb_center_wannier, &
       do_ddapc_constraint, do_ddapc_restraint, do_et_becke, do_et_ddapc, &
       do_full_density, do_no_et, do_spin_density, ot_precond_full_all, &
...
# 51 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/input_cp2k_properties_dft.F" 2
...
! *****************************************************************************
  SUBROUTINE create_properties_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_properties_dft.F",76)
...
! *****************************************************************************
  SUBROUTINE create_linres_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_properties_dft.F",136)
...
! *****************************************************************************
  SUBROUTINE create_current_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_properties_dft.F",276)
...
! *****************************************************************************
  SUBROUTINE create_nmr_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_properties_dft.F",468)
...
! *****************************************************************************
  SUBROUTINE create_spin_spin_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_properties_dft.F",618)
...
! *****************************************************************************
  SUBROUTINE create_epr_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_properties_dft.F",723)
...
! *****************************************************************************
  SUBROUTINE create_polarizability_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_properties_dft.F",859)
...
! *****************************************************************************
  SUBROUTINE create_et_coupling_section(section)
    ...
    NULLIFY(keyword)
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_properties_dft.F",920)
...
! *****************************************************************************
  SUBROUTINE create_restraint_A(section,section_name)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_properties_dft.F",980)
