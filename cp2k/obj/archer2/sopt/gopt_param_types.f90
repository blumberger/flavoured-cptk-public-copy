# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/motion/gopt_param_types.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/motion/gopt_param_types.F"
!-----------------------------------------------------------------------------!
...
# 25 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/motion/gopt_param_types.F" 2
...
! *****************************************************************************
  SUBROUTINE gopt_param_read(gopt_param, gopt_section, type_id)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(gopt_param)))CALL cp__a("motion/gopt_param_types.F",109)
    IF(.NOT.(ASSOCIATED(gopt_section)))CALL cp__a("motion/gopt_param_types.F",110)
...
! *****************************************************************************
  SUBROUTINE gopt_param_retain(gopt_param)
    ...
    IF(.NOT.(ASSOCIATED(gopt_param)))CALL cp__a("motion/gopt_param_types.F",177)
    IF(.NOT.(gopt_param%ref_count>0))CALL cp__a("motion/gopt_param_types.F",178)
...
! *****************************************************************************
  SUBROUTINE gopt_param_release(gopt_param)
    ...
    IF (ASSOCIATED(gopt_param)) THEN
       IF(.NOT.(gopt_param%ref_count>0))CALL cp__a("motion/gopt_param_types.F",195)
       gopt_param%ref_count=gopt_param%ref_count-1
