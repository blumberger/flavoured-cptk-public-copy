# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/topology_multiple_unit_cell.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/topology_multiple_unit_cell.F"
!-----------------------------------------------------------------------------!
...
# 23 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/topology_multiple_unit_cell.F" 2
...
! *****************************************************************************
  SUBROUTINE topology_muc(topology, subsys_section)
    ...
    IF(ANY(multiple_unit_cell<=0))&
       CALL cp_abort(cp__l("topology_multiple_unit_cell.F",64), "SUBSYS%TOPOLOGY%MULTIPLE_UNIT_CELL accepts "//&
    ...
    IF (ANY(multiple_unit_cell/=1)) THEN
       ...
       IF(ANY(iwork/=multiple_unit_cell))&
          CALL cp_abort(cp__l("topology_multiple_unit_cell.F",71),"SUBSYS%TOPOLOGY%MULTIPLE_UNIT_CELL and "//&
       ...
       IF (explicit) THEN
          ...
          check = nrep==natoms
          IF(.NOT.check)&
             CALL cp_abort(cp__l("topology_multiple_unit_cell.F",84),&
