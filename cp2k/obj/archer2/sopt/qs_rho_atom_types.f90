# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/qs_rho_atom_types.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/qs_rho_atom_types.F"
!-----------------------------------------------------------------------------!
...
# 13 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/qs_rho_atom_types.F" 2
...
! *****************************************************************************
  SUBROUTINE allocate_rho_atom_set(rho_atom_set,natom)
    ...
    IF (istat /= 0) CALL stop_memory(routineN,moduleN,83,&
...
! *****************************************************************************
  SUBROUTINE deallocate_rho_atom_set(rho_atom_set)
    ...
    ELSE
      ...
      CALL cp_abort(cp__l("qs_rho_atom_types.F",237),&
...
! *****************************************************************************
  SUBROUTINE get_rho_atom(rho_atom,cpc_h,cpc_s,rho_rad_h,rho_rad_s,&
    ...
    ELSE
      CALL cp__b("qs_rho_atom_types.F",299,"The pointer rho_atom is not associated")
    END IF
