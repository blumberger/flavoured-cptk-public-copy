# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/qs_scf_wfn_mix.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/qs_scf_wfn_mix.F"
!-----------------------------------------------------------------------------!
...
# 39 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/qs_scf_wfn_mix.F" 2
...
! *****************************************************************************
  SUBROUTINE wfn_mix(mos, particle_set, dft_section, qs_kind_set,&
    ...
    LOGICAL                                  :: explicit, orig_is_virtual, &
                                                overwrite_mos
