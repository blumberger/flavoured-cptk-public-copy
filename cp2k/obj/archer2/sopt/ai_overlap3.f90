# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/aobasis/ai_overlap3.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/aobasis/ai_overlap3.F"
!-----------------------------------------------------------------------------!
...
# 51 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/aobasis/ai_overlap3.F" 2
...
! *****************************************************************************
  ...
  SUBROUTINE overlap3(la_max_set,npgfa,zeta,rpgfa,la_min_set,&
                      ...
                      rab,dab,rac,dac,rbc,dbc,sabc,sdabc,sabdc)
    ...
    INTEGER :: ax, ay, az, bx, by, bz, coa, coax, coay, coaz, coc, cocx, &
      cocy, cocz, cx, cy, cz, handle, i, ipgf, j, jpgf, k, kpgf, l, la, &
      la_max, la_min, la_start, lai, lb, lb_max, lb_min, lbi, lc, lc_max, &
      lc_min, lci, na, nb, nc, nda, ndc
...
! *****************************************************************************
  SUBROUTINE derivatives_overlap3(la_max_set,la_min_set,lb_max_set,lb_min_set,&
    ...
    INTEGER :: ax, ay, az, bx, by, bz, coa, coamx, coamy, coamz, coapx, &
      coapy, coapz, cob, coc, cocmx, cocmy, cocmz, cocpx, cocpy, cocpz, cx, &
      cy, cz, devx, devy, devz, handle, la, lb, lc
    REAL(KIND=dp)                            :: fax, fay, faz, fcx, fcy, fcz, &
                                                fexpa, fexpc
