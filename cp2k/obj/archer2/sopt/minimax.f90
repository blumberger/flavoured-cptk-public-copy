# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/minimax.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/minimax.F"
!-----------------------------------------------------------------------------!
...
# 16 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/minimax.F" 2

   IMPLICIT NONE

   PRIVATE

  CHARACTER(len=*), PARAMETER, PRIVATE :: moduleN = 'minimax'

   PUBLIC :: get_minimax_coeff, check_range
...
! *****************************************************************************
   SUBROUTINE check_range(k,Rc,ierr)
    INTEGER                                  :: k
    REAL(KIND=dp)                            :: Rc
    INTEGER                                  :: ierr
...
!> \author Mauro Del Ben 
! *****************************************************************************
   SUBROUTINE get_minimax_coeff(k,Rc,aw,ierr)
    INTEGER                                  :: k
    REAL(KIND=dp)                            :: Rc
    REAL(KIND=dp), DIMENSION(:)              :: aw
    INTEGER                                  :: ierr

    CHARACTER(LEN=*), PARAMETER :: routineN = 'get_minimax_coeff', &
      routineP = moduleN//':'//routineN

    INTEGER                                  :: handle, icoef, kkk
    REAL(KIND=dp)                            :: L_b, R_max, R_min, R_transf, &
                                                U_b
    REAL(KIND=dp), DIMENSION(0:12, 2*k)      :: fit_coef
     ...
     IF(Rc<R_max.AND.Rc>=R_min.AND.ierr==0) THEN
   ...
   END SUBROUTINE get_minimax_coeff
