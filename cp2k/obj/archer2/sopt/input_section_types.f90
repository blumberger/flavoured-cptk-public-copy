# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/input/input_section_types.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/input/input_section_types.F"
!-----------------------------------------------------------------------------!
...
# 51 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/input/input_section_types.F" 2
...
! *****************************************************************************
  SUBROUTINE section_create(section,name,description,n_keywords,&
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input/input_section_types.F",172)
    my_n_keywords=10
...
! *****************************************************************************
  SUBROUTINE section_retain(section)
    ...
    IF(.NOT.(ASSOCIATED(section)))CALL cp__a("input/input_section_types.F",226)
    IF(.NOT.(section%ref_count>0))CALL cp__a("input/input_section_types.F",227)
...
! *****************************************************************************
  RECURSIVE SUBROUTINE section_release(section)
    ...
    IF (ASSOCIATED(section)) THEN
       IF(.NOT.(section%ref_count>0))CALL cp__a("input/input_section_types.F",245)
       section%ref_count=section%ref_count-1
...
! *****************************************************************************
  RECURSIVE SUBROUTINE section_describe(section, unit_nr, level, hide_root, recurse)
    ...
    IF (unit_nr>0) THEN
       ...
       IF (ASSOCIATED(section)) THEN
          IF(.NOT.(section%ref_count>0))CALL cp__a("input/input_section_types.F",331)
...
! *****************************************************************************
  RECURSIVE SUBROUTINE section_describe_html(section, prefix, depth, unit_number)
    ...
    IF (ASSOCIATED(section)) THEN
       ...
       IF(.NOT.(section%ref_count>0))CALL cp__a("input/input_section_types.F",397)
...
! *****************************************************************************
  RECURSIVE SUBROUTINE section_describe_index_html(section,prefix, unit_nr)
    ...
    IF (ASSOCIATED(section)) THEN
       IF(.NOT.(section%ref_count>0))CALL cp__a("input/input_section_types.F",497)
       local_prefix=TRIM(prefix//"~"//TRIM(section%name))
       WRITE(unit_nr,FMT='(A)') &
...
! *****************************************************************************
  FUNCTION section_get_subsection_index(section,subsection_name) RESULT(res)
    ...
    IF(.NOT.(ASSOCIATED(section)))CALL cp__a("input/input_section_types.F",531)
    IF(.NOT.(section%ref_count>0))CALL cp__a("input/input_section_types.F",532)
    res=-1
    upc_name=subsection_name
    CALL uppercase(upc_name)
    DO isub=1,section%n_subsections
       IF(.NOT.(ASSOCIATED(section%subsections(isub)%section)))CALL cp__a("input/input_section_types.F",537)
...
! *****************************************************************************
  FUNCTION section_get_keyword_index(section,keyword_name) RESULT(res)
    ...
    IF(.NOT.(ASSOCIATED(section)))CALL cp__a("input/input_section_types.F",590)
    IF(.NOT.(section%ref_count>0))CALL cp__a("input/input_section_types.F",591)
    IF(.NOT.(ASSOCIATED(section%keywords)))CALL cp__a("input/input_section_types.F",592)
    res=-2
    ...
    IF (res==-2) THEN
       k_search_loop: DO ik=1,section%n_keywords
          IF(.NOT.(ASSOCIATED(section%keywords(ik)%keyword)))CALL cp__a("input/input_section_types.F",605)
...
! *****************************************************************************
  RECURSIVE FUNCTION section_get_keyword(section,keyword_name) RESULT(res)
    ...
    IF (INDEX(keyword_name,"%")/=0) THEN
       ...
       IF(.NOT.(ASSOCIATED(section%subsections)))CALL cp__a("input/input_section_types.F",635)
       ...
       END DO
       IF(.NOT.(ik<=UBOUND(section%subsections,1)))CALL cp__a("input/input_section_types.F",639)
...
! *****************************************************************************
  SUBROUTINE section_add_keyword(section,keyword)
    ...
    IF(.NOT.(ASSOCIATED(section)))CALL cp__a("input/input_section_types.F",668)
    IF(.NOT.(section%ref_count>0))CALL cp__a("input/input_section_types.F",669)
    IF(.NOT.(.NOT.section%frozen))CALL cp__a("input/input_section_types.F",670)
    IF(.NOT.(ASSOCIATED(keyword)))CALL cp__a("input/input_section_types.F",671)
    IF(.NOT.(keyword%ref_count>0))CALL cp__a("input/input_section_types.F",672)
          ...
          DO i=1,section%n_keywords
             DO j=1,SIZE(section%keywords(i)%keyword%names)
                IF (keyword%names(k)==section%keywords(i)%keyword%names(j)) THEN
                   CALL cp_abort(cp__l("input/input_section_types.F",685),&
...
! *****************************************************************************
  SUBROUTINE section_add_subsection(section,subsection)
    ...
    IF(.NOT.(ASSOCIATED(section)))CALL cp__a("input/input_section_types.F",726)
    IF(.NOT.(section%ref_count>0))CALL cp__a("input/input_section_types.F",727)
    IF(.NOT.(ASSOCIATED(subsection)))CALL cp__a("input/input_section_types.F",728)
    IF(.NOT.(subsection%ref_count>0))CALL cp__a("input/input_section_types.F",729)
    ...
    DO i=1,section%n_subsections
       IF(subsection%name==section%subsections(i)%section%name)&
            CALL cp_abort(cp__l("input/input_section_types.F",743),&
...
! *****************************************************************************
  RECURSIVE SUBROUTINE section_vals_create(section_vals,section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section_vals)))CALL cp__a("input/input_section_types.F",768)
...
! *****************************************************************************
  SUBROUTINE section_vals_retain(section_vals)
    ...
    IF(.NOT.(ASSOCIATED(section_vals)))CALL cp__a("input/input_section_types.F",797)
    IF(.NOT.(section_vals%ref_count>0))CALL cp__a("input/input_section_types.F",798)
...
! *****************************************************************************
  RECURSIVE SUBROUTINE section_vals_release(section_vals)
    ...
    IF (ASSOCIATED(section_vals)) THEN
       IF(.NOT.(section_vals%ref_count>0))CALL cp__a("input/input_section_types.F",818)
       section_vals%ref_count=section_vals%ref_count-1
...
! *****************************************************************************
  SUBROUTINE section_vals_get(section_vals, ref_count, id_nr, n_repetition,&
    ...
    IF(.NOT.(ASSOCIATED(section_vals)))CALL cp__a("input/input_section_types.F",870)
    IF(.NOT.(section_vals%ref_count>0))CALL cp__a("input/input_section_types.F",871)
...
! *****************************************************************************
  RECURSIVE FUNCTION section_vals_get_subs_vals(section_vals,subsection_name,&
    ...
    IF(.NOT.(ASSOCIATED(section_vals)))CALL cp__a("input/input_section_types.F",904)
    IF(.NOT.(section_vals%ref_count>0))CALL cp__a("input/input_section_types.F",905)
    ...
    IF(.NOT.(irep<=SIZE(section_vals%subs_vals,2)))CALL cp__a("input/input_section_types.F",924)
    ...
    IF(.NOT.(ASSOCIATED(res).OR.my_can_return_null))&
         CALL cp_abort(cp__l("input/input_section_types.F",929),&
...
! *****************************************************************************
  FUNCTION section_vals_get_subs_vals2(section_vals,i_section,i_rep_section) RESULT(res)
    ...
    IF(.NOT.(ASSOCIATED(section_vals)))CALL cp__a("input/input_section_types.F",960)
    IF(.NOT.(section_vals%ref_count>0))CALL cp__a("input/input_section_types.F",961)
    NULLIFY(res)
    irep=1
    IF (PRESENT(i_rep_section)) irep=i_rep_section
    IF(.NOT.(irep<=SIZE(section_vals%subs_vals,2)))CALL cp__a("input/input_section_types.F",965)
    isect_att=0
...
! *****************************************************************************
  FUNCTION section_vals_get_subs_vals3(section_vals,subsection_name,&
    ...
    IF(.NOT.(ASSOCIATED(section_vals)))CALL cp__a("input/input_section_types.F",1000)
    IF(.NOT.(section_vals%ref_count>0))CALL cp__a("input/input_section_types.F",1001)
    NULLIFY(res)
    irep=1
    IF (PRESENT(i_rep_section)) irep=i_rep_section
    IF(.NOT.(irep<=SIZE(section_vals%subs_vals,2)))CALL cp__a("input/input_section_types.F",1005)
...
! *****************************************************************************
  SUBROUTINE section_vals_add_values(section_vals)
    ...
    IF(.NOT.(ASSOCIATED(section_vals)))CALL cp__a("input/input_section_types.F",1027)
    IF(.NOT.(section_vals%ref_count>0))CALL cp__a("input/input_section_types.F",1028)
...
! *****************************************************************************
  SUBROUTINE section_vals_remove_values(section_vals)
    ...
    IF (ASSOCIATED(section_vals)) THEN
       IF(.NOT.(section_vals%ref_count>0))CALL cp__a("input/input_section_types.F",1079)
       NULLIFY(el, vals)
...
! *****************************************************************************
  SUBROUTINE section_vals_val_get(section_vals,keyword_name,i_rep_section,&
    ...
    IF(.NOT.(ASSOCIATED(section_vals)))CALL cp__a("input/input_section_types.F",1254)
    IF(.NOT.(section_vals%ref_count>0))CALL cp__a("input/input_section_types.F",1255)
    ...
    IF(ik==-2) &
          CALL cp_abort(cp__l("input/input_section_types.F",1282),&
    ...
    IF(.NOT.(irs>0.AND.irs<=SIZE(s_vals%subs_vals,2)))&
          CALL cp_abort(cp__l("input/input_section_types.F",1287),&
    ...
    IF (valRequested) THEN
       IF(.NOT.ASSOCIATED(my_val))&
            CALL cp_abort(cp__l("input/input_section_types.F",1314),&
...
! *****************************************************************************
  SUBROUTINE section_vals_list_get(section_vals,keyword_name,i_rep_section,&
    ...
    IF(.NOT.(ASSOCIATED(section_vals)))CALL cp__a("input/input_section_types.F",1351)
    IF(.NOT.(section_vals%ref_count>0))CALL cp__a("input/input_section_types.F",1352)
    NULLIFY(list)
    my_index=INDEX(keyword_name,'%')+1
    len_key=LEN_TRIM(keyword_name)
    IF (my_index>1) THEN
    ...
    ik=section_get_keyword_index(s_vals%section,keyword_name(my_index:len_key))
    IF(ik==-2)&
         CALL cp_abort(cp__l("input/input_section_types.F",1372),&
              "section "//TRIM(section%name)//" does not contain keyword "//&
              TRIM(keyword_name(my_index:len_key)))
    IF(.NOT.(irs>0.AND.irs<=SIZE(s_vals%subs_vals,2)))&
         CALL cp_abort(cp__l("input/input_section_types.F",1376),&
              "section repetition requested ("//cp_to_string(irs)//&
              ") out of bounds (1:"//cp_to_string(SIZE(s_vals%subs_vals,2))&
              //")")
...
! *****************************************************************************
  SUBROUTINE section_vals_val_set(section_vals,keyword_name,i_rep_section,i_rep_val,&
    ...
    IF(.NOT.(ASSOCIATED(section_vals)))CALL cp__a("input/input_section_types.F",1434)
    IF(.NOT.(section_vals%ref_count>0))CALL cp__a("input/input_section_types.F",1435)
    ...
    ik=section_get_keyword_index(s_vals%section,keyword_name(my_index:len_key))
    IF(ik==-2)&
         CALL cp_abort(cp__l("input/input_section_types.F",1457),&
              "section "//TRIM(section%name)//" does not contain keyword "//&
              TRIM(keyword_name(my_index:len_key)))
    ! Add values..
    DO
    ...
    END DO
    IF(.NOT.(irs>0.AND.irs<=SIZE(s_vals%subs_vals,2)))&
         CALL cp_abort(cp__l("input/input_section_types.F",1466),&
              "section repetition requested ("//cp_to_string(irs)//&
              ") out of bounds (1:"//cp_to_string(SIZE(s_vals%subs_vals,2))&
              //")")
    ...
    IF (ASSOCIATED(my_val)) THEN
       ! check better?
       IF(valSet)&
            CALL cp_abort(cp__l("input/input_section_types.F",1479),&
    ...
    ELSE
       ! ignore ?
       IF(.NOT.valSet)&
            CALL cp_abort(cp__l("input/input_section_types.F",1486),&
                 " empty value in setting "//&
                 "keyword "//TRIM(keyword_name(my_index:len_key))//" of section "//&
                 TRIM(section%name))
       IF(.NOT.(valSet))CALL cp__a("input/input_section_types.F",1490)
       ...
       END IF
       IF(.NOT.(ASSOCIATED(my_val)))CALL cp__a("input/input_section_types.F",1499)
       IF(.NOT.(my_val%type_of_var==keyword%type_of_var))CALL cp__a("input/input_section_types.F",1500)
    END IF
    vals => s_vals%values(ik,irs)%list
    IF (irk==-1) THEN
    ...
    ELSE IF (irk <= cp_sll_val_get_length(vals)) THEN
       IF(irk<=0)&
            CALL cp_abort(cp__l("input/input_section_types.F",1507),&
    ...
    ELSE IF (irk>cp_sll_val_get_length(vals)+1) THEN
       ! change?
       CALL cp_abort(cp__l("input/input_section_types.F",1516),&
...
! *****************************************************************************
  SUBROUTINE section_vals_val_unset(section_vals,keyword_name,i_rep_section,&
    ...
    NULLIFY(pos)
    IF(.NOT.(ASSOCIATED(section_vals)))CALL cp__a("input/input_section_types.F",1557)
    IF(.NOT.(section_vals%ref_count>0))CALL cp__a("input/input_section_types.F",1558)
    ...
    ik=section_get_keyword_index(s_vals%section,keyword_name(my_index:len_key))
    IF(ik==-2)&
         CALL cp_abort(cp__l("input/input_section_types.F",1580),&
              "section "//TRIM(section%name)//" does not contain keyword "//&
              TRIM(keyword_name(my_index:len_key)))
    ! ignore unset of non set values
    IF (irs<=SIZE(s_vals%values,2)) THEN
       IF(.NOT.(irs>0.AND.irs<=SIZE(s_vals%subs_vals,2)))&
            CALL cp_abort(cp__l("input/input_section_types.F",1586),&
                 "section repetition requested ("//cp_to_string(irs)//&
                 ") out of bounds (1:"//cp_to_string(SIZE(s_vals%subs_vals,2))&
                 //")")
       IF (irk==-1) THEN
...
! *****************************************************************************
  RECURSIVE SUBROUTINE section_vals_write(section_vals,unit_nr,hide_root,hide_defaults)
    ...
    IF(.NOT.(ASSOCIATED(section_vals)))CALL cp__a("input/input_section_types.F",1640)
    IF(.NOT.(section_vals%ref_count>0))CALL cp__a("input/input_section_types.F",1641)
    IF (unit_nr>0) THEN
...
! *****************************************************************************
  RECURSIVE SUBROUTINE write_section_xml(section,level,unit_number)
    ...
    IF (ASSOCIATED(section)) THEN
       ...
       IF(.NOT.(section%ref_count>0))CALL cp__a("input/input_section_types.F",1753)
...
! *****************************************************************************
  RECURSIVE SUBROUTINE section_typo_match(section,section_name,unknown_string,location_string,&
    ...
    IF (ASSOCIATED(section)) THEN
       IF(.NOT.(section%ref_count>0))CALL cp__a("input/input_section_types.F",1831)
...
! *****************************************************************************
  SUBROUTINE section_vals_set_subs_vals(section_vals,subsection_name,&
    ...
    IF(.NOT.(ASSOCIATED(section_vals)))CALL cp__a("input/input_section_types.F",1894)
    IF(.NOT.(section_vals%ref_count>0))CALL cp__a("input/input_section_types.F",1895)
    IF(.NOT.(ASSOCIATED(new_section_vals)))CALL cp__a("input/input_section_types.F",1896)
    IF(.NOT.(new_section_vals%ref_count>0))CALL cp__a("input/input_section_types.F",1897)
    ...
    IF(.NOT.(irep<=SIZE(s_vals%subs_vals,2)))CALL cp__a("input/input_section_types.F",1915)

    isection=section_get_subsection_index(s_vals%section,subsection_name(my_index:LEN_TRIM(subsection_name)))
    IF(isection<=0)&
         CALL cp_abort(cp__l("input/input_section_types.F",1919),&
...
! *****************************************************************************
  SUBROUTINE section_vals_duplicate(section_vals_in,section_vals_out,&
    ...
    IF(.NOT.(ASSOCIATED(section_vals_in)))CALL cp__a("input/input_section_types.F",1945)
    IF(.NOT.(.NOT.ASSOCIATED(section_vals_out)))CALL cp__a("input/input_section_types.F",1946)
...
! *****************************************************************************
  RECURSIVE SUBROUTINE section_vals_copy(section_vals_in,section_vals_out,&
    ...
    IF(.NOT.(ASSOCIATED(section_vals_in)))CALL cp__a("input/input_section_types.F",1976)
    IF(.NOT.(ASSOCIATED(section_vals_out)))CALL cp__a("input/input_section_types.F",1977)
    !  IF(section_vals_in%section%id_nr/=section_vals_out%section%id_nr)&
    !     CALL cp__b("input/input_section_types.F",1979,"")
    ...
    IF (.NOT.PRESENT(i_rep_low).AND.(.NOT.PRESENT(i_rep_high))) THEN
     IF(.NOT.(SIZE(section_vals_in%values,2)==SIZE(section_vals_out%values,2)))CALL cp__a("input/input_section_types.F",2006)
     IF(.NOT.(SIZE(section_vals_in%subs_vals,2)==SIZE(section_vals_out%subs_vals,2)))CALL cp__a("input/input_section_types.F",2007)
    END IF
