# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/xc/xc_xbr_pbe_lda_hole_t_c_lr.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/xc/xc_xbr_pbe_lda_hole_t_c_lr.F"
!-----------------------------------------------------------------------------!
...
# 48 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/xc/xc_xbr_pbe_lda_hole_t_c_lr.F" 2
...
! *****************************************************************************
  SUBROUTINE xbr_pbe_lda_hole_tc_lr_lda_eval(rho_set,deriv_set,grad_deriv,params)
    ...
    IF(.NOT.(ASSOCIATED(rho_set)))CALL cp__a("xc/xc_xbr_pbe_lda_hole_t_c_lr.F",208)
    IF(.NOT.(rho_set%ref_count>0))CALL cp__a("xc/xc_xbr_pbe_lda_hole_t_c_lr.F",209)
    IF(.NOT.(ASSOCIATED(deriv_set)))CALL cp__a("xc/xc_xbr_pbe_lda_hole_t_c_lr.F",210)
    IF(.NOT.(deriv_set%ref_count>0))CALL cp__a("xc/xc_xbr_pbe_lda_hole_t_c_lr.F",211)
    ...
    END IF
    IF (grad_deriv>1.OR.grad_deriv<-1) THEN
      CALL cp__b("xc/xc_xbr_pbe_lda_hole_t_c_lr.F",245,"derivatives bigger than 1 not implemented")
    END IF
    ...
    IF ( R == 0.0_dp ) THEN
      CALL cp__b("xc/xc_xbr_pbe_lda_hole_t_c_lr.F",253,"Cutoff_Radius 0.0 not implemented")
    END IF
...
! *****************************************************************************
  SUBROUTINE xbr_pbe_lda_hole_tc_lr_lsd_eval(rho_set,deriv_set,grad_deriv,params)
    ...
    IF(.NOT.(ASSOCIATED(rho_set)))CALL cp__a("xc/xc_xbr_pbe_lda_hole_t_c_lr.F",486)
    IF(.NOT.(rho_set%ref_count>0))CALL cp__a("xc/xc_xbr_pbe_lda_hole_t_c_lr.F",487)
    IF(.NOT.(ASSOCIATED(deriv_set)))CALL cp__a("xc/xc_xbr_pbe_lda_hole_t_c_lr.F",488)
    IF(.NOT.(deriv_set%ref_count>0))CALL cp__a("xc/xc_xbr_pbe_lda_hole_t_c_lr.F",489)
    ...
    END IF
    IF (grad_deriv>1.OR.grad_deriv<-1) THEN
      CALL cp__b("xc/xc_xbr_pbe_lda_hole_t_c_lr.F",543,"derivatives bigger than 1 not implemented")
    END IF
    ...
    IF ( R == 0.0_dp ) THEN
      CALL cp__b("xc/xc_xbr_pbe_lda_hole_t_c_lr.F",551,"Cutoff_Radius 0.0 not implemented")
    END IF
