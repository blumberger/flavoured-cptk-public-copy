# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/eip_environment_types.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/eip_environment_types.F"
!-----------------------------------------------------------------------------!
...
# 43 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/eip_environment_types.F" 2
...
!> \author Thomas D. Kuehne (tkuehne@phys.chem.ethz.ch)
! *****************************************************************************
  SUBROUTINE eip_env_retain(eip_env)
...
!   ------------------------------------------------------------------------
    ...
    IF(.NOT.(ASSOCIATED(eip_env)))CALL cp__a("eip_environment_types.F",134)
    IF(.NOT.(eip_env%ref_count>0))CALL cp__a("eip_environment_types.F",135)
...
!   ------------------------------------------------------------------------
    ...
    IF (ASSOCIATED(eip_env)) THEN
      IF(.NOT.(eip_env%ref_count>0))CALL cp__a("eip_environment_types.F",156)
      eip_env%ref_count = eip_env%ref_count-1
...
!   ------------------------------------------------------------------------
    ...
    IF(.NOT.(ASSOCIATED(eip_env)))CALL cp__a("eip_environment_types.F",265)
    IF(.NOT.(eip_env%ref_count>0))CALL cp__a("eip_environment_types.F",266)
...
!   ------------------------------------------------------------------------
    ...
    IF(.NOT.(ASSOCIATED(eip_env)))CALL cp__a("eip_environment_types.F",379)
    IF(.NOT.(eip_env%ref_count>0))CALL cp__a("eip_environment_types.F",380)
...
!   ------------------------------------------------------------------------
    ...
    IF(.NOT.(ASSOCIATED(eip_env)))CALL cp__a("eip_environment_types.F",466)
