# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/lri_shg_integrals.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/lri_shg_integrals.F"
!-----------------------------------------------------------------------------!
...
# 28 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/lri_shg_integrals.F" 2
                            ...
                            DO jpgfb = 1, npgfb(jset)
                               ...
                               DO kpgfa = 1, npgfca(kset)
                                  ...
                                  DO ids = ids_start, nds + ndev 
                                     ...
                                     ELSE 
                                      CALL cp_abort(cp__l("lri_shg_integrals.F",351),&
                            ...
                            DO jpgfb = 1, npgfb(jset)
                               DO kpgfb = 1, npgfcb(kset)
                                  ...
                                  DO ids = ids_start, nds + ndev 
                                     ...
                                     ELSE 
                                      CALL cp_abort(cp__l("lri_shg_integrals.F",592),&
                                           "SHG integrals not implemented when l quantum number"//&
                                           " of orbital and ri basis larger than 11")
                                     ENDIF
                                  ENDDO
