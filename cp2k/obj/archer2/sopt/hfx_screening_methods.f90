# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/hfx_screening_methods.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/hfx_screening_methods.F"
!-----------------------------------------------------------------------------!
...
# 34 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/hfx_screening_methods.F" 2
...
! *****************************************************************************
  SUBROUTINE update_pmax_mat(pmax_set, map_atom_to_kind_atom, set_offset, atomic_block_offset, &
    ...
    INTEGER :: act_atomic_block_offset, act_set_offset, handle, i, img, &
      jatom, jkind, jset, katom, kind_kind_idx, kkind, kset, mb, mc, nimg, &
      nsetb, nsetc
