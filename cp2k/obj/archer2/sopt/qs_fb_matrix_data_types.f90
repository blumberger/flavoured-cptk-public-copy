# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/qs_fb_matrix_data_types.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/qs_fb_matrix_data_types.F"
!-----------------------------------------------------------------------------!
...
# 18 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/qs_fb_matrix_data_types.F" 2
...
! *****************************************************************************
  SUBROUTINE fb_matrix_data_add(matrix_data, row, col, blk)
    ...
    IF(.NOT.(check_ok))CALL cp__a("qs_fb_matrix_data_types.F",107)
...
! *****************************************************************************
  SUBROUTINE fb_matrix_data_create(matrix_data, nmax, nencode)
    ...
    IF(.NOT.(check_ok))CALL cp__a("qs_fb_matrix_data_types.F",168)
...
! *****************************************************************************
  SUBROUTINE fb_matrix_data_get(matrix_data, row, col, blk_p, found)
    ...
    check_ok = fb_matrix_data_has_data(matrix_data)
    IF(.NOT.(check_ok))CALL cp__a("qs_fb_matrix_data_types.F",208)
    pair_ind = fb_matrix_data_encode_pair(row, col, matrix_data%obj%nencode)
...
! *****************************************************************************
  SUBROUTINE fb_matrix_data_init(matrix_data, nmax, nencode)
    ...
    check_ok = fb_matrix_data_has_data(matrix_data)
    IF(.NOT.(check_ok))CALL cp__a("qs_fb_matrix_data_types.F",252)
...
! *****************************************************************************
  SUBROUTINE fb_matrix_data_release(matrix_data)
    ...
    IF (ASSOCIATED(matrix_data%obj)) THEN
       ...
       IF(.NOT.(check_ok))CALL cp__a("qs_fb_matrix_data_types.F",305)
...
! *****************************************************************************
  SUBROUTINE fb_matrix_data_retain(matrix_data)
    ...
    IF(.NOT.(check_ok))CALL cp__a("qs_fb_matrix_data_types.F",342)
    check_ok = matrix_data%obj%ref_count > 0
    IF(.NOT.(check_ok))CALL cp__a("qs_fb_matrix_data_types.F",344)
    matrix_data%obj%ref_count = matrix_data%obj%ref_count + 1
...
! *****************************************************************************
  SUBROUTINE fb_matrix_data_resize(matrix_data, nmax)
    ...
    check_ok = fb_matrix_data_has_data(matrix_data)
    IF(.NOT.(check_ok))CALL cp__a("qs_fb_matrix_data_types.F",367)
...
! *****************************************************************************
  SUBROUTINE fb_matrix_data_status(matrix_data, nmax, nblks, nencode, blk_sizes)
    ...
    check_ok = fb_matrix_data_has_data(matrix_data)
    IF(.NOT.(check_ok))CALL cp__a("qs_fb_matrix_data_types.F",421)
    ...
    IF (PRESENT(blk_sizes)) THEN
       ...
       IF(.NOT.(check_ok))CALL cp__a("qs_fb_matrix_data_types.F",428)
       blk_sizes(:,:) = 0
       DO ii = 1, matrix_data%obj%nblks
