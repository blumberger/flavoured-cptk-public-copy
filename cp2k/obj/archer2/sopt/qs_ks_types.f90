# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/qs_ks_types.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/qs_ks_types.F"
!-----------------------------------------------------------------------------!
...
# 72 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/qs_ks_types.F" 2
...
SUBROUTINE qs_ks_env_create(ks_env)
    ...
    IF(ASSOCIATED(ks_env)) CALL cp__b("qs_ks_types.F",242,"ks_env already associated")
    ALLOCATE(ks_env)
...
! *****************************************************************************
  SUBROUTINE get_ks_env(ks_env,v_hartree_rspace,&
    ...
    TYPE(admm_dm_type), OPTIONAL, POINTER    :: admm_dm
     ...
     IF(.NOT. ASSOCIATED(ks_env)) CALL cp__b("qs_ks_types.F",436,"get_ks_env: not associated")
     IF(ks_env%ref_count<1) CALL cp__b("qs_ks_types.F",437,"get_ks_env: ks_env%ref_count<1")
     IF(.NOT. ASSOCIATED(ks_env%subsys)) CALL cp__b("qs_ks_types.F",438,"get_ks_env: subsys not associated")
...
! *****************************************************************************
  SUBROUTINE set_ks_env(ks_env,v_hartree_rspace,&
    ...
    TYPE(admm_dm_type), OPTIONAL, POINTER    :: admm_dm
     ...
     IF(.NOT. ASSOCIATED(ks_env)) CALL cp__b("qs_ks_types.F",660,"set_ks_env: not associated")
     IF(ks_env%ref_count<1) CALL cp__b("qs_ks_types.F",661,"set_ks_env: ks_env%ref_count<1")
...
! *****************************************************************************
  SUBROUTINE qs_ks_release(ks_env)
    ...
    IF (ASSOCIATED(ks_env)) THEN
       IF(.NOT.(ks_env%ref_count>0))CALL cp__a("qs_ks_types.F",782)
...
SUBROUTINE qs_ks_retain(ks_env)
  ...
  IF(.NOT.(ASSOCIATED(ks_env)))CALL cp__a("qs_ks_types.F",925)
  IF(.NOT.(ks_env%ref_count>0))CALL cp__a("qs_ks_types.F",926)
  ks_env%ref_count=ks_env%ref_count+1
...
! *****************************************************************************
  SUBROUTINE qs_ks_did_change(ks_env,s_mstruct_changed,rho_changed,&
    ...
    IF(.NOT.(ASSOCIATED(ks_env)))CALL cp__a("qs_ks_types.F",962)
