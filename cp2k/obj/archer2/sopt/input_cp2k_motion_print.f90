# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/input_cp2k_motion_print.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/input_cp2k_motion_print.F"
!-----------------------------------------------------------------------------!
...
# 34 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/input_cp2k_motion_print.F" 2
...
! *****************************************************************************
  SUBROUTINE create_motion_print_section(section)
    ...
    CALL cp_print_key_section_create(print_key,"VELOCITIES",&
         ...
         "(27.21 eV or 4.359e-18 J) as hbar/Ehartree = 2.42e-17 sec = 0.02042 fs. "//&
...
! *****************************************************************************
  SUBROUTINE add_format_keyword(keyword, section, pos, description)
    ...
    IF(.NOT.(ASSOCIATED(section)))CALL cp__a("input_cp2k_motion_print.F",258)
    IF(.NOT.(.NOT.ASSOCIATED(keyword)))CALL cp__a("input_cp2k_motion_print.F",259)
