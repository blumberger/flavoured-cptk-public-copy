# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/qs_fb_atomic_halo_types.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/qs_fb_atomic_halo_types.F"
!-----------------------------------------------------------------------------!
...
# 33 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/qs_fb_atomic_halo_types.F" 2
...
!> \author Lianheng Tong (LT) lianheng.tong@kcl.ac.uk
! *****************************************************************************
  SUBROUTINE fb_atomic_halo_retain(atomic_halo)
    ...
    IF(.NOT.(ASSOCIATED(atomic_halo%obj)))CALL cp__a("qs_fb_atomic_halo_types.F",152)
    IF(.NOT.(atomic_halo%obj%ref_count>0))CALL cp__a("qs_fb_atomic_halo_types.F",153)
...
! *****************************************************************************
  SUBROUTINE fb_atomic_halo_release(atomic_halo)
    ...
    IF (ASSOCIATED(atomic_halo%obj)) THEN
       IF(.NOT.(atomic_halo%obj%ref_count>0))CALL cp__a("qs_fb_atomic_halo_types.F",172)
       atomic_halo%obj%ref_count = atomic_halo%obj%ref_count - 1
...
! *****************************************************************************
  SUBROUTINE fb_atomic_halo_create(atomic_halo)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(atomic_halo%obj)))CALL cp__a("qs_fb_atomic_halo_types.F",257)
...
! *****************************************************************************
  SUBROUTINE fb_atomic_halo_init(atomic_halo)
    ...
    IF(.NOT.(ASSOCIATED(atomic_halo%obj)))CALL cp__a("qs_fb_atomic_halo_types.F",284)
...
! *****************************************************************************
  SUBROUTINE fb_atomic_halo_get(atomic_halo, &
    ...
    IF(.NOT.(ASSOCIATED(atomic_halo%obj)))CALL cp__a("qs_fb_atomic_halo_types.F",332)
...
! *****************************************************************************
  SUBROUTINE fb_atomic_halo_set(atomic_halo, &
    ...
    IF(.NOT.(ASSOCIATED(atomic_halo%obj)))CALL cp__a("qs_fb_atomic_halo_types.F",379)
...
! *****************************************************************************
  SUBROUTINE fb_atomic_halo_sort(atomic_halo)
    ...
    IF(.NOT.(SIZE(atomic_halo%obj%halo_atoms) > 0))CALL cp__a("qs_fb_atomic_halo_types.F",410)
...
! *****************************************************************************
  SUBROUTINE fb_atomic_halo_atom_global2halo(atomic_halo, &
    ...
    IF(.NOT.(atomic_halo%obj%sorted))CALL cp__a("qs_fb_atomic_halo_types.F",446)
...
! *****************************************************************************
  SUBROUTINE fb_atomic_halo_build_halo_atoms(owner_atom, &
    ...
    IF(.NOT.(check_ok))CALL cp__a("qs_fb_atomic_halo_types.F",583)
...
!> \author Lianheng Tong (LT) lianheng.tong@kcl.ac.uk
! *****************************************************************************
  SUBROUTINE fb_atomic_halo_list_retain(atomic_halos)
    TYPE(fb_atomic_halo_list_obj), &
    ...
    IF(.NOT.(ASSOCIATED(atomic_halos%obj)))CALL cp__a("qs_fb_atomic_halo_types.F",633)
    IF(.NOT.(atomic_halos%obj%ref_count>0))CALL cp__a("qs_fb_atomic_halo_types.F",634)
...
! *****************************************************************************
  SUBROUTINE fb_atomic_halo_list_release(atomic_halos)
    ...
    IF (ASSOCIATED(atomic_halos%obj)) THEN
       IF(.NOT.(atomic_halos%obj%ref_count>0))CALL cp__a("qs_fb_atomic_halo_types.F",655)
       atomic_halos%obj%ref_count = atomic_halos%obj%ref_count - 1
...
! *****************************************************************************
  SUBROUTINE fb_atomic_halo_list_create(atomic_halos)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(atomic_halos%obj)))CALL cp__a("qs_fb_atomic_halo_types.F",745)
...
! *****************************************************************************
  SUBROUTINE fb_atomic_halo_list_init(atomic_halos)
    ...
    IF(.NOT.(ASSOCIATED(atomic_halos%obj)))CALL cp__a("qs_fb_atomic_halo_types.F",771)
...
! *****************************************************************************
  SUBROUTINE fb_atomic_halo_list_get(atomic_halos, nhalos, max_nhalos, halos)
    ...
    IF(.NOT.(ASSOCIATED(atomic_halos%obj)))CALL cp__a("qs_fb_atomic_halo_types.F",805)
...
! *****************************************************************************
  SUBROUTINE fb_atomic_halo_list_set(atomic_halos, nhalos, max_nhalos, halos)
    ...
    IF(.NOT.(ASSOCIATED(atomic_halos%obj)))CALL cp__a("qs_fb_atomic_halo_types.F",836)
