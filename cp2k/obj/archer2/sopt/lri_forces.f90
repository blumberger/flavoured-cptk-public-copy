# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/lri_forces.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/lri_forces.F"
!-----------------------------------------------------------------------------!
...
# 38 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/lri_forces.F" 2
...
! *****************************************************************************
  SUBROUTINE calculate_v_dadr(lri_env,lri_density,pmatrix,atomic_kind_set,&
    ...
    LOGICAL                                  :: found, trans
    REAL(KIND=dp), DIMENSION(3)              :: dcharge, dlambda, force_a, &
                                                force_b, nsdssn, nsdsst, &
                                                nsdt, rab
