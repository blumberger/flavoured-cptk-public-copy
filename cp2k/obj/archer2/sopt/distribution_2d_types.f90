# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/distribution_2d_types.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/distribution_2d_types.F"
!-----------------------------------------------------------------------------!
...
# 25 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/distribution_2d_types.F" 2
...
SUBROUTINE distribution_2d_create(distribution_2d, blacs_env,&
   ...
   IF(.NOT.(ASSOCIATED(blacs_env)))CALL cp__a("distribution_2d_types.F",126)
   IF(.NOT.(.NOT.ASSOCIATED(distribution_2d)))CALL cp__a("distribution_2d_types.F",127)
   ...
   IF(PRESENT(n_col_distribution)) THEN
      IF (ASSOCIATED(distribution_2d%col_distribution)) THEN
         IF(n_col_distribution>distribution_2d%n_col_distribution)&
            CALL cp__b("distribution_2d_types.F",148,"n_col_distribution<=distribution_2d%n_col_distribution")
   ...
   IF(PRESENT(n_row_distribution)) THEN
      IF (ASSOCIATED(distribution_2d%row_distribution)) THEN
         IF(n_row_distribution>distribution_2d%n_row_distribution)&
            CALL cp__b("distribution_2d_types.F",161,"n_row_distribution<=distribution_2d%n_row_distribution")
   ...
   IF (.NOT.ASSOCIATED(distribution_2d%local_rows)) THEN
      IF(.NOT.(PRESENT(n_local_rows)))CALL cp__a("distribution_2d_types.F",170)
   ...
   IF (PRESENT(n_local_rows)) THEN
      IF(SIZE(distribution_2d%n_local_rows)/=SIZE(n_local_rows))&
         CALL cp__b("distribution_2d_types.F",180,"SIZE(distribution_2d%n_local_rows)==SIZE(n_local_rows)")
      DO i=1,SIZE(distribution_2d%n_local_rows)
         IF(SIZE(distribution_2d%local_rows(i)%array)<n_local_rows(i))&
            CALL cp__b("distribution_2d_types.F",183,"SIZE(distribution_2d%local_rows(i)%array)>=n_local_rows(i)")
   ...
   IF (.NOT.ASSOCIATED(distribution_2d%local_cols)) THEN
      IF(.NOT.(PRESENT(n_local_cols)))CALL cp__a("distribution_2d_types.F",196)
   ...
   IF (PRESENT(n_local_cols)) THEN
      IF(SIZE(distribution_2d%n_local_cols)/=SIZE(n_local_cols))&
         CALL cp__b("distribution_2d_types.F",206,"SIZE(distribution_2d%n_local_cols)==SIZE(n_local_cols)")
      DO i=1,SIZE(distribution_2d%n_local_cols)
         IF(SIZE(distribution_2d%local_cols(i)%array)<n_local_cols(i))&
            CALL cp__b("distribution_2d_types.F",209,"SIZE(distribution_2d%local_cols(i)%array)>=n_local_cols(i)")
...
SUBROUTINE distribution_2d_retain(distribution_2d)
  ...
  IF(.NOT.(ASSOCIATED(distribution_2d)))CALL cp__a("distribution_2d_types.F",235)
  IF(.NOT.(distribution_2d%ref_count>0))CALL cp__a("distribution_2d_types.F",236)
...
SUBROUTINE distribution_2d_release(distribution_2d)
   ...
   IF (ASSOCIATED(distribution_2d)) THEN
      IF(.NOT.(distribution_2d%ref_count>0))CALL cp__a("distribution_2d_types.F",253)
      distribution_2d%ref_count=distribution_2d%ref_count-1
...
SUBROUTINE distribution_2d_get(distribution_2d, row_distribution, &
  ...
  IF(.NOT.(ASSOCIATED(distribution_2d)))CALL cp__a("distribution_2d_types.F",527)
  IF(.NOT.(distribution_2d%ref_count>0))CALL cp__a("distribution_2d_types.F",528)
     ...
     IF (.NOT.ASSOCIATED(distribution_2d%flat_local_rows)) THEN
        ...
        DO iblock_atomic=1,SIZE(distribution_2d%flat_local_rows)
           ...
           DO ikind=1,SIZE(distribution_2d%local_rows)
              ...
              END IF
           END DO
           IF(.NOT.(ikind_min>0))CALL cp__a("distribution_2d_types.F",554)
     ...
     IF (.NOT.ASSOCIATED(distribution_2d%flat_local_cols)) THEN
        ...
        DO iblock_atomic=1,SIZE(distribution_2d%flat_local_cols)
           ...
           DO ikind=1,SIZE(distribution_2d%local_cols)
              ...
              END IF
           END DO
           IF(.NOT.(ikind_min>0))CALL cp__a("distribution_2d_types.F",580)
