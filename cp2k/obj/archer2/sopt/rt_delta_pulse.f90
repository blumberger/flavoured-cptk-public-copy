# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/emd/rt_delta_pulse.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/emd/rt_delta_pulse.F"
!-----------------------------------------------------------------------------!
...
# 57 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/emd/rt_delta_pulse.F" 2
...
!remove later
    ...
    CALL cp_dbcsr_filter(S_inv,rtp%filter_eps)
    CALL cp_fm_release(S_inv_fm)
!**************************************************************
