# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/dm_ls_scf_qs.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/dm_ls_scf_qs.F"
!-----------------------------------------------------------------------------!
...
# 83 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/dm_ls_scf_qs.F" 2
...
! *****************************************************************************
  SUBROUTINE matrix_ls_create(matrix_ls,matrix_qs,ls_mstruct)
    ...
    CASE DEFAULT
       CALL cp__b("dm_ls_scf_qs.F",225," BUG cluster option")
    END SELECT
...
! *****************************************************************************
  SUBROUTINE matrix_ls_to_qs(matrix_qs,matrix_ls,ls_mstruct,covariant)
    ...
    CASE DEFAULT
       CALL cp__b("dm_ls_scf_qs.F",370,"BUG")
    END SELECT
  ...
  SUBROUTINE ls_scf_dm_to_ks(qs_env,ls_scf_env,energy_new,iscf)
    ...
    IF(ls_scf_env%do_rho_mixing) THEN
      IF(ls_scf_env%density_mixing_method .EQ. direct_mixing_nr)&
         CALL cp__b("dm_ls_scf_qs.F",581,"Direct P mixing not implemented in linear scaling SCF. ")
