# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/dbcsr/base/dbcsr_array_sort_s.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/dbcsr/base/dbcsr_array_sort_s.F"
!-----------------------------------------------------------------------------!
...
MODULE dbcsr_array_sort_s
  ...
  CHARACTER(len=*), PARAMETER, PRIVATE :: moduleN = 'dbcsr_array_sort_s'
...
! ARGS:
!  USE = "USE kinds, ONLY: real_4"
!  defines = 
!    "#define CP_R_LESS_Q(el1,el2) ( el1 < el2 )
!     "
!  lessQ = "CP_R_LESS_Q"
!  nametype1 = "s"
!  type1 = "real(kind=real_4)"


END MODULE dbcsr_array_sort_s
