# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/input_cp2k_global.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/input_cp2k_global.F"
!-----------------------------------------------------------------------------!
...
MODULE input_cp2k_global
  ...
  USE cp_dbcsr_interface,              ONLY: &
       ...
       mm_driver_auto, mm_driver_blas, mm_driver_matmul, mm_driver_smm, &
       mm_driver_xsmm, mm_name_auto, mm_name_blas, mm_name_matmul, &
...
# 61 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/input_cp2k_global.F" 2
...
! *****************************************************************************
  SUBROUTINE create_global_section(section)
    ...
    NULLIFY(print_key)
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_global.F",87)
...
! *****************************************************************************
  SUBROUTINE create_dbcsr_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_global.F",506)
    ...
    CALL keyword_create(keyword, name="mm_driver",&
         ...
         enum_c_vals=s2a(mm_name_auto, mm_name_blas,mm_name_matmul,mm_name_smm,&
                         mm_name_xsmm),&
...
! *****************************************************************************
  SUBROUTINE create_fm_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_global.F",713)
