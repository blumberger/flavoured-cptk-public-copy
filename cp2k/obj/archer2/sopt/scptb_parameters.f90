# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/scptb_parameters.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/scptb_parameters.F"
!-----------------------------------------------------------------------------!
...
# 28 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/scptb_parameters.F" 2
...
! *****************************************************************************
  SUBROUTINE scptb_default_parameter ( param)
    ...
    CASE DEFAULT
       CALL cp__b("scptb_parameters.F",57,"")
    CASE ("XX")
       param%defined          = .TRUE.
    CASE ("H")
       !Hydrogen
