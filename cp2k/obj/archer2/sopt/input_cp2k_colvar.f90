# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/input_cp2k_colvar.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/input_cp2k_colvar.F"
!-----------------------------------------------------------------------------!
...
# 41 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/input_cp2k_colvar.F" 2
...
! *****************************************************************************
  RECURSIVE SUBROUTINE create_colvar_section(section,skip_recursive_colvar)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_colvar.F",72)
...
! *****************************************************************************
  SUBROUTINE create_clv_info_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_colvar.F",114)
    NULLIFY( keyword)
...
! *****************************************************************************
  RECURSIVE SUBROUTINE create_colvar_var_section(subsection, section, skip_recursive_colvar)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(subsection)))CALL cp__a("input_cp2k_colvar.F",146)
    IF(.NOT.(ASSOCIATED(section)))CALL cp__a("input_cp2k_colvar.F",147)
...
! *****************************************************************************
  SUBROUTINE create_colvar_coord_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_colvar.F",259)
...
! *****************************************************************************
  SUBROUTINE create_colvar_cond_dist_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_colvar.F",392)
...
! *****************************************************************************
  SUBROUTINE create_colvar_pop_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_colvar.F",498)
...
! *****************************************************************************
  SUBROUTINE create_colvar_gyr_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_colvar.F",598)
...
! *****************************************************************************
  SUBROUTINE create_colvar_dfunct_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_colvar.F",642)
...
! *****************************************************************************
  SUBROUTINE create_colvar_torsion_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_colvar.F",697)
...
! *****************************************************************************
  SUBROUTINE create_colvar_rot_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_colvar.F",734)
...
! *****************************************************************************
  SUBROUTINE create_colvar_angle_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_colvar.F",796)
...
! *****************************************************************************
  SUBROUTINE create_colvar_dist_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_colvar.F",832)
...
! *****************************************************************************
  SUBROUTINE create_colvar_xyz_d_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_colvar.F",876)
...
! *****************************************************************************
  SUBROUTINE create_colvar_xyz_od_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_colvar.F",940)
...
! *****************************************************************************
  SUBROUTINE create_colvar_u_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_colvar.F",1006)
...
! *****************************************************************************
  SUBROUTINE create_colvar_d_pl_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_colvar.F",1088)
...
! *****************************************************************************
  SUBROUTINE create_colvar_a_pl_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_colvar.F",1142)
...
! *****************************************************************************
  SUBROUTINE create_point_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_colvar.F",1203)
...
! *****************************************************************************
  SUBROUTINE create_colvar_qparm_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_colvar.F",1261)
...
! *****************************************************************************
  SUBROUTINE create_colvar_hydronium_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_colvar.F",1327)
...
! *****************************************************************************
  SUBROUTINE create_colvar_rmsd_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_colvar.F",1454)
...
! *****************************************************************************
  SUBROUTINE create_colvar_rpath_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_colvar.F",1526)
...
! *****************************************************************************
  SUBROUTINE create_colvar_dpath_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_colvar.F",1549)
...
! *****************************************************************************
  SUBROUTINE create_colvar_comb_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_colvar.F",1720)
...
! *****************************************************************************
  SUBROUTINE create_coord_section_cv(section,name)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_colvar.F",1800)
...
! *****************************************************************************
  SUBROUTINE create_colvar_wc_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_colvar.F",1828)
...
! *****************************************************************************
  SUBROUTINE create_colvar_hbp_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_colvar.F",1873)
...
! *****************************************************************************
  SUBROUTINE create_colvar_ring_puckering_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_colvar.F",1933)
