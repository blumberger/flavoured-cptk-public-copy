# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/pair_potential_util.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/pair_potential_util.F"
!-----------------------------------------------------------------------------!
...
# 25 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/pair_potential_util.F" 2
  ...
  FUNCTION ener_pot(pot, r, energy_cutoff) RESULT(value)
    ...
    DO j = 1, SIZE(pot%type)
       ...
       ELSE IF (pot%type(j)==gp_type) THEN
          ...
          IF (EvalErrType > 0) &
               CALL cp__b("pair_potential_util.F",149,"Error evaluating generic potential energy function")
       ELSE
          lvalue = 0.0_dp
       END IF
       value = value + lvalue
