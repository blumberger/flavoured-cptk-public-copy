# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/lri_environment_types.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/lri_environment_types.F"
!-----------------------------------------------------------------------------!
...
# 32 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/lri_environment_types.F" 2
...
! *****************************************************************************
  SUBROUTINE deallocate_lri_ints (lri_ints)
    ...
    IF(.NOT.(ASSOCIATED(lri_ints)))CALL cp__a("lri_environment_types.F",868)
...
! *****************************************************************************
  SUBROUTINE deallocate_lri_ints_rho (lri_ints_rho)
    ...
    IF(.NOT.(ASSOCIATED(lri_ints_rho)))CALL cp__a("lri_environment_types.F",920)
  ...
  SUBROUTINE deallocate_lri_rhos(lri_rhos)
    ...
    IF(ASSOCIATED(lri_rhos)) THEN
      ...
      DO i=1,SIZE(lri_rhos)
         ...
         IF(.NOT.(ASSOCIATED(lri_rho)))CALL cp__a("lri_environment_types.F",970)
         nkind = lri_rho%nkind
