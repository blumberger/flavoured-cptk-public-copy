# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/dbcsr/base/dbcsr_array_sort_i8.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/dbcsr/base/dbcsr_array_sort_i8.F"
!-----------------------------------------------------------------------------!
...
MODULE dbcsr_array_sort_i8
  ...
  CHARACTER(len=*), PARAMETER, PRIVATE :: moduleN = 'dbcsr_array_sort_i8'
...
END MODULE dbcsr_array_sort_i8
