# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/pw_env_types.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/pw_env_types.F"
!-----------------------------------------------------------------------------!
...
# 35 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/pw_env_types.F" 2
...
SUBROUTINE pw_env_get(pw_env, pw_pools, cube_info, gridlevel_info,&
  ...
  IF(.NOT.(ASSOCIATED(pw_env)))CALL cp__a("pw_env_types.F",143)
  IF(.NOT.(pw_env%ref_count>0))CALL cp__a("pw_env_types.F",144)
...
SUBROUTINE pw_env_retain(pw_env)
  ...
  IF(.NOT.(ASSOCIATED(pw_env)))CALL cp__a("pw_env_types.F",180)
  IF(.NOT.(pw_env%ref_count>0))CALL cp__a("pw_env_types.F",181)
...
SUBROUTINE pw_env_release(pw_env, kg)
  ...
  IF (ASSOCIATED(pw_env)) THEN
     IF(.NOT.(pw_env%ref_count>0))CALL cp__a("pw_env_types.F",206)
     pw_env%ref_count=pw_env%ref_count-1
