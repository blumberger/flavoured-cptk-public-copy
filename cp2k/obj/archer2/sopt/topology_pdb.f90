# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/topology_pdb.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/topology_pdb.F"
!-----------------------------------------------------------------------------!
...
# 81 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/topology_pdb.F" 2
...
! *****************************************************************************
  SUBROUTINE write_coordinate_pdb (file_unit,topology,subsys_section)
    ...
    IF(i>1)&
      CALL cp__b("topology_pdb.F",314,"Either only CHARGE_OCCUP, CHARGE_BETA, or CHARGE_EXTENDED can be selected")
       ...
       IF (ASSOCIATED(atom_info%atm_charge)) THEN
          IF(ANY((/charge_occup,charge_beta,charge_extended/)).AND.&
            (atom_info%atm_charge(i) == -HUGE(0.0_dp)))&
               CALL cp__b("topology_pdb.F",374,"No atomic charges found yet (after the topology setup)")
