# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/splines_types.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/splines_types.F"
!-----------------------------------------------------------------------------!
...
# 17 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/splines_types.F" 2
...
! *****************************************************************************
  SUBROUTINE spline_env_release(spline_env)
    ...
    IF (ASSOCIATED(spline_env)) THEN
       IF(.NOT.(spline_env%ref_count>0))CALL cp__a("splines_types.F",98)
...
! *****************************************************************************
  SUBROUTINE spline_data_release (spline_data)
    ...
    IF (ASSOCIATED(spline_data)) THEN
       IF(.NOT.(spline_data%ref_count>0))CALL cp__a("splines_types.F",125)
...
! *****************************************************************************
  SUBROUTINE spline_data_retain(spline_data)
    ...
    IF(.NOT.(ASSOCIATED(spline_data)))CALL cp__a("splines_types.F",178)
    IF(.NOT.(spline_data%ref_count>0))CALL cp__a("splines_types.F",179)
    spline_data%ref_count=spline_data%ref_count+1
...
! *****************************************************************************
  SUBROUTINE spline_data_p_retain(spl_p)
    ...
    IF(.NOT.(ASSOCIATED(spl_p)))CALL cp__a("splines_types.F",197)
    DO i = 1, SIZE(spl_p)
...
!> \author unknown
! *****************************************************************************
  SUBROUTINE spline_env_retain(spline_env)
    TYPE(spline_environment_type), POINTER   :: spline_env

    CHARACTER(len=*), PARAMETER :: routineN = 'spline_env_retain', &
      routineP = moduleN//':'//routineN

    IF(.NOT.(ASSOCIATED(spline_env)))CALL cp__a("splines_types.F",216)
    IF(.NOT.(spline_env%ref_count>0))CALL cp__a("splines_types.F",217)
    spline_env%ref_count=spline_env%ref_count+1
...
! *****************************************************************************
  SUBROUTINE spline_data_p_copy ( spl_p_source, spl_p_dest)
    ...
    IF(.NOT.(ASSOCIATED(spl_p_source)))CALL cp__a("splines_types.F",288)
    ...
    ELSE
       ...
       IF(.NOT.(nsizes==nsized))CALL cp__a("splines_types.F",297)
       DO i = 1, nsizes
...
! *****************************************************************************
  SUBROUTINE spline_data_copy ( spline_data_source, spline_data_dest)
    ...
    IF(.NOT.(ASSOCIATED(spline_data_source)))CALL cp__a("splines_types.F",320)
...
! *****************************************************************************
  SUBROUTINE spline_factor_create (spline_factor)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(spline_factor)))CALL cp__a("splines_types.F",396)
...
! *****************************************************************************
  SUBROUTINE spline_factor_copy (spline_factor_source,spline_factor_dest)
    ...
    IF (ASSOCIATED(spline_factor_source)) THEN
       ...
       IF(.NOT.(isize==jsize))CALL cp__a("splines_types.F",428)
       IF(.NOT.(isize==ksize))CALL cp__a("splines_types.F",429)
