# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/mscfg_types.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/mscfg_types.F"
!-----------------------------------------------------------------------------!
...
# 34 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/mscfg_types.F" 2
...
! *****************************************************************************
  SUBROUTINE get_matrix_from_submatrices(mscfg_env, matrix_out, iset)
    ...
    IF(.NOT.(iset.le.mscfg_max_moset_size))CALL cp__a("mscfg_types.F",158)
    ...
    DO ifrag=1, mscfg_env%nfrags
       ...
       IF(.NOT.(iset.le.mscfg_env%nmosets_of_frag(ifrag)))CALL cp__a("mscfg_types.F",175)
    ...
    IF(.NOT.(offset(1).eq.matrix_size(1)))CALL cp__a("mscfg_types.F",194)
    IF(.NOT.(offset(2).eq.matrix_size(2)))CALL cp__a("mscfg_types.F",195)
...
! obtain distribution of the submatrix
    ...
    DO WHILE (cp_dbcsr_iterator_blocks_left(iter))
       ...
       IF(.NOT.(ASSOCIATED(p_new_block)))CALL cp__a("mscfg_types.F",343)
       IF(.NOT.(SIZE(p_new_block,1).eq.SIZE(data_p,1)))CALL cp__a("mscfg_types.F",344)
       IF(.NOT.(SIZE(p_new_block,2).eq.SIZE(data_p,2)))CALL cp__a("mscfg_types.F",345)
