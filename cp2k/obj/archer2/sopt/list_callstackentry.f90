# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/common/list_callstackentry.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/common/list_callstackentry.F"
!-----------------------------------------------------------------------------!
...
MODULE list_callstackentry
  ...
  USE timings_base_type,               ONLY: callstack_entry_type
...
# 28 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/common/list_callstackentry.F" 2

  IMPLICIT NONE
  PRIVATE

  LOGICAL, PRIVATE, PARAMETER :: debug_this_module=.FALSE.
  CHARACTER(len=*), PARAMETER, PRIVATE :: moduleN = 'list_callstackentry'
  ...
  PUBLIC :: list_callstackentry_init
  PUBLIC :: list_callstackentry_push
  PUBLIC :: list_callstackentry_pop
  PUBLIC :: list_callstackentry_peek
  PUBLIC :: list_callstackentry_insert
  PUBLIC :: list_callstackentry_set
  PUBLIC :: list_callstackentry_get
  PUBLIC :: list_callstackentry_del
  PUBLIC :: list_callstackentry_clear
  PUBLIC :: list_callstackentry_size
  PUBLIC :: list_callstackentry_destroy
  PUBLIC :: list_callstackentry_isready
...
!>        For deallocation call list_callstackentry_destroy.
!> \param list ...
...
SUBROUTINE list_callstackentry_init(list, initial_capacity)
    ...
    IF(initial_capacity_ < 0) & 
      CALL cp__b("common/list_callstackentry.F",111,"list_callstackentry_create: initial_capacity < 0")

    IF(ASSOCIATED(list%arr)) &
       CALL cp__b("common/list_callstackentry.F",114,"list_callstackentry_create: list is already initialized.")

    ALLOCATE(list%arr(initial_capacity_), stat=stat)
    IF (stat/=0)&
       CALL cp__b("common/list_callstackentry.F",118,"list_callstackentry_init: allocation failed")
...
SUBROUTINE list_callstackentry_destroy(list)
    ...
    IF(.NOT. ASSOCIATED(list%arr)) &
       CALL cp__b("common/list_callstackentry.F",139,"list_callstackentry_destroy: list is not initialized.")
...
SUBROUTINE list_callstackentry_set(list, value, pos)
    ...
    IF(.NOT. ASSOCIATED(list%arr)) &
       CALL cp__b("common/list_callstackentry.F",167,"list_callstackentry_set: list is not initialized.")
    IF(pos < 1)&
       CALL cp__b("common/list_callstackentry.F",169,"list_callstackentry_set: pos < 1")
    IF(pos > list%size)&
       CALL cp__b("common/list_callstackentry.F",171,"list_callstackentry_set: pos > size")
...
SUBROUTINE list_callstackentry_push(list, value)
    ...
    IF(.NOT. ASSOCIATED(list%arr)) &
       CALL cp__b("common/list_callstackentry.F",192,"list_callstackentry_push: list is not initialized.")
    ...
    IF (stat/=0)&
       CALL cp__b("common/list_callstackentry.F",199,"list_callstackentry_push: allocation failed")
...
SUBROUTINE list_callstackentry_insert(list, value, pos)
    ...
    IF(.NOT. ASSOCIATED(list%arr)) &
       CALL cp__b("common/list_callstackentry.F",223,"list_callstackentry_insert: list is not initialized.")
    IF(pos < 1)&
       CALL cp__b("common/list_callstackentry.F",225,"list_callstackentry_insert: pos < 1")
    IF(pos > list%size+1)&
       CALL cp__b("common/list_callstackentry.F",227,"list_callstackentry_insert: pos > size+1")
    ...
    ALLOCATE(list%arr(pos)%p, stat=stat)
     IF (stat/=0)&
        CALL cp__b("common/list_callstackentry.F",239,"list_callstackentry_insert: allocation failed.")
    list%arr(pos)%p%value = value
...
FUNCTION list_callstackentry_peek(list) RESULT(value)
    ...
    IF(.NOT. ASSOCIATED(list%arr)) &
       CALL cp__b("common/list_callstackentry.F",259,"list_callstackentry_peek: list is not initialized.")
    IF(list%size < 1) &
       CALL cp__b("common/list_callstackentry.F",261,"list_callstackentry_peek: list is empty.")
...
FUNCTION list_callstackentry_pop(list) RESULT(value)
    ...
    IF(.NOT. ASSOCIATED(list%arr)) &
       CALL cp__b("common/list_callstackentry.F",285,"list_callstackentry_pop: list is not initialized.")
    IF(list%size < 1) &
       CALL cp__b("common/list_callstackentry.F",287,"list_callstackentry_pop: list is empty.")
...
SUBROUTINE list_callstackentry_clear(list)
    ...
    IF(.NOT. ASSOCIATED(list%arr)) &
       CALL cp__b("common/list_callstackentry.F",310,"list_callstackentry_clear: list is not initialized.")
...
FUNCTION list_callstackentry_get(list, pos) RESULT(value)
    ...
    IF(.NOT. ASSOCIATED(list%arr)) &
       CALL cp__b("common/list_callstackentry.F",336,"list_callstackentry_get: list is not initialized.")
    IF(pos < 1)&
       CALL cp__b("common/list_callstackentry.F",338,"list_callstackentry_get: pos < 1")
    IF(pos > list%size)&
       CALL cp__b("common/list_callstackentry.F",340,"list_callstackentry_get: pos > size")
...
SUBROUTINE list_callstackentry_del(list, pos)
    ...
    IF(.NOT. ASSOCIATED(list%arr)) &
       CALL cp__b("common/list_callstackentry.F",363,"list_callstackentry_del: list is not initialized.")
    IF(pos < 1)&
       CALL cp__b("common/list_callstackentry.F",365,"list_callstackentry_det: pos < 1")
    IF(pos > list%size)&
       CALL cp__b("common/list_callstackentry.F",367,"list_callstackentry_det: pos > size")
...
FUNCTION list_callstackentry_size(list) RESULT(size)
    ...
    IF(.NOT. ASSOCIATED(list%arr)) &
       CALL cp__b("common/list_callstackentry.F",392,"list_callstackentry_size: list is not initialized.")
...
SUBROUTINE change_capacity(list, new_capacity)
   ...
   IF(new_cap < 0) &
      CALL cp__b("common/list_callstackentry.F",417,"list_callstackentry_change_capacity: new_capacity < 0")
   IF(new_cap < list%size) &
      CALL cp__b("common/list_callstackentry.F",419,"list_callstackentry_change_capacity: new_capacity < size")
   IF(new_cap > HUGE(i)) THEN
      IF(SIZE(list%arr) == HUGE(i)) &
      CALL cp__b("common/list_callstackentry.F",422,"list_callstackentry_change_capacity: list has reached integer limit.")
   ...
   IF (stat/=0)&
      CALL cp__b("common/list_callstackentry.F",429,"list_callstackentry_change_capacity: allocation failed")

   DO i=1, list%size
      ALLOCATE(list%arr(i)%p, stat=stat)
      IF (stat/=0)&
         CALL cp__b("common/list_callstackentry.F",434,"list_callstackentry_change_capacity: allocation failed")
