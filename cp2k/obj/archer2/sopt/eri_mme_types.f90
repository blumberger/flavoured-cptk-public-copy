# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/eri_mme_types.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/eri_mme_types.F"
!-----------------------------------------------------------------------------!
...
# 35 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/eri_mme_types.F" 2
...
! *****************************************************************************
  SUBROUTINE create_eri_mme_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("eri_mme_types.F",95)
...
! *****************************************************************************
  SUBROUTINE eri_mme_init_read_input(mme_section, param)
    ...
    IF(param%n_minimax .GT. n_minimax_max)&
       CALL cp__b("eri_mme_types.F",222,"The maximum allowed number of minimax points N_MINIMAX is "//TRIM(string))
