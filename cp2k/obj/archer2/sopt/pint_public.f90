# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/motion/pint_public.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/motion/pint_public.F"
!-----------------------------------------------------------------------------!
...
# 20 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/motion/pint_public.F" 2
...
!> \author Lukasz Walewski
! *****************************************************************************
  FUNCTION pint_com_pos(pint_env) RESULT(com_r)
    ...
    IF(.NOT.(ASSOCIATED(pint_env)))CALL cp__a("motion/pint_public.F",54)
...
!> \author Lukasz Walewski
! *****************************************************************************
  FUNCTION pint_cog_pos(pint_env) RESULT(cntrd_r)
    ...
    IF(.NOT.(ASSOCIATED(pint_env)))CALL cp__a("motion/pint_public.F",92)
...
! *****************************************************************************
  SUBROUTINE pint_levy_walk( x0, n, v, x, rng_gaussian)
    ...
    CHARACTER(len=*), PARAMETER :: routineN = 'pint_levy_walk', &
      routineP = moduleN//':'//routineN
