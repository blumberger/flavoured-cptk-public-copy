# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/fp_methods.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/fp_methods.F"
!-----------------------------------------------------------------------------!
...
# 34 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/fp_methods.F" 2
...
! *****************************************************************************
  SUBROUTINE fp_eval(fp_env, subsys, cell)
    ...
    IF(.NOT.(ASSOCIATED(fp_env)))CALL cp__a("fp_methods.F",75)
    IF(.NOT.(fp_env%use_fp))CALL cp__a("fp_methods.F",76)
    IF(.NOT.(ASSOCIATED(subsys)))CALL cp__a("fp_methods.F",77)
    ...
    IF(.NOT.(i<=maxfac))CALL cp__a("fp_methods.F",147)
