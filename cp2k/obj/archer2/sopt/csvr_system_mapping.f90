# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/motion/thermostat/csvr_system_mapping.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/motion/thermostat/csvr_system_mapping.F"
!-----------------------------------------------------------------------------!
...
# 33 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/motion/thermostat/csvr_system_mapping.F" 2
...
! *****************************************************************************
  SUBROUTINE csvr_to_barostat_mapping ( simpar, csvr)
    ...
    CASE  DEFAULT
       CALL cp__b("motion/thermostat/csvr_system_mapping.F",65,'Never reach this point!')
...
! *****************************************************************************
  SUBROUTINE csvr_to_particle_mapping ( thermostat_info, simpar, local_molecules,&
    ...
    SELECT CASE ( simpar % ensemble )
    CASE DEFAULT
       CALL cp__b("motion/thermostat/csvr_system_mapping.F",133,'Unknown ensemble!')
    CASE ( nve_ensemble, isokin_ensemble, npe_f_ensemble, npe_i_ensemble, nph_uniaxial_ensemble,&
       ...
       CALL cp__b("motion/thermostat/csvr_system_mapping.F",136,'Never reach this point!')
    CASE ( nvt_ensemble, npt_i_ensemble, npt_f_ensemble)
       ...
       IF ( (sum_of_thermostats == 1).AND.(map_info%dis_type /= do_thermo_no_communication)) THEN
          ...
          IF ( fac == 0.0_dp ) THEN
             CALL cp__b("motion/thermostat/csvr_system_mapping.F",161,'Zero degrees of freedom. Nothing to thermalize!')
          END IF
...
! *****************************************************************************
  SUBROUTINE csvr_to_shell_mapping( thermostat_info, simpar, local_molecules,&
    ...
    SELECT CASE ( simpar % ensemble )
    CASE DEFAULT
       CALL cp__b("motion/thermostat/csvr_system_mapping.F",281,'Unknown ensemble!')
    CASE ( isokin_ensemble, nph_uniaxial_ensemble,&
           nph_uniaxial_damped_ensemble, reftraj_ensemble, langevin_ensemble )
       CALL cp__b("motion/thermostat/csvr_system_mapping.F",284,'Never reach this point!')
