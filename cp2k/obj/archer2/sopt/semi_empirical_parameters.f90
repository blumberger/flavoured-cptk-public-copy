# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/semi_empirical_parameters.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/semi_empirical_parameters.F"
!-----------------------------------------------------------------------------!
...
# 59 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/semi_empirical_parameters.F" 2
...
! *****************************************************************************
  SUBROUTINE mndo_default_parameter ( sep, z, itype)
    ...
    SELECT CASE (z)
    CASE DEFAULT
       CALL cp__b("semi_empirical_parameters.F",122,"invalid atomic number")
    CASE (0)
       sep%defined          = .TRUE.
    CASE (1)
       !Hydrogen
...
! *****************************************************************************
  SUBROUTINE pnnl_default_parameter ( sep, z)
    ...
    SELECT CASE (z)
    CASE DEFAULT
       CALL cp__b("semi_empirical_parameters.F",720,"invalid atomic number")
    CASE (0)
       sep%defined          = .TRUE.
    CASE (1)
       !Hydrogen
...
! *****************************************************************************
  SUBROUTINE am1_default_parameter ( sep, z)
    ...
    SELECT CASE (z)
    CASE DEFAULT
       CALL cp__b("semi_empirical_parameters.F",1045,"invalid atomic number")
    CASE (0)
       sep%defined = .TRUE.
    CASE (1)
       !Hydrogen
...
! *****************************************************************************
  SUBROUTINE rm1_default_parameter ( sep, z)
    ...
    SELECT CASE (z)
      CASE DEFAULT
        CALL cp__b("semi_empirical_parameters.F",1527,"invalid atomic number")
      CASE (0)
        sep%defined = .TRUE.
      CASE (1)
         !Hydrogen
...
! *****************************************************************************
  SUBROUTINE pm3_default_parameter ( sep, z)
    ...
    SELECT CASE (z)
    CASE DEFAULT
       CALL cp__b("semi_empirical_parameters.F",1738,"invalid atomic number")
    CASE (0)
       sep%defined = .TRUE.
    CASE (1)
       !Hydrogen
...
! *****************************************************************************
  SUBROUTINE pm6_default_parameter ( sep, z)
    ...
    SELECT CASE (z)
    CASE DEFAULT
       CALL cp__b("semi_empirical_parameters.F",2532,"invalid atomic number")
    CASE (0)
       sep%defined = .TRUE.
    CASE(1)
       ! Hydrogen
...
! *****************************************************************************
  SUBROUTINE pdg_default_parameter ( sep, z)
    ...
    SELECT CASE (z)
    CASE DEFAULT
       CALL cp__b("semi_empirical_parameters.F",3889,"invalid atomic number")
    CASE (0)
       sep%defined = .TRUE.
    CASE (1)
       !Hydrogen
