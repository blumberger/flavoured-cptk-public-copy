# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/input_cp2k_neb.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/input_cp2k_neb.F"
!-----------------------------------------------------------------------------!
...
# 43 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/input_cp2k_neb.F" 2
...
! *****************************************************************************
  SUBROUTINE create_band_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_neb.F",70)
...
! *****************************************************************************
  SUBROUTINE create_opt_band_section(section)
    ...
    IF(.NOT.(ASSOCIATED(section)))CALL cp__a("input_cp2k_neb.F",327)
    NULLIFY(keyword, print_key, subsection, subsubsection)
