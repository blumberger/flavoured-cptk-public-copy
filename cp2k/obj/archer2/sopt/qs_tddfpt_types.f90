# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/qs_tddfpt_types.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/qs_tddfpt_types.F"
!-----------------------------------------------------------------------------!
...
# 29 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/qs_tddfpt_types.F" 2
...
! *****************************************************************************
  SUBROUTINE tddfpt_env_allocate(t_env, p_env, qs_env)
    ...
    IF (stat /=0 ) CALL stop_memory(routineN,moduleN,86,&
    ...
    IF (stat /= 0) CALL stop_memory(routineN,moduleN,103,&
