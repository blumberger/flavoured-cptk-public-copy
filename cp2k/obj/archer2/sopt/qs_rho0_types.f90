# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/qs_rho0_types.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/qs_rho0_types.F"
!-----------------------------------------------------------------------------!
...
# 25 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/qs_rho0_types.F" 2
...
! *****************************************************************************
  SUBROUTINE allocate_multipoles(mp_rho,natom,mp_gau,nkind)
    ...
    IF (istat /= 0) CALL stop_memory(routineN,moduleN,115,&
    ...
    IF (istat /= 0) CALL stop_memory(routineN,moduleN,130,&
...
! *****************************************************************************
  SUBROUTINE allocate_rho0_atom_rad(rho0_atom,nr,nchannels)
    ...
    IF (istat /= 0) CALL stop_memory(routineN,moduleN,206,&
                            "vrho0_rad_h",int_size)
...
! *****************************************************************************
  SUBROUTINE allocate_rho0_mpole(rho0)
    ...
    IF (istat /= 0) CALL stop_memory(routineN,moduleN,230,&
                            "rho0_mpole",int_size)
...
!   Allocate g0
    ...
    IF (istat /= 0) CALL stop_memory(routineN,moduleN,272,&
...
! *****************************************************************************
  SUBROUTINE deallocate_rho0_atom(rho0_atom_set)
    ...
    ELSE
      CALL cp_abort(cp__l("qs_rho0_types.F",406),&
...
! *****************************************************************************
  SUBROUTINE deallocate_rho0_mpole(rho0)
    ...
    IF (ASSOCIATED(rho0)) THEN
      ...
      DEALLOCATE (rho0)
    ELSE
      CALL cp_abort(cp__l("qs_rho0_types.F",449),&
...
! *****************************************************************************
  SUBROUTINE get_rho0_mpole(rho0_mpole, g0_h, vg0_h, iat, ikind, lmax_0, l0_ikind,&
    ...
    ELSE
      CALL cp__b("qs_rho0_types.F",534,"The pointer rho0_mpole is not associated")
    END IF
