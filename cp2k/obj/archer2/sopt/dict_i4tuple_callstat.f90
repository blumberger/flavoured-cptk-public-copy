# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/common/dict_i4tuple_callstat.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/common/dict_i4tuple_callstat.F"
!-----------------------------------------------------------------------------!
...
# 32 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/common/dict_i4tuple_callstat.F" 2
...
SUBROUTINE dict_i4tuple_callstat_init(dict, initial_capacity)
    ...
    IF(initial_capacity_ < 1) & 
       CALL cp__b("common/dict_i4tuple_callstat.F",136,"dict_i4tuple_callstat_init: initial_capacity < 1")

    IF(ASSOCIATED(dict%buckets)) &
       CALL cp__b("common/dict_i4tuple_callstat.F",139,"dict_i4tuple_callstat_init: dictionary is already initialized.")
...
SUBROUTINE dict_i4tuple_callstat_destroy(dict)
    ...
    IF(.NOT. ASSOCIATED(dict%buckets)) &
       CALL cp__b("common/dict_i4tuple_callstat.F",181,"dict_i4tuple_callstat_destroy: dictionary is not initialized.")
...
SUBROUTINE dict_i4tuple_callstat_set(dict, key, value)
    TYPE(dict_i4tuple_callstat_type), &
      INTENT(inout)                          :: dict
    INTEGER(kind=int_4), DIMENSION(2), &
      INTENT(in)                             :: key
    ...
    IF(.NOT. ASSOCIATED(dict%buckets)) &
       CALL cp__b("common/dict_i4tuple_callstat.F",217,"dict_i4tuple_callstat_set: dictionary is not initialized.")
...
RECURSIVE SUBROUTINE change_capacity(dict, new_capacity)
    ...
    END IF
    IF(new_cap < 1) &
       CALL cp__b("common/dict_i4tuple_callstat.F",303,"dict_i4tuple_callstat_change_capacity: new_capacity < 1.")
    IF(4*dict%size > 3*new_cap) &
       CALL cp__b("common/dict_i4tuple_callstat.F",305,"dict_i4tuple_callstat_change_capacity: new_capacity too small.")
    ...
    IF(old_size /= dict%size) &
       CALL cp__b("common/dict_i4tuple_callstat.F",324,"dict_i4tuple_callstat_change_capacity: assertion failed")
...
FUNCTION dict_i4tuple_callstat_get(dict, key, default_value) RESULT(value)
    ...
    INTEGER(kind=int_4), DIMENSION(2)        :: key
    TYPE(call_stat_type), INTENT(in), &
      OPTIONAL, POINTER                      :: default_value
    TYPE(call_stat_type), POINTER            :: value
    ...
    IF(.NOT. ASSOCIATED(dict%buckets)) &
       CALL cp__b("common/dict_i4tuple_callstat.F",351,"dict_i4tuple_callstat_get: dictionary is not initialized.")
    ...
    CALL cp__b("common/dict_i4tuple_callstat.F",372,"dict_i4tuple_callstat_get: Key not found in dictionary.")
...
SUBROUTINE dict_i4tuple_callstat_del(dict, key)
    ...
    IF(.NOT. ASSOCIATED(dict%buckets)) &
       CALL cp__b("common/dict_i4tuple_callstat.F",394,"dict_i4tuple_callstat_del: dictionary is not initialized.")
    ...
    CALL cp__b("common/dict_i4tuple_callstat.F",418,"dict_i4tuple_callstat_del: Key not found in dictionary.")
...
FUNCTION dict_i4tuple_callstat_size(dict) RESULT(size)
    ...
    IF(.NOT. ASSOCIATED(dict%buckets)) &
       CALL cp__b("common/dict_i4tuple_callstat.F",435,"dict_i4tuple_callstat_size: dictionary is not initialized.")
...
FUNCTION dict_i4tuple_callstat_haskey(dict, key) RESULT(res)
    ...
    IF(.NOT. ASSOCIATED(dict%buckets)) &
       CALL cp__b("common/dict_i4tuple_callstat.F",460,"dict_i4tuple_callstat_haskey: dictionary is not initialized.")
...
FUNCTION dict_i4tuple_callstat_items(dict) RESULT(items)
    ...
    IF(.NOT. ASSOCIATED(dict%buckets)) &
       CALL cp__b("common/dict_i4tuple_callstat.F",502,"dict_i4tuple_callstat_items: dictionary is not initialized.")
    ...
    IF(j /= dict%size + 1) &
       CALL cp__b("common/dict_i4tuple_callstat.F",517,"dict_i4tuple_callstat_items: assertion failed!")
...
SUBROUTINE dict_i4tuple_callstat_update(dict, from_dict)
    ...
    IF(.NOT. ASSOCIATED(dict%buckets)) &
       CALL cp__b("common/dict_i4tuple_callstat.F",541,"dict_i4tuple_callstat_update: dictionary is not initialized.")
    IF(.NOT. ASSOCIATED(from_dict%buckets)) &
       CALL cp__b("common/dict_i4tuple_callstat.F",543,"dict_i4tuple_callstat_update: from_dict is not initialized.")
