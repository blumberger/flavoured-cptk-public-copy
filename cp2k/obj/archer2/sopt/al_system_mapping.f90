# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/motion/thermostat/al_system_mapping.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/motion/thermostat/al_system_mapping.F"
!-----------------------------------------------------------------------------!
...
# 30 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/motion/thermostat/al_system_mapping.F" 2
...
! *****************************************************************************
  SUBROUTINE al_to_particle_mapping ( thermostat_info, simpar, local_molecules,&
    ...
    CHARACTER(LEN=*), PARAMETER :: routineN = 'al_to_particle_mapping', &
    ...
    CASE DEFAULT
       CALL cp__b("motion/thermostat/al_system_mapping.F",80,'Unknown ensemble!')
    CASE ( nve_ensemble, isokin_ensemble, npe_f_ensemble, npe_i_ensemble, nph_uniaxial_ensemble,&
       ...
       CALL cp__b("motion/thermostat/al_system_mapping.F",83,'Never reach this point!')
    CASE ( nvt_ensemble, npt_i_ensemble, npt_f_ensemble)
       ...
       IF ( (sum_of_thermostats == 1).AND.(map_info%dis_type /= do_thermo_no_communication)) THEN
          ...
          IF ( fac == 0.0_dp ) THEN 
             CALL cp__b("motion/thermostat/al_system_mapping.F",108,'Zero degrees of freedom. Nothing to thermalize!')
          END IF
...
! *****************************************************************************
  SUBROUTINE setup_al_thermostat ( al, thermostat_info, deg_of_freedom,&
    ...
    CHARACTER(LEN=*), PARAMETER :: routineN = 'setup_al_thermostat', &
      routineP = moduleN//':'//routineN
