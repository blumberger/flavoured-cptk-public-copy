# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/input_cp2k_qmmm.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/input_cp2k_qmmm.F"
!-----------------------------------------------------------------------------!
...
MODULE input_cp2k_qmmm
  ...
  USE input_constants,                 ONLY: &
       alpha_imomm_default, charge_scale_factor, do_fm_mom_conserv_buffer, &
       do_fm_mom_conserv_core, do_fm_mom_conserv_equal_a, &
       do_fm_mom_conserv_equal_f, do_fm_mom_conserv_none, &
       do_fm_mom_conserv_qm, do_multipole_section_off, &
       do_multipole_section_on, do_par_atom, do_par_grid, &
       do_qmmm_center_every_step, do_qmmm_center_max_minus_min, &
       do_qmmm_center_never, do_qmmm_center_pbc_aware, &
       do_qmmm_center_setup_only, do_qmmm_coulomb, do_qmmm_gauss, &
       do_qmmm_image_calcmatrix, do_qmmm_image_gpw, do_qmmm_image_iter, &
       do_qmmm_image_mme, do_qmmm_link_gho, do_qmmm_link_imomm, &
       do_qmmm_link_pseudo, do_qmmm_none, do_qmmm_pcharge, do_qmmm_swave, &
       do_qmmm_wall_none, do_qmmm_wall_quadratic, do_qmmm_wall_reflective, &
       gaussian, radius_qmmm_default, spline3_nopbc_interp
...
# 74 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/input_cp2k_qmmm.F" 2
...
! *****************************************************************************
  SUBROUTINE create_qmmm_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_qmmm.F",100)
...
! *****************************************************************************
  SUBROUTINE create_qmmm_mm_kinds(section)
    ...
    NULLIFY(keyword)
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_qmmm.F",290)
...
! *****************************************************************************
  SUBROUTINE create_qmmm_force_mixing_section(section)
    ...
    NULLIFY(keyword)
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_qmmm.F",334)
...
! *****************************************************************************
  SUBROUTINE create_qmmm_qm_kinds(section)
    ...
    NULLIFY(keyword)
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_qmmm.F",570)
...
! *****************************************************************************
  SUBROUTINE create_qmmm_walls_section(section)
    ...
    NULLIFY(keyword)
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_qmmm.F",604)
...
! *****************************************************************************
  SUBROUTINE create_qmmm_image_charge_section (section)
    ...
    NULLIFY(keyword,subsection)
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_qmmm.F",658)
    ...
    CALL keyword_create(keyword, name="IMAGE_MATRIX_METHOD", &
         description="Method for calculating the image matrix. The MME method is "//&
         "much faster than GPW s.t. the overhead of the IC approach compared to "//&
         "standard QM/MM becomes negligible in total computation time. Note that MME "//&
         "is an approximative method that has limited accuracy in the current implementation.",&
         usage="IMAGE_MATRIX_METHOD MME",&
         enum_c_vals=s2a( "GPW","MME"),&
         enum_i_vals=(/ do_qmmm_image_gpw, do_qmmm_image_mme /),&
         enum_desc=s2a("Uses Gaussian Plane Wave method [Golze2013]", &
                       "Uses MiniMax-Ewald method (ERI_MME subsection)"),&
         default_i_val=do_qmmm_image_gpw)
    CALL section_add_keyword(section,keyword)
    CALL keyword_release(keyword)
...
! *****************************************************************************
  SUBROUTINE create_qmmm_periodic_section(section)
    ...
    NULLIFY(keyword, subsection)
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_qmmm.F",754)
...
! *****************************************************************************
  SUBROUTINE create_multipole_qmmm_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_qmmm.F",817)
...
! *****************************************************************************
  SUBROUTINE create_qmmm_forcefield_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_qmmm.F",900)
...
! *****************************************************************************
  SUBROUTINE create_qmmm_ff_nb_section(section)
    ...
    NULLIFY(subsection )
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_qmmm.F",937)
...
! *****************************************************************************
  SUBROUTINE create_qmmm_link_section(section)
    ...
    NULLIFY(keyword, subsection )
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_qmmm.F",975)
...
! *****************************************************************************
  SUBROUTINE create_qmmm_interp_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_qmmm.F",1171)
...
! *****************************************************************************
  SUBROUTINE create_print_qmmm_section(section)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(section)))CALL cp__a("input_cp2k_qmmm.F",1270)
    NULLIFY(keyword, print_key)
