# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/molsym.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/molsym.F"
!-----------------------------------------------------------------------------!
...
# 24 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/molsym.F" 2
...
! *****************************************************************************
  SUBROUTINE release_molsym(sym)
    ...
    IF(.NOT.(ASSOCIATED(sym)))CALL cp__a("molsym.F",149)
...
! *****************************************************************************
  SUBROUTINE addsec(n,a,sym)
    ...
    IF(.NOT.(sym%nsec(n) < maxsec))CALL cp__a("molsym.F",212)
...
! *****************************************************************************
  SUBROUTINE addses(n,a,sym)
    ...
    IF(.NOT.(sym%nses(n) < maxses))CALL cp__a("molsym.F",252)
...
! *****************************************************************************
  SUBROUTINE addsig(a,sym)
    ...
    IF(.NOT.(sym%nsig < maxsig))CALL cp__a("molsym.F",289)
    sym%nsig = sym%nsig + 1
    sym%sig(:,sym%nsig) = d(:)
...
! Find the vector center_of_mass to molecular center of mass
    ...
    IF(.NOT.(tt /= 0))CALL cp__a("molsym.F",1740)
