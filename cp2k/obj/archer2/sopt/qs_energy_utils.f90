# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/qs_energy_utils.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/qs_energy_utils.F"
!-----------------------------------------------------------------------------!
...
# 91 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/qs_energy_utils.F" 2
...
! *****************************************************************************
  SUBROUTINE atom_trace(amat,bmat,factor,atrace)
    ...
    IF(.NOT.(nblock==SIZE(atrace)))CALL cp__a("qs_energy_utils.F",647)
