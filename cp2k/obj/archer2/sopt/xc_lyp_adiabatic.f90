# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/xc/xc_lyp_adiabatic.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/xc/xc_lyp_adiabatic.F"
!-----------------------------------------------------------------------------!
...
# 32 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/xc/xc_lyp_adiabatic.F" 2
...
! *****************************************************************************
  SUBROUTINE lyp_adiabatic_lda_eval(rho_set,deriv_set,grad_deriv,lyp_adiabatic_params)
    ...
    IF(.NOT.(ASSOCIATED(rho_set)))CALL cp__a("xc/xc_lyp_adiabatic.F",149)
    IF(.NOT.(rho_set%ref_count>0))CALL cp__a("xc/xc_lyp_adiabatic.F",150)
    IF(.NOT.(ASSOCIATED(deriv_set)))CALL cp__a("xc/xc_lyp_adiabatic.F",151)
    IF(.NOT.(deriv_set%ref_count>0))CALL cp__a("xc/xc_lyp_adiabatic.F",152)
    ...
    END IF
    IF (grad_deriv>1.OR.grad_deriv<-1) THEN
      CALL cp__b("xc/xc_lyp_adiabatic.F",178,"derivatives bigger than 1 not implemented")
    END IF
...
! *****************************************************************************
  SUBROUTINE lyp_adiabatic_lsd_eval(rho_set,deriv_set,grad_deriv,lyp_adiabatic_params)
    ...
    IF(.NOT.(ASSOCIATED(rho_set)))CALL cp__a("xc/xc_lyp_adiabatic.F",364)
    IF(.NOT.(rho_set%ref_count>0))CALL cp__a("xc/xc_lyp_adiabatic.F",365)
    IF(.NOT.(ASSOCIATED(deriv_set)))CALL cp__a("xc/xc_lyp_adiabatic.F",366)
    IF(.NOT.(deriv_set%ref_count>0))CALL cp__a("xc/xc_lyp_adiabatic.F",367)
    ...
    END IF
    IF (grad_deriv>1.OR.grad_deriv<-1) THEN
      CALL cp__b("xc/xc_lyp_adiabatic.F",418,"derivatives bigger than 1 not implemented")
    END IF
