# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/motion/md_ener_types.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/motion/md_ener_types.F"
!-----------------------------------------------------------------------------!
...
# 14 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/motion/md_ener_types.F" 2
...
! *****************************************************************************
  SUBROUTINE create_md_ener(md_ener)
    ...
    IF(.NOT.(.NOT.ASSOCIATED(md_ener)))CALL cp__a("motion/md_ener_types.F",71)
    ALLOCATE(md_ener)
...
! *****************************************************************************
  SUBROUTINE retain_md_ener(md_ener)
    ...
    IF(.NOT.(ASSOCIATED(md_ener)))CALL cp__a("motion/md_ener_types.F",99)
    IF(.NOT.(md_ener%ref_count>0))CALL cp__a("motion/md_ener_types.F",100)
...
! *****************************************************************************
  SUBROUTINE release_md_ener(md_ener)
    ...
    IF (ASSOCIATED(md_ener)) THEN
       IF(.NOT.(md_ener%ref_count>0))CALL cp__a("motion/md_ener_types.F",118)
       md_ener%ref_count=md_ener%ref_count-1
