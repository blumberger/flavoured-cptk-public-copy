# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/hartree_local_methods.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/hartree_local_methods.F"
!-----------------------------------------------------------------------------!
...
# 50 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/hartree_local_methods.F" 2
...
! *****************************************************************************
  SUBROUTINE Vh_1c_gg_integrals(qs_env,energy_hartree_1c,tddft,do_triplet,p_env)
    ...
    INTEGER :: bo(2), handle, iat, iatom, ikind, ipgf1, is1, iset1, iso, &
      l_ang, llmax, lmax0, lmax_0, m1, max_iso, max_iso_not0, max_s_harm, &
      maxl, maxso, mepos, n1, nat, natom, nchan_0, nkind, nr, nset, nsotot, &
      nspins, num_pe
...
!===========    PAW   ===============
         ...
         IF(nchan_0 > max_iso_not0) CALL cp__b("hartree_local_methods.F",371,"channels for rho0 > # max of spherical harmonics")
