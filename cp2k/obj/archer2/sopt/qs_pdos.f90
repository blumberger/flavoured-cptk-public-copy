# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/qs_pdos.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/qs_pdos.F"
!-----------------------------------------------------------------------------!
...
# 82 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/qs_pdos.F" 2
...
! *****************************************************************************
  SUBROUTINE calculate_projected_dos(mo_set,atomic_kind_set,qs_kind_set,particle_set,qs_env,&
    ...
    INTEGER :: handle, homo, i, iatom, ikind, il, ildos, im, imo, in_x, in_y, &
      ...
      npoints, nrow_global, nset, nsgf, nvirt, out_each, output_unit
