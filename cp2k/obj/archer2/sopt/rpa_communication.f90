# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/rpa_communication.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/rpa_communication.F"
!-----------------------------------------------------------------------------!
...
# 27 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/rpa_communication.F" 2
...
! *****************************************************************************
  SUBROUTINE fm_redistribute(fm_mat_source,fm_mat_dest,RPA_proc_map,buffer_rec,buffer_send,&
    ...
    INTEGER :: dummy_proc, handle, handle2, i_global, i_local, iiB, iii, &
      ...
      nrow_local_s, proc_receive, proc_send, proc_shift, rec_counter, &
      rec_local_col, rec_local_row, rec_pcol, rec_prow, ref_rec_pcol, &
      ref_rec_prow, send_counter, size_rec_buffer, size_send_buffer
