# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/qs_linres_types.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/qs_linres_types.F"
!-----------------------------------------------------------------------------!
...
# 33 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/qs_linres_types.F" 2
...
! *****************************************************************************
  SUBROUTINE linres_control_create(linres_control)
    ...
    CHARACTER(len=*), PARAMETER :: routineN = 'linres_control_create', &
     ...
     IF(.NOT.(.NOT.ASSOCIATED(linres_control)))CALL cp__a("qs_linres_types.F",246)
  ...
  SUBROUTINE linres_control_release(linres_control)
    ...
    CHARACTER(len=*), PARAMETER :: routineN = 'linres_control_release', &
     ...
     IF (ASSOCIATED(linres_control)) THEN
       IF(.NOT.(linres_control%ref_count>0))CALL cp__a("qs_linres_types.F",277)
...
! *****************************************************************************
  SUBROUTINE linres_control_retain(linres_control)
    ...
    CHARACTER(len=*), PARAMETER :: routineN = 'linres_control_retain', &
     ...
     IF(.NOT.(ASSOCIATED(linres_control)))CALL cp__a("qs_linres_types.F",300)
     IF(.NOT.(linres_control%ref_count>0))CALL cp__a("qs_linres_types.F",301)
     linres_control%ref_count=linres_control%ref_count+1
...
! *****************************************************************************
  SUBROUTINE current_env_create(current_env)
    ...
    IF(.NOT.(current_env%ref_count==0))CALL cp__a("qs_linres_types.F",317)
...
! *****************************************************************************
  SUBROUTINE nmr_env_create(nmr_env)
    ...
    CHARACTER(len=*), PARAMETER :: routineN = 'nmr_env_create', &
     ...
     IF(.NOT.(nmr_env%ref_count==0))CALL cp__a("qs_linres_types.F",358)
     nmr_env%ref_count = 1
...
! *****************************************************************************
  SUBROUTINE issc_env_create(issc_env)
    ...
    CHARACTER(len=*), PARAMETER :: routineN = 'issc_env_create', &
     ...
     IF(.NOT.(issc_env%ref_count==0))CALL cp__a("qs_linres_types.F",381)
...
! *****************************************************************************
  SUBROUTINE epr_env_create(epr_env)
    ...
    IF(.NOT.(epr_env%ref_count==0))CALL cp__a("qs_linres_types.F",411)
    epr_env%ref_count = 1
...
!
    ...
    IF(.NOT.(current_env%ref_count>0))CALL cp__a("qs_linres_types.F",503)
...
! *****************************************************************************
  SUBROUTINE get_nmr_env(nmr_env, n_nics, cs_atom_list, do_calc_cs_atom, &
    ...
    IF(.NOT.(nmr_env%ref_count>0))CALL cp__a("qs_linres_types.F",572)
...
! *****************************************************************************
  SUBROUTINE get_issc_env(issc_env,issc_on_atom_list,issc_gapw_radius,issc_loc,&
    ...
    IF(.NOT.(issc_env%ref_count>0))CALL cp__a("qs_linres_types.F",642)
...
! *****************************************************************************
  SUBROUTINE set_current_env(current_env,jrho1_atom_set,jrho1_set)
    ...
    IF(.NOT.(current_env%ref_count>0))CALL cp__a("qs_linres_types.F",687)
...
! *****************************************************************************
  SUBROUTINE get_epr_env(epr_env, g_total, g_so, g_soo, nablavks_set, nablavks_atom_set, &
    ...
    IF(.NOT.(epr_env%ref_count>0))CALL cp__a("qs_linres_types.F",737)
...
! *****************************************************************************
  SUBROUTINE set_epr_env(epr_env,g_free_factor,g_soo_chicorr_factor,&
    ...
    IF(.NOT.(epr_env%ref_count>0))CALL cp__a("qs_linres_types.F",778)
...
! *****************************************************************************
  SUBROUTINE deallocate_nablavks_atom_set(nablavks_atom_set)
    ...
    IF(.NOT.(ASSOCIATED(nablavks_atom_set)))CALL cp__a("qs_linres_types.F",845)
...
! *****************************************************************************
  SUBROUTINE deallocate_jrho_atom_set(jrho_atom_set)
    ...
    IF(.NOT.(ASSOCIATED(jrho_atom_set)))CALL cp__a("qs_linres_types.F",926)
...
! *****************************************************************************
  SUBROUTINE  allocate_jrho_atom_rad(jrho1_atom,ispin,nr,na,max_iso_not0)
    ...
    IF(.NOT.(ASSOCIATED(jrho1_atom)))CALL cp__a("qs_linres_types.F",1035)
...
!
    ...
    IF(.NOT.(ASSOCIATED(jrho1_atom)))CALL cp__a("qs_linres_types.F",1093)
    !
    jrho1_atom%jrho_h(ispin)%r_coef = 0.0_dp
    jrho1_atom%jrho_s(ispin)%r_coef = 0.0_dp
    !
...
! *****************************************************************************
  SUBROUTINE allocate_jrho_coeff(jrho1_atom_set,iatom,nsotot)
    ...
    CALL timeset(routineN,handle)
    IF(.NOT.(ASSOCIATED(jrho1_atom_set)))CALL cp__a("qs_linres_types.F",1135)
...
! *****************************************************************************
  SUBROUTINE deallocate_jrho_coeff(jrho1_atom_set,iatom)
    ...
    CALL timeset(routineN,handle)
    IF(.NOT.(ASSOCIATED(jrho1_atom_set)))CALL cp__a("qs_linres_types.F",1176)
    DO i = 1,SIZE(jrho1_atom_set(iatom)%cjc0_h,1)
...
! *****************************************************************************
  SUBROUTINE get_jrho_atom(jrho1_atom_set,iatom,cjc_h,cjc_s,cjc_ii_h,cjc_ii_s,&
    ...
    IF(.NOT.(ASSOCIATED(jrho1_atom_set)))CALL cp__a("qs_linres_types.F",1220)
...
! *****************************************************************************
  SUBROUTINE init_jrho_atom_set(jrho1_atom_set,atomic_kind_set,nspins)
    ...
    IF(.NOT.(ASSOCIATED(atomic_kind_set)))CALL cp__a("qs_linres_types.F",1257)
...
! *****************************************************************************
  SUBROUTINE init_nablavks_atom_set(nablavks_atom_set,atomic_kind_set,qs_kind_set,nspins)
    ...
    IF(.NOT.(ASSOCIATED(qs_kind_set)))CALL cp__a("qs_linres_types.F",1372)
...
! *****************************************************************************
  SUBROUTINE polar_env_create(polar_env)
    ...
    CHARACTER(len=*), PARAMETER :: routineN = 'polar_env_create', &
     ...
     IF(.NOT.(polar_env%ref_count==0))CALL cp__a("qs_linres_types.F",1430)
...
! *****************************************************************************
  SUBROUTINE get_polar_env(polar_env,do_raman,dBerry_psi0, polar, &
    ...
    IF(.NOT.(polar_env%ref_count>0))CALL cp__a("qs_linres_types.F",1464)
...
! *****************************************************************************
  SUBROUTINE set_polar_env(polar_env)
    ...
    IF(.NOT.(polar_env%ref_count>0))CALL cp__a("qs_linres_types.F",1486)
