# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/ls_matrix_exp.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/ls_matrix_exp.F"
!-----------------------------------------------------------------------------!
...
# 22 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/ls_matrix_exp.F" 2
...
! *****************************************************************************
   ...
   SUBROUTINE bch_expansion_imaginary_propagator(propagator,density_re,density_im,filter_eps,filter_eps_small,eps_exp)
    ...
    IF(.NOT.convergence)&
       CALL cp__w("ls_matrix_exp.F",442,"BCH method did not converge")
...
! *****************************************************************************
   ...
   SUBROUTINE bch_expansion_complex_propagator(propagator_re,propagator_im,density_re,density_im,filter_eps,&
    ...
    IF(.NOT.convergence)&
       CALL cp__w("ls_matrix_exp.F",539,"BCH method did not converge ")
