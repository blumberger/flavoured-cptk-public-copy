# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/eip_silicon.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/eip_silicon.F"
!-----------------------------------------------------------------------------!
...
# 43 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/eip_silicon.F" 2
...
! *****************************************************************************
  SUBROUTINE eip_bazant(eip_env)
    ...
    INTEGER :: handle, i, iparticle, iparticle_kind, iparticle_local, iw, &
      natom, nparticle_kind, nparticle_local
...
!   ------------------------------------------------------------------------
    ...
    IF(.NOT.(ASSOCIATED(eip_env)))CALL cp__a("eip_silicon.F",109)
    ...
    CALL mp_sum(ekin, para_env%group)
...
!   ------------------------------------------------------------------------
    ...
    IF(.NOT.(ASSOCIATED(eip_env)))CALL cp__a("eip_silicon.F",280)
...
! linear scaling calculation of verlet list
        ll1=INT(alat(1)/cut)
        IF (ll1.lt.1) CALL cp__b("eip_silicon.F",665,"alat(1) too small")
        ll2=INT(alat(2)/cut)
        IF (ll2.lt.1) CALL cp__b("eip_silicon.F",667,"alat(2) too small")
        ll3=INT(alat(3)/cut)
        IF (ll3.lt.1) CALL cp__b("eip_silicon.F",669,"alat(3) too small")
...
! xy plane
        ...
        i=icell(ii,l1,l2,0)
        il=il+1
        IF (il.gt.nn) CALL cp__b("eip_silicon.F",775,"enlarge laymx")
        lay(il)=i
        ...
        il=il+1
        IF (il.gt.nn) CALL cp__b("eip_silicon.F",788,"enlarge laymx")
        lay(il)=i
        icell(ii,l1,l2,-1)=il
        rxyz(1,il)=rxyz(1,i)
        rxyz(2,il)=rxyz(2,i)
...
! yz plane
        ...
        i=icell(ii,0,l2,l3)
        il=il+1
        IF (il.gt.nn) CALL cp__b("eip_silicon.F",808,"enlarge laymx")
        lay(il)=i
        ...
        il=il+1
        IF (il.gt.nn) CALL cp__b("eip_silicon.F",821,"enlarge laymx")
        lay(il)=i
        icell(ii,-1,l2,l3)=il
        rxyz(1,il)=rxyz(1,i)-alat(1)
        rxyz(2,il)=rxyz(2,i)
...
! xz plane
        ...
        i=icell(ii,l1,0,l3)
        il=il+1
        IF (il.gt.nn) CALL cp__b("eip_silicon.F",841,"enlarge laymx")
        lay(il)=i
        ...
        il=il+1
        IF (il.gt.nn) CALL cp__b("eip_silicon.F",854,"enlarge laymx")
        lay(il)=i
        icell(ii,l1,-1,l3)=il
        rxyz(1,il)=rxyz(1,i)
        rxyz(2,il)=rxyz(2,i)-alat(2)
...
! x axis
        ...
        i=icell(ii,l1,0,0)
        il=il+1
        IF (il.gt.nn) CALL cp__b("eip_silicon.F",873,"enlarge laymx")
        lay(il)=i
        ...
        il=il+1
        IF (il.gt.nn) CALL cp__b("eip_silicon.F",886,"enlarge laymx")
        lay(il)=i
        ...
        il=il+1
        IF (il.gt.nn) CALL cp__b("eip_silicon.F",899,"enlarge laymx")
        lay(il)=i
        ...
        il=il+1
        IF (il.gt.nn) CALL cp__b("eip_silicon.F",912,"enlarge laymx")
        lay(il)=i
        icell(ii,l1,-1,-1)=il
        rxyz(1,il)=rxyz(1,i)
        rxyz(2,il)=rxyz(2,i)-alat(2)
...
! y axis
        ...
        i=icell(ii,0,l2,0)
        il=il+1
        IF (il.gt.nn) CALL cp__b("eip_silicon.F",930,"enlarge laymx")
        lay(il)=i
        ...
        il=il+1
        IF (il.gt.nn) CALL cp__b("eip_silicon.F",943,"enlarge laymx")
        lay(il)=i
        ...
        il=il+1
        IF (il.gt.nn) CALL cp__b("eip_silicon.F",956,"enlarge laymx")
        lay(il)=i
        ...
        il=il+1
        IF (il.gt.nn) CALL cp__b("eip_silicon.F",969,"enlarge laymx")
        lay(il)=i
        icell(ii,-1,l2,-1)=il
        rxyz(1,il)=rxyz(1,i)-alat(1)
        rxyz(2,il)=rxyz(2,i)
...
! z axis
        ...
        i=icell(ii,0,0,l3)
        il=il+1
        IF (il.gt.nn) CALL cp__b("eip_silicon.F",987,"enlarge laymx")
        lay(il)=i
        ...
        il=il+1
        IF (il.gt.nn) CALL cp__b("eip_silicon.F",1000,"enlarge laymx")
        lay(il)=i
        ...
        il=il+1
        IF (il.gt.nn) CALL cp__b("eip_silicon.F",1013,"enlarge laymx")
        lay(il)=i
        ...
        il=il+1
        IF (il.gt.nn) CALL cp__b("eip_silicon.F",1026,"enlarge laymx")
        lay(il)=i
        icell(ii,-1,-1,l3)=il
        rxyz(1,il)=rxyz(1,i)-alat(1)
        rxyz(2,il)=rxyz(2,i)-alat(2)
...
! corners
        ...
        i=icell(ii,0,0,0)
        il=il+1
        IF (il.gt.nn) CALL cp__b("eip_silicon.F",1042,"enlarge laymx")
        lay(il)=i
        ...
        il=il+1
        IF (il.gt.nn) CALL cp__b("eip_silicon.F",1055,"enlarge laymx")
        lay(il)=i
        ...
        il=il+1
        IF (il.gt.nn) CALL cp__b("eip_silicon.F",1068,"enlarge laymx")
        lay(il)=i
        ...
        il=il+1
        IF (il.gt.nn) CALL cp__b("eip_silicon.F",1081,"enlarge laymx")
        lay(il)=i
        icell(ii,-1,-1,ll3)=il
        rxyz(1,il)=rxyz(1,i)-alat(1)
        rxyz(2,il)=rxyz(2,i)-alat(2)
        ...
        il=il+1
        IF (il.gt.nn) CALL cp__b("eip_silicon.F",1094,"enlarge laymx")
        lay(il)=i
        ...
        il=il+1
        IF (il.gt.nn) CALL cp__b("eip_silicon.F",1107,"enlarge laymx")
        lay(il)=i
        icell(ii,-1,ll2,-1)=il
        rxyz(1,il)=rxyz(1,i)-alat(1)
        rxyz(2,il)=rxyz(2,i)+alat(2)
        ...
        il=il+1
        IF (il.gt.nn) CALL cp__b("eip_silicon.F",1120,"enlarge laymx")
        lay(il)=i
        icell(ii,ll1,-1,-1)=il
        rxyz(1,il)=rxyz(1,i)+alat(1)
        rxyz(2,il)=rxyz(2,i)-alat(2)
        ...
        il=il+1
        IF (il.gt.nn) CALL cp__b("eip_silicon.F",1133,"enlarge laymx")
        lay(il)=i
        icell(ii,-1,-1,-1)=il
        rxyz(1,il)=rxyz(1,i)-alat(1)
        rxyz(2,il)=rxyz(2,i)-alat(2)
...
!                    ener,DNRM2(3*nat,fxyz,1)
        IF (istopg.gt.0) CALL cp__b("eip_silicon.F",1277,"DIMENSION ERROR (see WARNING above)")
...
! linear scaling calculation of verlet list
        ll1=INT(alat(1)/cut)
        IF (ll1.lt.1) CALL cp__b("eip_silicon.F",1835,"alat(1) too small")
        ll2=INT(alat(2)/cut)
        IF (ll2.lt.1) CALL cp__b("eip_silicon.F",1837,"alat(2) too small")
        ll3=INT(alat(3)/cut)
        IF (ll3.lt.1) CALL cp__b("eip_silicon.F",1839,"alat(3) too small")
...
! xy plane
        ...
        i=icell(ii,l1,l2,0)
        il=il+1
        IF (il.gt.nn) CALL cp__b("eip_silicon.F",1944,"enlarge laymx")
        lay(il)=i
        icell(ii,l1,l2,ll3)=il
        rxyz(1,il)=rxyz(1,i)
        rxyz(2,il)=rxyz(2,i)
        ...
        i=icell(ii,l1,l2,ll3-1)
        il=il+1
        IF (il.gt.nn) CALL cp__b("eip_silicon.F",1957,"enlarge laymx")
        lay(il)=i
        icell(ii,l1,l2,-1)=il
        rxyz(1,il)=rxyz(1,i)
        rxyz(2,il)=rxyz(2,i)
...
! yz plane
        ...
        i=icell(ii,0,l2,l3)
        il=il+1
        IF (il.gt.nn) CALL cp__b("eip_silicon.F",1977,"enlarge laymx")
        lay(il)=i
        icell(ii,ll1,l2,l3)=il
        rxyz(1,il)=rxyz(1,i)+alat(1)
        rxyz(2,il)=rxyz(2,i)
        ...
        i=icell(ii,ll1-1,l2,l3)
        il=il+1
        IF (il.gt.nn) CALL cp__b("eip_silicon.F",1990,"enlarge laymx")
        lay(il)=i
        icell(ii,-1,l2,l3)=il
        rxyz(1,il)=rxyz(1,i)-alat(1)
        rxyz(2,il)=rxyz(2,i)
...
! xz plane
        ...
        i=icell(ii,l1,0,l3)
        il=il+1
        IF (il.gt.nn) CALL cp__b("eip_silicon.F",2010,"enlarge laymx")
        lay(il)=i
        icell(ii,l1,ll2,l3)=il
        rxyz(1,il)=rxyz(1,i)
        rxyz(2,il)=rxyz(2,i)+alat(2)
        ...
        i=icell(ii,l1,ll2-1,l3)
        il=il+1
        IF (il.gt.nn) CALL cp__b("eip_silicon.F",2023,"enlarge laymx")
        lay(il)=i
        icell(ii,l1,-1,l3)=il
        rxyz(1,il)=rxyz(1,i)
        rxyz(2,il)=rxyz(2,i)-alat(2)
...
! x axis
        ...
        i=icell(ii,l1,0,0)
        il=il+1
        IF (il.gt.nn) CALL cp__b("eip_silicon.F",2042,"enlarge laymx")
        lay(il)=i
        icell(ii,l1,ll2,ll3)=il
        rxyz(1,il)=rxyz(1,i)
        rxyz(2,il)=rxyz(2,i)+alat(2)
        ...
        i=icell(ii,l1,0,ll3-1)
        il=il+1
        IF (il.gt.nn) CALL cp__b("eip_silicon.F",2055,"enlarge laymx")
        lay(il)=i
        icell(ii,l1,ll2,-1)=il
        rxyz(1,il)=rxyz(1,i)
        rxyz(2,il)=rxyz(2,i)+alat(2)
        ...
        i=icell(ii,l1,ll2-1,0)
        il=il+1
        IF (il.gt.nn) CALL cp__b("eip_silicon.F",2068,"enlarge laymx")
        lay(il)=i
        icell(ii,l1,-1,ll3)=il
        rxyz(1,il)=rxyz(1,i)
        rxyz(2,il)=rxyz(2,i)-alat(2)
        ...
        i=icell(ii,l1,ll2-1,ll3-1)
        il=il+1
        IF (il.gt.nn) CALL cp__b("eip_silicon.F",2081,"enlarge laymx")
        lay(il)=i
        icell(ii,l1,-1,-1)=il
        rxyz(1,il)=rxyz(1,i)
        rxyz(2,il)=rxyz(2,i)-alat(2)
...
! y axis
        ...
        i=icell(ii,0,l2,0)
        il=il+1
        IF (il.gt.nn) CALL cp__b("eip_silicon.F",2099,"enlarge laymx")
        lay(il)=i
        icell(ii,ll1,l2,ll3)=il
        rxyz(1,il)=rxyz(1,i)+alat(1)
        rxyz(2,il)=rxyz(2,i)
        ...
        i=icell(ii,0,l2,ll3-1)
        il=il+1
        IF (il.gt.nn) CALL cp__b("eip_silicon.F",2112,"enlarge laymx")
        lay(il)=i
        icell(ii,ll1,l2,-1)=il
        rxyz(1,il)=rxyz(1,i)+alat(1)
        rxyz(2,il)=rxyz(2,i)
        ...
        i=icell(ii,ll1-1,l2,0)
        il=il+1
        IF (il.gt.nn) CALL cp__b("eip_silicon.F",2125,"enlarge laymx")
        lay(il)=i
        icell(ii,-1,l2,ll3)=il
        rxyz(1,il)=rxyz(1,i)-alat(1)
        rxyz(2,il)=rxyz(2,i)
        ...
        i=icell(ii,ll1-1,l2,ll3-1)
        il=il+1
        IF (il.gt.nn) CALL cp__b("eip_silicon.F",2138,"enlarge laymx")
        lay(il)=i
        icell(ii,-1,l2,-1)=il
        rxyz(1,il)=rxyz(1,i)-alat(1)
        rxyz(2,il)=rxyz(2,i)
...
! z axis
        ...
        i=icell(ii,0,0,l3)
        il=il+1
        IF (il.gt.nn) CALL cp__b("eip_silicon.F",2156,"enlarge laymx")
        lay(il)=i
        icell(ii,ll1,ll2,l3)=il
        rxyz(1,il)=rxyz(1,i)+alat(1)
        rxyz(2,il)=rxyz(2,i)+alat(2)
        ...
        i=icell(ii,ll1-1,0,l3)
        il=il+1
        IF (il.gt.nn) CALL cp__b("eip_silicon.F",2169,"enlarge laymx")
        lay(il)=i
        icell(ii,-1,ll2,l3)=il
        rxyz(1,il)=rxyz(1,i)-alat(1)
        rxyz(2,il)=rxyz(2,i)+alat(2)
        ...
        i=icell(ii,0,ll2-1,l3)
        il=il+1
        IF (il.gt.nn) CALL cp__b("eip_silicon.F",2182,"enlarge laymx")
        lay(il)=i
        icell(ii,ll1,-1,l3)=il
        rxyz(1,il)=rxyz(1,i)+alat(1)
        rxyz(2,il)=rxyz(2,i)-alat(2)
        ...
        i=icell(ii,ll1-1,ll2-1,l3)
        il=il+1
        IF (il.gt.nn) CALL cp__b("eip_silicon.F",2195,"enlarge laymx")
        lay(il)=i
        icell(ii,-1,-1,l3)=il
        rxyz(1,il)=rxyz(1,i)-alat(1)
        rxyz(2,il)=rxyz(2,i)-alat(2)
...
! corners
        ...
        i=icell(ii,0,0,0)
        il=il+1
        IF (il.gt.nn) CALL cp__b("eip_silicon.F",2211,"enlarge laymx")
        lay(il)=i
        icell(ii,ll1,ll2,ll3)=il
        rxyz(1,il)=rxyz(1,i)+alat(1)
        rxyz(2,il)=rxyz(2,i)+alat(2)
        ...
        i=icell(ii,ll1-1,0,0)
        il=il+1
        IF (il.gt.nn) CALL cp__b("eip_silicon.F",2224,"enlarge laymx")
        lay(il)=i
        icell(ii,-1,ll2,ll3)=il
        rxyz(1,il)=rxyz(1,i)-alat(1)
        rxyz(2,il)=rxyz(2,i)+alat(2)
        ...
        i=icell(ii,0,ll2-1,0)
        il=il+1
        IF (il.gt.nn) CALL cp__b("eip_silicon.F",2237,"enlarge laymx")
        lay(il)=i
        icell(ii,ll1,-1,ll3)=il
        rxyz(1,il)=rxyz(1,i)+alat(1)
        rxyz(2,il)=rxyz(2,i)-alat(2)
        ...
        i=icell(ii,ll1-1,ll2-1,0)
        il=il+1
        IF (il.gt.nn) CALL cp__b("eip_silicon.F",2250,"enlarge laymx")
        lay(il)=i
        icell(ii,-1,-1,ll3)=il
        rxyz(1,il)=rxyz(1,i)-alat(1)
        rxyz(2,il)=rxyz(2,i)-alat(2)
        ...
        i=icell(ii,0,0,ll3-1)
        il=il+1
        IF (il.gt.nn) CALL cp__b("eip_silicon.F",2263,"enlarge laymx")
        lay(il)=i
        icell(ii,ll1,ll2,-1)=il
        rxyz(1,il)=rxyz(1,i)+alat(1)
        rxyz(2,il)=rxyz(2,i)+alat(2)
        ...
        i=icell(ii,ll1-1,0,ll3-1)
        il=il+1
        IF (il.gt.nn) CALL cp__b("eip_silicon.F",2276,"enlarge laymx")
        lay(il)=i
        icell(ii,-1,ll2,-1)=il
        rxyz(1,il)=rxyz(1,i)-alat(1)
        rxyz(2,il)=rxyz(2,i)+alat(2)
        ...
        i=icell(ii,0,ll2-1,ll3-1)
        il=il+1
        IF (il.gt.nn) CALL cp__b("eip_silicon.F",2289,"enlarge laymx")
        lay(il)=i
        icell(ii,ll1,-1,-1)=il
        rxyz(1,il)=rxyz(1,i)+alat(1)
        rxyz(2,il)=rxyz(2,i)-alat(2)
        ...
        i=icell(ii,ll1-1,ll2-1,ll3-1)
        il=il+1
        IF (il.gt.nn) CALL cp__b("eip_silicon.F",2302,"enlarge laymx")
        lay(il)=i
        icell(ii,-1,-1,-1)=il
        rxyz(1,il)=rxyz(1,i)-alat(1)
        rxyz(2,il)=rxyz(2,i)-alat(2)
...
!         write(*,*) 'ener,norm force', &
!                    ener,DNRM2(3*nat,fxyz,1)
        IF (istopg.gt.0) CALL cp__b("eip_silicon.F",2437,"DIMENSION ERROR (see WARNING above)")
        ener_var=ener2/nat-(ener/nat)**2
        coord=coord/nat
        coord_var=coord2/nat-coord**2
