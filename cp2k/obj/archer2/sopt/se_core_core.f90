# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/se_core_core.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/se_core_core.F"
!-----------------------------------------------------------------------------!
...
# 63 "/work/e05/e05/fivanovic/flavoured-cptk-X-SH-coulomb-barrier/cp2k/src/se_core_core.F" 2
...
! *****************************************************************************
  SUBROUTINE se_core_core_interaction(qs_env, para_env, calculate_forces)
    ...
    IF(.NOT.(ASSOCIATED(qs_env)))CALL cp__a("se_core_core.F",133)
    ...
    IF(se_control%do_ewald_gks) THEN
       ...
       IF(.NOT.(.NOT.use_virial))CALL cp__a("se_core_core.F",162)
    END IF
